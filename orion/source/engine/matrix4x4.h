...
struct Matrix4x4 final
{
  public:
    ...
    NODISCARD auto world_to_screen(const Vector3& world_pos, ImVec2& screen_pos) const noexcept -> bool;

    NODISCARD auto world_to_screen_pixel_aligned(const Vector3& world_pos, ImVec2& screen_pos) const noexcept -> bool;
