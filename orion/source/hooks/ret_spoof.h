...
namespace orion::hooks {
    ...
    namespace detail {
        ...
        NODISCARD __declspec(naked) constexpr auto __fastcall invoke_fastcall(
            ...
            __asm {
                ...
                ret 4  // pop 'function_address' from stack and jump to it, skip 'context' on stack; esp will point to the spoofed return address (gadget_address)
    ...
    public:
        ...
        NODISCARD static constexpr auto invoke_fastcall(
            ...
            return detail::invoke_fastcall<ReturnType, Args...>(
                ecx,
                edx,
                function_address,
                &context,
        ...
        NODISCARD static constexpr auto invoke_cdecl(
            ...
            const detail::Context context;
            return detail::invoke_cdecl<ReturnType, Args...>(
                function_address,
                &context,
                gadget_address,
                args...
