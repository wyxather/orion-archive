...
orion::imports::User32::User32( const li::detail::win::LDR_DATA_TABLE_ENTRY_T& user32 ) noexcept
{
    ...
    getCursorPos             = LI_FUNC( GetCursorPos )::in( user32.DllBase );
    getSystemMetrics         = LI_FUNC( GetSystemMetrics )::in( user32.DllBase );
    ...
    postMessage              = LI_FUNC( PostMessage )::in( user32.DllBase );
...
void orion::imports::to_json( nlohmann::json& json, const User32& user32 ) noexcept
{
    json = {
        ...
        { xorstr_( "getCursorPos" ), user32.getCursorPos },
        { xorstr_( "getSystemMetrics" ), user32.getSystemMetrics },
        ...
        { xorstr_( "postMessage" ), user32.postMessage },
