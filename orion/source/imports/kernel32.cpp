...
orion::imports::Kernel32::Kernel32( void* const kernel32 ) noexcept
{
    ...
    getModuleHandleA         = LI_FUNC( GetModuleHandleA )::in( kernel32 );
    getModuleInformation     = LI_FUNC( GetModuleInformation )::in( kernel32 );
...
void orion::imports::to_json( nlohmann::json& json, const Kernel32& kernel32 ) noexcept
{
    json = {
        ...
        { xorstr_( "getModuleHandleA" ), reinterpret_cast<std::uintptr_t>( kernel32.getModuleHandleA ) },
        { xorstr_( "getModuleInformation" ), reinterpret_cast<std::uintptr_t>( kernel32.getModuleInformation ) },
