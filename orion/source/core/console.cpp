...
Console::Console() noexcept
{
    ...
    freopen_s(&stream, utilities::String<"CONOUT$">(), utilities::String<"w">(), stdout);
    ...
    user32.set_window_long_ptr(window, GWL_STYLE, user32.get_window_long_ptr(window, GWL_STYLE) & ~WS_SYSMENU);
}
