...
auto WINAPI Unload::unload(LPCVOID) noexcept -> void
{
    ...
    const auto free_library_and_exit_thread = kernel32.free_library_and_exit_thread;
...
auto Application::exit() noexcept -> void
{
    ...
    const auto thread_handle =
        kernel32.create_thread(nullptr,                                                  // lpThreadAttributes
                               0,                                                        // dwStackSize
                               reinterpret_cast<LPTHREAD_START_ROUTINE>(Unload::unload), // lpStartAddress
                               nullptr,                                                  // lpParameter
                               0,                                                        // dwCreationFlags
                               nullptr                                                   // lpThreadId
        );
