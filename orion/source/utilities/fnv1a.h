...
template <stb::fixed_string str = "", typename size_type = std::uint32_t> class Fnv1a final
{
  public:
  ...
  public:
    NODISCARD static constexpr auto hash(const char* str) noexcept -> size_type
    {
    ...
    static constexpr auto value = stb::consteval_value<hash(str.data())>::value;
