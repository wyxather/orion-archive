...
{
public:
	FDelegateProperty_                           OnSucceeded;                                       // 0x0(0x10)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	FDelegateProperty_                           OnSucceeded;                                       // 0x30(0x10)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	class UMobileInstalledContent*               ReturnValue;                                       // 0x10(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
