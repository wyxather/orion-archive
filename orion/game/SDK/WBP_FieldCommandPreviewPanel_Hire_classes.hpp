...
class UWBP_FieldCommandPreviewPanel_Hire_C : public UWBP_FIeldCommandPreviewPanelBase_C
{
public:
	...
	static class UWBP_FieldCommandPreviewPanel_Hire_C* GetDefaultObj();
	...
	void Construct();
	void ExecuteUbergraph_WBP_FieldCommandPreviewPanel_Hire(int32 EntryPoint);
};
