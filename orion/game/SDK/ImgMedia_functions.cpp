...
void UImgMediaSource::SetSequencePath(const class FString& Path)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ImgMediaSource", "SetSequencePath");
...
void UImgMediaSource::SetMipLevelDistance(float Distance)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ImgMediaSource", "SetMipLevelDistance");
...
void UImgMediaSource::RemoveTargetObject(class AActor* InActor)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ImgMediaSource", "RemoveTargetObject");
...
void UImgMediaSource::RemoveGlobalCamera(class AActor* InActor)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ImgMediaSource", "RemoveGlobalCamera");
...
class FString UImgMediaSource::GetSequencePath()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ImgMediaSource", "GetSequencePath");
...
void UImgMediaSource::GetProxies(TArray<class FString>* OutProxies)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ImgMediaSource", "GetProxies");
...
void UImgMediaSource::AddTargetObject(class AActor* InActor, float Width)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ImgMediaSource", "AddTargetObject");
...
void UImgMediaSource::AddGlobalCamera(class AActor* InActor)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ImgMediaSource", "AddGlobalCamera");
