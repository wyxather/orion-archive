...
bool ULocationServices::StopLocationServices()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LocationServices", "StopLocationServices");
...
bool ULocationServices::StartLocationServices()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LocationServices", "StartLocationServices");
...
bool ULocationServices::IsLocationAccuracyAvailable(enum class ELocationAccuracy Accuracy)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LocationServices", "IsLocationAccuracyAvailable");
...
bool ULocationServices::InitLocationServices(enum class ELocationAccuracy Accuracy, float UpdateFrequency, float MinDistanceFilter)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LocationServices", "InitLocationServices");
...
class ULocationServicesImpl* ULocationServices::GetLocationServicesImpl()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LocationServices", "GetLocationServicesImpl");
...
struct FLocationServicesData ULocationServices::GetLastKnownLocation()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LocationServices", "GetLastKnownLocation");
...
bool ULocationServices::AreLocationServicesEnabled()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LocationServices", "AreLocationServicesEnabled");
