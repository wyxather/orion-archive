...
struct FHitResult UChaosSolverEngineBlueprintLibrary::ConvertPhysicsCollisionToHitResult(struct FChaosPhysicsCollisionInfo& PhysicsCollision)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ChaosSolverEngineBlueprintLibrary", "ConvertPhysicsCollisionToHitResult");
...
void AChaosSolverActor::SetSolverActive(bool bActive)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ChaosSolverActor", "SetSolverActive");
...
void AChaosSolverActor::SetAsCurrentWorldSolver()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("ChaosSolverActor", "SetAsCurrentWorldSolver");
