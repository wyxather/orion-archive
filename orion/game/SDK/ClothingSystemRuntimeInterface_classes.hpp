...
{
public:
	TMap<class FName, class UClothingInteractor*> ClothingInteractors;                               // 0x28(0x50)(NativeAccessSpecifierPublic)
	uint8                                        Pad_20F[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	TArray<struct FVector>                       Normals;                                           // 0x38(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_217[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
