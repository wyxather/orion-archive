...
public:
	...
	enum class EMobileShadowQuality              MobileShadowQuality;                               // 0x8(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
