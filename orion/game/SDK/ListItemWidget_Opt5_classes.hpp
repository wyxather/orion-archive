...
class UListItemWidget_Opt5_C : public UListItemWidget_Opt_Base
{
public:
	...
	static class UListItemWidget_Opt5_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ListItemWidget_Opt5(int32 EntryPoint);
};
