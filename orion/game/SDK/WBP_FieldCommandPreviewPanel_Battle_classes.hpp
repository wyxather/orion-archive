...
class UWBP_FieldCommandPreviewPanel_Battle_C : public UWBP_FIeldCommandPreviewPanelBase_C
{
public:
	...
	static class UWBP_FieldCommandPreviewPanel_Battle_C* GetDefaultObj();
	...
	void Construct();
	void ExecuteUbergraph_WBP_FieldCommandPreviewPanel_Battle(int32 EntryPoint);
};
