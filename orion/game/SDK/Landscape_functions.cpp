...
void ALandscapeProxy::SetLandscapeMaterialVectorParameterValue(class FName ParameterName, const struct FLinearColor& Value)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "SetLandscapeMaterialVectorParameterValue");
...
void ALandscapeProxy::SetLandscapeMaterialTextureParameterValue(class FName ParameterName, class UTexture* Value)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "SetLandscapeMaterialTextureParameterValue");
...
void ALandscapeProxy::SetLandscapeMaterialScalarParameterValue(class FName ParameterName, float Value)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "SetLandscapeMaterialScalarParameterValue");
...
bool ALandscapeProxy::LandscapeExportHeightmapToRenderTarget(class UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "LandscapeExportHeightmapToRenderTarget");
...
void ALandscapeProxy::EditorSetLandscapeMaterial(class UMaterialInterface* NewLandscapeMaterial)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "EditorSetLandscapeMaterial");
...
void ALandscapeProxy::EditorApplySpline(class USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32 NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, class ULandscapeLayerInfoObject* PaintLayer, class FName EditLayerName)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "EditorApplySpline");
...
void ALandscapeProxy::ChangeUseTessellationComponentScreenSizeFalloff(bool InComponentScreenSizeToUseSubSections)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "ChangeUseTessellationComponentScreenSizeFalloff");
...
void ALandscapeProxy::ChangeTessellationComponentScreenSizeFalloff(float InUseTessellationComponentScreenSizeFalloff)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "ChangeTessellationComponentScreenSizeFalloff");
...
void ALandscapeProxy::ChangeTessellationComponentScreenSize(float InTessellationComponentScreenSize)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "ChangeTessellationComponentScreenSize");
...
void ALandscapeProxy::ChangeLODDistanceFactor(float InLODDistanceFactor)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "ChangeLODDistanceFactor");
...
void ALandscapeProxy::ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeProxy", "ChangeComponentScreenSizeToUseSubSections");
...
void ALandscapeBlueprintBrushBase::RequestLandscapeUpdate()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeBlueprintBrushBase", "RequestLandscapeUpdate");
...
class UTextureRenderTarget2D* ALandscapeBlueprintBrushBase::Render(bool InIsHeightmap, class UTextureRenderTarget2D* InCombinedResult, class FName& InWeightmapLayerName)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeBlueprintBrushBase", "Render");
...
void ALandscapeBlueprintBrushBase::Initialize(struct FTransform& InLandscapeTransform, struct FIntPoint& InLandscapeSize, struct FIntPoint& InLandscapeRenderTargetSize)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeBlueprintBrushBase", "Initialize");
...
void ALandscapeBlueprintBrushBase::GetBlueprintRenderDependencies(TArray<class UObject*>* OutStreamableAssets)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeBlueprintBrushBase", "GetBlueprintRenderDependencies");
...
class UClass* ULandscapeLODStreamingProxy::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LandscapeLODStreamingProxy");
...
class ULandscapeLODStreamingProxy* ULandscapeLODStreamingProxy::GetDefaultObj()
{
	static class ULandscapeLODStreamingProxy* Default = nullptr;

	if (!Default)
		Default = static_cast<ULandscapeLODStreamingProxy*>(ULandscapeLODStreamingProxy::StaticClass()->DefaultObject);
...
class UMaterialInstanceDynamic* ULandscapeComponent::GetMaterialInstanceDynamic(int32 InIndex)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeComponent", "GetMaterialInstanceDynamic");
...
float ULandscapeComponent::EditorGetPaintLayerWeightByNameAtLocation(struct FVector& InLocation, class FName InPaintLayerName)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeComponent", "EditorGetPaintLayerWeightByNameAtLocation");
...
float ULandscapeComponent::EditorGetPaintLayerWeightAtLocation(struct FVector& InLocation, class ULandscapeLayerInfoObject* PaintLayer)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeComponent", "EditorGetPaintLayerWeightAtLocation");
...
class ULandscapeComponent* ULandscapeHeightfieldCollisionComponent::GetRenderComponent()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeHeightfieldCollisionComponent", "GetRenderComponent");
...
TArray<class USplineMeshComponent*> ULandscapeSplinesComponent::GetSplineMeshComponents()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("LandscapeSplinesComponent", "GetSplineMeshComponents");
