...
class ABP_EnvFX_Snow_Smoke_C : public AActor
{
public:
	...
	class UParticleSystemComponent*              FxPS_Eve_SnowSmoke;                                // 0x230(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	static class ABP_EnvFX_Snow_Smoke_C* GetDefaultObj();

	void OnHidden();
	void OnShown();
	void ExecuteUbergraph_BP_EnvFX_Snow_Smoke(int32 EntryPoint);
};
