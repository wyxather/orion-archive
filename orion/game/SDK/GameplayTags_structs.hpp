...
{
public:
	uint8                                        Pad_9CF[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_9D0[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_9D1[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_A18[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
