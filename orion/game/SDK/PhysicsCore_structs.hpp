...
{
public:
	uint8                                        Pad_70F[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        bUpdateMassWhenScaleChanges : 1;                   // Mask: 0x40, PropSize: 0x10x10(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_710[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
