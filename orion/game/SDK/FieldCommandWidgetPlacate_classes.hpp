...
class UFieldCommandWidgetPlacate_C : public UUFieldCommandWidgetFollowBase
{
public:
	...
	static class UFieldCommandWidgetPlacate_C* GetDefaultObj();
	...
	class AKSCharacterBase* Get_Follow_Placate_Member();
	...
	void ExecuteUbergraph_FieldCommandWidgetPlacate(int32 EntryPoint);
};
