...
class UCineCameraComponent* ACineCameraActor::GetCineCameraComponent()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraActor", "GetCineCameraComponent");
...
class USplineComponent* ACameraRig_Rail::GetRailSplineComponent()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CameraRig_Rail", "GetRailSplineComponent");
...
void UCineCameraComponent::SetLensPresetByName(const class FString& InPresetName)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "SetLensPresetByName");
...
void UCineCameraComponent::SetFilmbackPresetByName(const class FString& InPresetName)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "SetFilmbackPresetByName");
...
void UCineCameraComponent::SetCurrentFocalLength(float InFocalLength)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "SetCurrentFocalLength");
...
float UCineCameraComponent::GetVerticalFieldOfView()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "GetVerticalFieldOfView");
...
TArray<struct FNamedLensPreset> UCineCameraComponent::GetLensPresetsCopy()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "GetLensPresetsCopy");
...
class FString UCineCameraComponent::GetLensPresetName()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "GetLensPresetName");
...
float UCineCameraComponent::GetHorizontalFieldOfView()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "GetHorizontalFieldOfView");
...
TArray<struct FNamedFilmbackPreset> UCineCameraComponent::GetFilmbackPresetsCopy()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "GetFilmbackPresetsCopy");
...
class FString UCineCameraComponent::GetFilmbackPresetName()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "GetFilmbackPresetName");
...
class FString UCineCameraComponent::GetDefaultFilmbackPresetName()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("CineCameraComponent", "GetDefaultFilmbackPresetName");
