...
class UWBP_FieldCommandPreviewPanel_Search_C : public UWBP_FIeldCommandPreviewPanelBase_C
{
public:
	...
	static class UWBP_FieldCommandPreviewPanel_Search_C* GetDefaultObj();
	...
	void Construct();
	void ExecuteUbergraph_WBP_FieldCommandPreviewPanel_Search(int32 EntryPoint);
};
