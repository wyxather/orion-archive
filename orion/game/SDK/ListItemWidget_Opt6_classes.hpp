...
class UListItemWidget_Opt6_C : public UListItemWidget_Opt_Base
{
public:
	...
	class UKeyConfigButton1WBP_C*                ExWidget;                                          // 0x480(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UAcqImage*                             Image_47;                                          // 0x488(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	static class UListItemWidget_Opt6_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ListItemWidget_Opt6(int32 EntryPoint);
};
