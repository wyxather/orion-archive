...
{
public:
	uint8                                        Pad_ED5[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_ED6[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        BitPad_D1 : 6;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
...
public:
	...
	FDelegateProperty_                           Delegate;                                          // 0x8(0x10)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	TArray<class FName>                          BrushPropertyNamePath;                             // 0x80(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
...
{
public:
	struct FTextBlockStyle                       TextStyle;                                         // 0x8(0x270)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_EDF[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_EE0[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_EE6[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	FDelegateProperty_                           CustomDelegate;                                    // 0x14(0x10)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
};
