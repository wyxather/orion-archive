...
class UFieldCommandWidgetLead_C : public UUFieldCommandWidgetFollowBase
{
public:
	...
	static class UFieldCommandWidgetLead_C* GetDefaultObj();
	...
	class AKSCharacterBase* Get_Follow_Lead_Member();
	void LeadFailedCallback(int32 SelectIndex);
	void LeadReleaseCallback(int32 SelectIndex);
	void LeadCallback(int32 SelectIndex);
	void LeadChangeCallback(int32 SelectIndex);
	...
	void OnCloseFinish();
	void OnOpenFinish();
	void ExecuteUbergraph_FieldCommandWidgetLead(int32 EntryPoint);
};
