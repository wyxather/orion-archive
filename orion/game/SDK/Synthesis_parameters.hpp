...
{
public:
	class USoundModulatorBase*                   Modulator;                                         // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSourceEffectBitCrusherSettings       ModulationSettings;                                // 0x0(0x30)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSourceEffectChorusSettings           ModulationSettings;                                // 0x0(0x78)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSubmixEffectConvolutionReverbSettings InSettings;                                        // 0x0(0x28)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	class UAudioImpulseResponse*                 InImpulseResponse;                                 // 0x0(0x8)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSubmixEffectMultibandCompressorSettings InSettings;                                        // 0x0(0x20)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_7B8[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
