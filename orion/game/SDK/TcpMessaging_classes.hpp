...
public:
	...
	bool                                         bStopServiceWhenAppDeactivates;                    // 0x54(0x1)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_402[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
