...
bool UMovieSceneCaptureProtocolBase::IsCapturing()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCaptureProtocolBase", "IsCapturing");
...
enum class EMovieSceneCaptureProtocolState UMovieSceneCaptureProtocolBase::GetState()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCaptureProtocolBase", "GetState");
...
void UMovieSceneCapture::SetImageCaptureProtocolType(TSubclassOf<class UMovieSceneCaptureProtocolBase> ProtocolType)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCapture", "SetImageCaptureProtocolType");
...
void UMovieSceneCapture::SetAudioCaptureProtocolType(TSubclassOf<class UMovieSceneCaptureProtocolBase> ProtocolType)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCapture", "SetAudioCaptureProtocolType");
...
class UMovieSceneCaptureProtocolBase* UMovieSceneCapture::GetImageCaptureProtocol()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCapture", "GetImageCaptureProtocol");
...
class UMovieSceneCaptureProtocolBase* UMovieSceneCapture::GetAudioCaptureProtocol()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCapture", "GetAudioCaptureProtocol");
...
bool UMovieSceneCaptureEnvironment::IsCaptureInProgress()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCaptureEnvironment", "IsCaptureInProgress");
...
int32 UMovieSceneCaptureEnvironment::GetCaptureFrameNumber()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCaptureEnvironment", "GetCaptureFrameNumber");
...
float UMovieSceneCaptureEnvironment::GetCaptureElapsedTime()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCaptureEnvironment", "GetCaptureElapsedTime");
...
class UMovieSceneImageCaptureProtocolBase* UMovieSceneCaptureEnvironment::FindImageCaptureProtocol()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCaptureEnvironment", "FindImageCaptureProtocol");
...
class UMovieSceneAudioCaptureProtocolBase* UMovieSceneCaptureEnvironment::FindAudioCaptureProtocol()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MovieSceneCaptureEnvironment", "FindAudioCaptureProtocol");
...
void UUserDefinedCaptureProtocol::StopCapturingFinalPixels()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "StopCapturingFinalPixels");
...
void UUserDefinedCaptureProtocol::StartCapturingFinalPixels(struct FCapturedPixelsID& StreamID)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "StartCapturingFinalPixels");
...
void UUserDefinedCaptureProtocol::ResolveBuffer(class UTexture* Buffer, struct FCapturedPixelsID& BufferID)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "ResolveBuffer");
...
void UUserDefinedCaptureProtocol::OnWarmUp()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnWarmUp");
...
void UUserDefinedCaptureProtocol::OnTick()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnTick");
...
void UUserDefinedCaptureProtocol::OnStartCapture()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnStartCapture");
...
bool UUserDefinedCaptureProtocol::OnSetup()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnSetup");
...
void UUserDefinedCaptureProtocol::OnPreTick()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnPreTick");
...
void UUserDefinedCaptureProtocol::OnPixelsReceived(struct FCapturedPixels& Pixels, struct FCapturedPixelsID& ID, const struct FFrameMetrics& FrameMetrics)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnPixelsReceived");
...
void UUserDefinedCaptureProtocol::OnPauseCapture()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnPauseCapture");
...
void UUserDefinedCaptureProtocol::OnFinalize()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnFinalize");
...
void UUserDefinedCaptureProtocol::OnCaptureFrame()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnCaptureFrame");
...
bool UUserDefinedCaptureProtocol::OnCanFinalize()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnCanFinalize");
...
void UUserDefinedCaptureProtocol::OnBeginFinalize()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "OnBeginFinalize");
...
struct FFrameMetrics UUserDefinedCaptureProtocol::GetCurrentFrameMetrics()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "GetCurrentFrameMetrics");
...
class FString UUserDefinedCaptureProtocol::GenerateFilename(struct FFrameMetrics& InFrameMetrics)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedCaptureProtocol", "GenerateFilename");
...
void UUserDefinedImageCaptureProtocol::WriteImageToDisk(struct FCapturedPixels& PixelData, struct FCapturedPixelsID& StreamID, struct FFrameMetrics& FrameMetrics, bool bCopyImageData)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedImageCaptureProtocol", "WriteImageToDisk");
...
class FString UUserDefinedImageCaptureProtocol::GenerateFilenameForCurrentFrame()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedImageCaptureProtocol", "GenerateFilenameForCurrentFrame");
...
class FString UUserDefinedImageCaptureProtocol::GenerateFilenameForBuffer(class UTexture* Buffer, struct FCapturedPixelsID& StreamID)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("UserDefinedImageCaptureProtocol", "GenerateFilenameForBuffer");
