...
public:
	...
	uint8                                        BitPad_2F : 2;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_364[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_36E[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FNavAvoidanceMask                     AvoidanceGroup;                                    // 0x1E8(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNavAvoidanceMask                     GroupsToAvoid;                                     // 0x1EC(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FNavAvoidanceMask                     GroupsToIgnore;                                    // 0x1F0(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	...
	struct FReplicatedVehicleState               ReplicatedState;                                   // 0x204(0x14)(Net, Transient, NoDestructor, Protected, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_38C[0x24];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3DF[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3E2[0x798];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	class UWheeledVehicleMovementComponent*      WheeledVehicleMovementComponent;                   // 0xA50(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3E3[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3FE[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_400[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	class UWheeledVehicleMovementComponent*      VehicleMovement;                                   // 0x288(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FVehicleDifferential4WData            DifferentialSetup;                                 // 0x330(0x1C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
