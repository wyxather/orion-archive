...
bool UMobileInstalledContent::Mount(int32 PakOrder, const class FString& MountPoint)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobileInstalledContent", "Mount");
...
float UMobileInstalledContent::GetInstalledContentSize()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobileInstalledContent", "GetInstalledContentSize");
...
float UMobileInstalledContent::GetDiskFreeSpace()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobileInstalledContent", "GetDiskFreeSpace");
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// FDelegateProperty_                 OnSucceeded                                                      (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
...
void UMobilePendingContent::StartInstall(FDelegateProperty_ OnSucceeded, FDelegateProperty_ OnFailed)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePendingContent", "StartInstall");
...
float UMobilePendingContent::GetTotalDownloadedSize()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePendingContent", "GetTotalDownloadedSize");
...
float UMobilePendingContent::GetRequiredDiskSpace()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePendingContent", "GetRequiredDiskSpace");
...
float UMobilePendingContent::GetInstallProgress()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePendingContent", "GetInstallProgress");
...
class FText UMobilePendingContent::GetDownloadStatusText()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePendingContent", "GetDownloadStatusText");
...
float UMobilePendingContent::GetDownloadSpeed()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePendingContent", "GetDownloadSpeed");
...
float UMobilePendingContent::GetDownloadSize()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePendingContent", "GetDownloadSize");
...
void UMobilePatchingLibrary::RequestContent(const class FString& RemoteManifestURL, const class FString& CloudURL, const class FString& InstallDirectory, FDelegateProperty_ OnSucceeded, FDelegateProperty_ OnFailed)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePatchingLibrary", "RequestContent");
...
bool UMobilePatchingLibrary::HasActiveWiFiConnection()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePatchingLibrary", "HasActiveWiFiConnection");
...
TArray<class FString> UMobilePatchingLibrary::GetSupportedPlatformNames()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePatchingLibrary", "GetSupportedPlatformNames");
...
class UMobileInstalledContent* UMobilePatchingLibrary::GetInstalledContent(const class FString& InstallDirectory)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePatchingLibrary", "GetInstalledContent");
...
class FString UMobilePatchingLibrary::GetActiveDeviceProfileName()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("MobilePatchingLibrary", "GetActiveDeviceProfileName");
