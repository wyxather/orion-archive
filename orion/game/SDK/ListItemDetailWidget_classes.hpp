...
class UListItemDetailWidget_C : public UListItemDetailWidgetBase
{
public:
	...
	class UKSTextBlock*                          KSTextBlock_0;                                     // 0x280(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UListItemDetailWidget_C* GetDefaultObj();

	void SetText(class FText NewParam);
	void Hide();
	void Show();
	void ExecuteUbergraph_ListItemDetailWidget(int32 EntryPoint);
};
