...
void UGameMapsSettings::SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("GameMapsSettings", "SetSkipAssigningGamepadToPlayer1");
...
bool UGameMapsSettings::GetSkipAssigningGamepadToPlayer1()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("GameMapsSettings", "GetSkipAssigningGamepadToPlayer1");
...
class UGameMapsSettings* UGameMapsSettings::GetGameMapsSettings()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("GameMapsSettings", "GetGameMapsSettings");
