...
public:
	...
	uint8                                        Pad_9DD[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A12[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_A13[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
