...
class UBarMenuStoryChList_C : public UAcqUserWidget
{
public:
	...
	static class UBarMenuStoryChList_C* GetDefaultObj();

	void Setup(int32 CharaID);
	...
	void ExecuteUbergraph_BarMenuStoryChList(int32 EntryPoint);
};
