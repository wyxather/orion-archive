...
struct ABP_FCv2_FieldCommandFlow_Placate_Release_C_IsAvailable_Params
{
public:
...
struct ABP_FCv2_FieldCommandFlow_Placate_Release_C_UpdateFlow_Params
{
public:
...
struct ABP_FCv2_FieldCommandFlow_Placate_Release_C_SetState_Params
{
public:
	enum class EFCV2_SequenceState_Placate_Release NewValue;                                          // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x1 (0x1 - 0x0)
// Function BP_FCv2_FieldCommandFlow_Placate_Release.BP_FCv2_FieldCommandFlow_Placate_Release_C.GetState
struct ABP_FCv2_FieldCommandFlow_Placate_Release_C_GetState_Params
{
public:
	enum class EFCV2_SequenceState_Placate_Release ReturnValue;                                       // 0x0(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
