...
class UWBP_FieldCommandPreviewPanel_Dose_C : public UWBP_FIeldCommandPreviewPanelBase_C
{
public:
	...
	static class UWBP_FieldCommandPreviewPanel_Dose_C* GetDefaultObj();
	...
	void Construct();
	void ExecuteUbergraph_WBP_FieldCommandPreviewPanel_Dose(int32 EntryPoint);
};
