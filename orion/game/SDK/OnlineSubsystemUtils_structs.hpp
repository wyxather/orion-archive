...
{
public:
	uint8                                        Pad_11A[0x108];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_123[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<struct FPlayerReservation>            RemovedPartyMembers;                               // 0x40(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
};
