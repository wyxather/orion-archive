...
class ABP_FCv2_FieldCommandFlow_Placate_Release_C : public ABP_FCv2_FieldCommandFlowBase_C
{
public:
	enum class EFCV2_SequenceState_Placate_Release State;                                             // 0x5B5(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	static class ABP_FCv2_FieldCommandFlow_Placate_Release_C* GetDefaultObj();
	...
	void PreProcess();
	void SetState(enum class EFCV2_SequenceState_Placate_Release NewValue);
	enum class EFCV2_SequenceState_Placate_Release GetState();
};
