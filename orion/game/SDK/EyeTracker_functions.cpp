...
void UEyeTrackerFunctionLibrary::SetEyeTrackedPlayer(class APlayerController* PlayerController)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("EyeTrackerFunctionLibrary", "SetEyeTrackedPlayer");
...
bool UEyeTrackerFunctionLibrary::IsStereoGazeDataAvailable()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("EyeTrackerFunctionLibrary", "IsStereoGazeDataAvailable");
...
bool UEyeTrackerFunctionLibrary::IsEyeTrackerConnected()
{
	...
	if (!Func)
		Func = this->Class->GetFunction("EyeTrackerFunctionLibrary", "IsEyeTrackerConnected");
...
bool UEyeTrackerFunctionLibrary::GetStereoGazeData(struct FEyeTrackerStereoGazeData* OutGazeData)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("EyeTrackerFunctionLibrary", "GetStereoGazeData");
...
bool UEyeTrackerFunctionLibrary::GetGazeData(struct FEyeTrackerGazeData* OutGazeData)
{
	...
	if (!Func)
		Func = this->Class->GetFunction("EyeTrackerFunctionLibrary", "GetGazeData");
