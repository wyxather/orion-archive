...
struct ULibAccessor_EffectManager_C_GetEffectManager_Params
{
public:
	...
	class AEffectManagerBP_C*                    EffectManager;                                     // 0x8(0x8)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
