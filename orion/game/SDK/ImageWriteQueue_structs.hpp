...
public:
	...
	FDelegateProperty_                           OnComplete;                                        // 0x4(0x10)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_295[0x46];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
