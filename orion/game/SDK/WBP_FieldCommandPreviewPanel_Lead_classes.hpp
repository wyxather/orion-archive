...
class UWBP_FieldCommandPreviewPanel_Lead_C : public UWBP_FIeldCommandPreviewPanelBase_C
{
public:
	...
	static class UWBP_FieldCommandPreviewPanel_Lead_C* GetDefaultObj();
	...
	void Construct();
	void ExecuteUbergraph_WBP_FieldCommandPreviewPanel_Lead(int32 EntryPoint);
};
