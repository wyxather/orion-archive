...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        if (ImGui::TreeNode("Rendering more text into the same line"))
        {
            ...
            ImGui::Selectable("main.c",    &selected[0]); ImGui::SameLine(); ImGui::Button("Link 1");
            ImGui::Selectable("Hello.cpp", &selected[1]); ImGui::SameLine(); ImGui::Button("Link 2");
            ImGui::Selectable("Hello.h",   &selected[2]); ImGui::SameLine(); ImGui::Button("Link 3");
            ImGui::TreePop();
        }
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Key Ownership"))
        {
            ...
            if (ImGui::TreeNode("Usage Scenarios"))
            {
                ...
                if (ImGui::TreeNode("6. Claiming Escape away from an InputText()"))
                {
                    static char buf[9];
                ...
                if (ImGui::TreeNode("7. Claiming Escape away from an nav logic exiting a child"))
                {
                ...
                if (ImGui::TreeNode("8. Claiming Tab, CTRL+Tab"))
                {
                    static int mode = 0;
                    static int counter = 0;
