...
#include "BL3_AttInit_MoxxiEvent_ElementalChance_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AttInit_MoxxiEvent_ElementalChance.AttInit_MoxxiEvent_ElementalChance_C");
		return ptr;
	}
