...
#include "BL3_Passive_Gunner_ExperimentalMunitions_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Passive_Gunner_ExperimentalMunitions.Passive_Gunner_ExperimentalMunitions_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Passive_Gunner_ExperimentalMunitions(int EntryPoint);
};
