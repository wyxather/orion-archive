...
#include "BL3_LightProjectile_DoubleTap_Cryo_parameters.hpp"
...
void ULightProjectile_DoubleTap_Cryo_C::OnDamage(class ULightProjectile** Projectile, struct FHitResult* Hit, bool* bCritical)
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_DoubleTap_Cryo.LightProjectile_DoubleTap_Cryo_C.OnDamage");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_DoubleTap_Cryo.LightProjectile_DoubleTap_Cryo_C.OnBegin");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_DoubleTap_Cryo.LightProjectile_DoubleTap_Cryo_C.OnLifetimeExpired");
