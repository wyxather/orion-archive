...
#include "BL3_PassiveSkill_Operative_Refreshment_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PassiveSkill_Operative_Refreshment.PassiveSkill_Operative_Refreshment_C");
		return ptr;
	}


	void OnActivated();
	void ExecuteUbergraph_PassiveSkill_Operative_Refreshment(int EntryPoint);
};
