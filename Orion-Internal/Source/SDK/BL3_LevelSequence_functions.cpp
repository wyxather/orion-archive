...
#include "BL3_LevelSequence_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LevelSequence.LevelSequenceActor.OnRequestStopTicking");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LevelSequence.LevelSequenceActor.OnCancelStopTicking");
