...
#include "BL3_Proj_Artifact_Sparkplug_Augment_structs.hpp"
...
class AProj_Artifact_Sparkplug_Augment_C : public AOakProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_Artifact_Sparkplug_Augment.Proj_Artifact_Sparkplug_Augment_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Proj_Artifact_Sparkplug_Augment(int EntryPoint);
};
