...
#include "BL3_ActionDodgeVehicle_Moving_BR_structs.hpp"
...
class UActionDodgeVehicle_Moving_BR_C : public UOakAction_Anim
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ActionDodgeVehicle_Moving_BR.ActionDodgeVehicle_Moving_BR_C");
		return ptr;
	}
