...
#include "BL3_Proj_VLA_SR_Rocket_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_VLA_SR_Rocket.Proj_VLA_SR_Rocket_C");
		return ptr;
	}
	...
	void OnExplode();
	void ExecuteUbergraph_Proj_VLA_SR_Rocket(int EntryPoint);
};
