...
#include "BL3_BPAnim_PS_Tediore_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PS_Tediore.BPAnim_PS_Tediore_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_PS_Tediore(int EntryPoint);
};
