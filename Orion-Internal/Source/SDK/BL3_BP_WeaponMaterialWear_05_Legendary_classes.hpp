...
#include "BL3_BP_WeaponMaterialWear_05_Legendary_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_WeaponMaterialWear_05_Legendary.BP_WeaponMaterialWear_05_Legendary_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_WeaponMaterialWear_05_Legendary(int EntryPoint);
};
