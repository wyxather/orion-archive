...
#include "BL3_BPAnim_HW_TOR_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_HW_TOR.BPAnim_HW_TOR_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_HW_TOR(int EntryPoint);
};
