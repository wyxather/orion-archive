...
#include "BL3_BP_PhaseTranceSingularity_Slam_Fracture_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PhaseTranceSingularity_Slam_Fracture.BP_PhaseTranceSingularity_Slam_Fracture_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PhaseTranceSingularity_Slam_Fracture(int EntryPoint);
};
