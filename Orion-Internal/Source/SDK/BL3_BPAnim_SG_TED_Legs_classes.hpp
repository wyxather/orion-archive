...
#include "BL3_BPAnim_SG_TED_Legs_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x12B8(0x0008) MISSED OFFSET
	...
	class ABPChar_TedioreTurret_C*                     Base_BPChar;                                              // 0x1788(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SG_TED_Legs.BPAnim_SG_TED_Legs_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SG_TED_Legs(int EntryPoint);
};
