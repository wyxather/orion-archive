...
struct FAssetData
{
	...
	struct FDateTime                                   AssetDateModified;                                        // 0x0050(0x0008) (BlueprintVisible, BlueprintReadOnly, Transient)
};
...
struct FARFilter
{
	...
	bool                                               bExcludeLocalizedAssets;                                  // 0x00E3(0x0001) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
