...
#include "BL3_BPAnim_PetApe_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x1278(0x0008) MISSED OFFSET
	...
	unsigned char                                      UnknownData01[0x8];                                       // 0x46A8(0x0008) MISSED OFFSET
	...
	TEnumAsByte<EApeVariants>                          Variants;                                                 // 0x9C60(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x9C61(0x0003) MISSED OFFSET
	float                                              L_ArmIK;                                                  // 0x9C64(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              R_ArmIK;                                                  // 0x9C68(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               InCombatStance;                                           // 0x9C6C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               Biped;                                                    // 0x9C6D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               DefaultStances;                                           // 0x9C6E(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x9C6F(0x0001) MISSED OFFSET
	class AOakCharacter*                               Character;                                                // 0x9C70(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	class UGbxCharacterMovementComponent*              GbxMoveComp;                                              // 0x9C78(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	class UOakCharacterMovementComponent*              OakMoveComp;                                              // 0x9C80(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	bool                                               Has_Fall_Anims;                                           // 0x9C88(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<Enum_CustomMoveTypes>                  CustomMoves;                                              // 0x9C89(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               Biped_Combat;                                             // 0x9C8A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               InPassive;                                                // 0x9C8B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               WeaponValid;                                              // 0x9C8C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x9C8D(0x0003) MISSED OFFSET
	struct FName                                       RightGrip;                                                // 0x9C90(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               WeaponIsValid;                                            // 0x9C98(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData05[0x7];                                       // 0x9C99(0x0007) MISSED OFFSET
	class AOakWeapon*                                  BaseWeapon;                                               // 0x9CA0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	int                                                GripType;                                                 // 0x9CA8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ForeGripType;                                             // 0x9CAC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UManufacturerData*                           Manufacturer;                                             // 0x9CB0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<struct FName>                               LiveWeaponPoses;                                          // 0x9CB8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FAStruct_Generic_WeaponAnimContainer        WeaponPoses;                                              // 0x9CC8(0x0A20) (Edit, BlueprintVisible, DisableEditOnInstance)
	int                                                CurrentWeaponManufacturer;                                // 0xA6E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                WeaponType;                                               // 0xA6EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PetApe.BPAnim_PetApe_C");
		return ptr;
	}


	void CalculateWeaponHoldData(class AWeapon* New_Weapon, bool* ValidWeapon);
	void EvaluateStances(const struct FName& StanceData, const struct FName& StanceType);
	...
	void ExecuteUbergraph_BPAnim_PetApe(int EntryPoint);
};
