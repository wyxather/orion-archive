...
#include "BL3_BPAnim_PS_TED_Legs_structs.hpp"
...
public:
	...
	class ABPChar_TedioreTurret_C*                     Base_BPChar;                                              // 0x1638(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PS_TED_Legs.BPAnim_PS_TED_Legs_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_PS_TED_Legs(int EntryPoint);
};
