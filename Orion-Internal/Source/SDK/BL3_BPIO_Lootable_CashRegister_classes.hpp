...
#include "BL3_BPIO_Lootable_CashRegister_structs.hpp"
...
// BlueprintGeneratedClass BPIO_Lootable_CashRegister.BPIO_Lootable_CashRegister_C
// 0x0014 (0x08C8 - 0x08B4)
class ABPIO_Lootable_CashRegister_C : public ABPIO_Lootable_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BPIO_Lootable_CashRegister.BPIO_Lootable_CashRegister_C");
		return ptr;
	}
