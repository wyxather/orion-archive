...
#include "BL3_Condition_IsCriticalHit_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Condition_IsCriticalHit.Condition_IsCriticalHit_C.EvaluateCondition");
