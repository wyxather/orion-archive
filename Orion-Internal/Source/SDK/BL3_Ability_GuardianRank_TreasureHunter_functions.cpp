...
#include "BL3_Ability_GuardianRank_TreasureHunter_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Ability_GuardianRank_TreasureHunter.Ability_GuardianRank_TreasureHunter_C.CausedDeath");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Ability_GuardianRank_TreasureHunter.Ability_GuardianRank_TreasureHunter_C.OnActivated");
...
void UAbility_GuardianRank_TreasureHunter_C::ExecuteUbergraph_Ability_GuardianRank_TreasureHunter(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function Ability_GuardianRank_TreasureHunter.Ability_GuardianRank_TreasureHunter_C.ExecuteUbergraph_Ability_GuardianRank_TreasureHunter");
