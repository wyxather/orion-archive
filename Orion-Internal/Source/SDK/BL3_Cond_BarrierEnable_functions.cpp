...
#include "BL3_Cond_BarrierEnable_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Cond_BarrierEnable.Cond_BarrierEnable_C.EvaluateCondition");
