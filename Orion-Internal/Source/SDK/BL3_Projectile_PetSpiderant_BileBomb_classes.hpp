...
#include "BL3_Projectile_PetSpiderant_BileBomb_structs.hpp"
...
public:
	...
	class UClass*                                      DamageType;                                               // 0x0710(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UExplosionData*                              ExplosionDef;                                             // 0x0718(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Projectile_PetSpiderant_BileBomb.Projectile_PetSpiderant_BileBomb_C");
		return ptr;
	}
	...
	void OnExplode();
	void ExecuteUbergraph_Projectile_PetSpiderant_BileBomb(int EntryPoint);
};
