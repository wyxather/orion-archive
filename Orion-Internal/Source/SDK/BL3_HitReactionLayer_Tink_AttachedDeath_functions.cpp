...
#include "BL3_HitReactionLayer_Tink_AttachedDeath_parameters.hpp"
...
// Function HitReactionLayer_Tink_AttachedDeath.HitReactionLayer_Tink_AttachedDeath_C.EvaluateTag
...
class UHitReactionTag* UHitReactionLayer_Tink_AttachedDeath_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_Tink_AttachedDeath.HitReactionLayer_Tink_AttachedDeath_C.EvaluateTag");

	UHitReactionLayer_Tink_AttachedDeath_C_EvaluateTag_Params params;
