...
#include "BL3_Projectile_MAL_SR_ASMD_Orb_structs.hpp"
...
public:
	...
	class USphereComponent*                            ProjOverlap;                                              // 0x0798(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Projectile_MAL_SR_ASMD_Orb.Projectile_MAL_SR_ASMD_Orb_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Projectile_MAL_SR_ASMD_Orb(int EntryPoint);
};
