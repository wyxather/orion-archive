...
#include "BL3_BP_GM_Payload_WizardOfNOG_parameters.hpp"
...
// Function BP_GM_Payload_WizardOfNOG.BP_GM_Payload_WizardOfNOG_C.K2_GrenadeDamageDealt
...
void UBP_GM_Payload_WizardOfNOG_C::K2_GrenadeDamageDealt(class AGrenade** Grenade, class AGrenadeMod** GrenadeMod, class AOakCharacter** Character, struct FDamageDataEventDetails* DamageEvent, struct FPayloadInstanceData* InstanceData)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_WizardOfNOG.BP_GM_Payload_WizardOfNOG_C.K2_GrenadeDamageDealt");
