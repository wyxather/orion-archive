...
#include "BL3_Condition_TEDWeaponType_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Condition_TEDWeaponType.Condition_TEDWeaponType_C.EvaluateCondition");
