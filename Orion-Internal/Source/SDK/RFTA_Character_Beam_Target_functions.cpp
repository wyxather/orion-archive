...
#include "RFTA_Character_Beam_Target_parameters.hpp"
...
void ACharacter_Beam_Target_C::FilterIncomingDamage(struct FDamageInfo* DamageInfo, struct FDamageInfo* DamageInfoOut, bool* ShouldApplyDamage)
{
