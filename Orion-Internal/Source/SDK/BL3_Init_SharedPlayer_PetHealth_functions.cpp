...
#include "BL3_Init_SharedPlayer_PetHealth_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Init_SharedPlayer_PetHealth.Init_SharedPlayer_PetHealth_C.CalculateAttributeInitialValue");
