...
#include "BL3_MovieScene_structs.hpp"
...
public:
	...
	bool                                               bDisableURO;                                              // 0x0342(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bReversePlayback : 1;                                     // 0x03CC(0x0001)
	unsigned char                                      UnknownData02[0xB];                                       // 0x03CD(0x000B) MISSED OFFSET
	class UMovieSceneSequence*                         Sequence;                                                 // 0x03D8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FFrameNumber                                StartTime;                                                // 0x03E0(0x0004)
	int                                                DurationFrames;                                           // 0x03E4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                CurrentNumLoops;                                          // 0x03E8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x14];                                      // 0x03EC(0x0014) MISSED OFFSET
	struct FMovieSceneSequencePlaybackSettings         PlaybackSettings;                                         // 0x0400(0x0048)
	unsigned char                                      UnknownData04[0x3A8];                                     // 0x0448(0x03A8) MISSED OFFSET
...
public:
	...
	bool                                               DisableFrameSnapping;                                     // 0x00CA(0x0001) (ZeroConstructor, IsPlainOldData)
