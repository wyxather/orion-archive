...
#include "BL3_PlayerCondition_ShieldsEmpty_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerCondition_ShieldsEmpty.PlayerCondition_ShieldsEmpty_C.EvaluateCondition");
