...
#include "BL3_Ability_GuardianRank_Resilient_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_GuardianRank_Resilient.Ability_GuardianRank_Resilient_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Ability_GuardianRank_Resilient(int EntryPoint);
};
