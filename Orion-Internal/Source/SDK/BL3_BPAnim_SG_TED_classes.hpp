...
#include "BL3_BPAnim_SG_TED_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SG_TED.BPAnim_SG_TED_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SG_TED(int EntryPoint);
};
