...
#include "BL3_Proj_ATL_Tracker_Ball_Plumage_structs.hpp"
...
// BlueprintGeneratedClass Proj_ATL_Tracker_Ball_Plumage.Proj_ATL_Tracker_Ball_Plumage_C
// 0x0048 (0x0A20 - 0x09D8)
class AProj_ATL_Tracker_Ball_Plumage_C : public AProj_ATL_TrackerMaster_Base_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_ATL_Tracker_Ball_Plumage.Proj_ATL_Tracker_Ball_Plumage_C");
		return ptr;
	}
	...
	void GbxAsyncRequest_Spawned_EC7096D84CE43BFCBCFD209C516EA52E(class AActor* Actor, int InstanceIndex);
	void OnExplode();
	...
	void MultiTargetTag();
	void ExecuteUbergraph_Proj_ATL_Tracker_Ball_Plumage(int EntryPoint);
};
