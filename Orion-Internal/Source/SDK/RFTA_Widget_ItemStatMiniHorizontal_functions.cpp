...
#include "RFTA_Widget_ItemStatMiniHorizontal_parameters.hpp"
...
void UWidget_ItemStatMiniHorizontal_C::Init(struct FInspectStat* Stat, bool* Comparing, struct FInspectStat* CompareStat, struct FInspectInfo* InspectInfo)
{
