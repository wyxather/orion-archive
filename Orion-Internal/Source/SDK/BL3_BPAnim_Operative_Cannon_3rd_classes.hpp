...
#include "BL3_BPAnim_Operative_Cannon_3rd_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_Operative_Cannon_3rd.BPAnim_Operative_Cannon_3rd_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_Operative_Cannon_3rd(int EntryPoint);
};
