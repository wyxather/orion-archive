...
#include "BL3_Challenge_Manufacturer_Vladof_Bipod_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_Manufacturer_Vladof_Bipod.Challenge_Manufacturer_Vladof_Bipod_C");
		return ptr;
	}
