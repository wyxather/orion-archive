...
#include "BL3_Ability_OnePumpOrTwoOrThree_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_OnePumpOrTwoOrThree.Ability_OnePumpOrTwoOrThree_C");
		return ptr;
	}
	...
	void OnActivated();
	void WeaponFired();
	void ExecuteUbergraph_Ability_OnePumpOrTwoOrThree(int EntryPoint);
};
