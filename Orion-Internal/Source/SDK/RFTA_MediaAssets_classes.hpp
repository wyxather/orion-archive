...
#include "RFTA_MediaAssets_structs.hpp"
...
{
public:
	EMediaSoundChannels                                Channels;                                                 // 0x0680(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0680(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData03[0x1E8];                                     // 0x06A8(0x01E8) MISSED OFFSET
