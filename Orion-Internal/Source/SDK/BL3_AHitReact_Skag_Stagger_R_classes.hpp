...
#include "BL3_AHitReact_Skag_Stagger_R_structs.hpp"
...
class UAHitReact_Skag_Stagger_R_C : public UOakAction_Anim
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AHitReact_Skag_Stagger_R.AHitReact_Skag_Stagger_R_C");
		return ptr;
	}
