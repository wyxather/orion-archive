...
#include "BL3_BPAnim_AR_DAL_structs.hpp"
...
public:
	...
	class UAnimSequence*                               IdleAddAnim;                                              // 0x1290(0x0008) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAddIdleAnim;                                             // 0x1298(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_AR_DAL.BPAnim_AR_DAL_C");
		return ptr;
	}


	void UpdateIdleAnim(unsigned char NewParam, int A);
	...
	void ExecuteUbergraph_BPAnim_AR_DAL(int EntryPoint);
};
