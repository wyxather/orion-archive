...
#include "BL3_BP_GM_Delivery_Slider_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Delivery_Slider.BP_GM_Delivery_Slider_C.K2_GrenadeInitialized");
