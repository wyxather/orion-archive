...
#include "BL3_LightProjectile_VLA_AR_ETechUnderbarrel_classes.hpp"
...
struct ULightProjectile_VLA_AR_ETechUnderbarrel_C_OnExplode_Params
{
...
struct ULightProjectile_VLA_AR_ETechUnderbarrel_C_OnLifetimeExpired_Params
{
	class ULightProjectile**                           Projectile;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
