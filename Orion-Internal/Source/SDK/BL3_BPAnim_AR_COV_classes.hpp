...
#include "BL3_BPAnim_AR_COV_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_AR_COV.BPAnim_AR_COV_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_AR_COV(int EntryPoint);
};
