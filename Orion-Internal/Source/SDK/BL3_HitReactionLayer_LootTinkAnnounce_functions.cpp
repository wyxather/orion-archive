...
#include "BL3_HitReactionLayer_LootTinkAnnounce_parameters.hpp"
...
// Function HitReactionLayer_LootTinkAnnounce.HitReactionLayer_LootTinkAnnounce_C.EvaluateTag
...
class UHitReactionTag* UHitReactionLayer_LootTinkAnnounce_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_LootTinkAnnounce.HitReactionLayer_LootTinkAnnounce_C.EvaluateTag");

	UHitReactionLayer_LootTinkAnnounce_C_EvaluateTag_Params params;
