...
#include "RFTA_Action_Revive_Invulnerable_parameters.hpp"
...
void UAction_Revive_Invulnerable_C::FilterIncomingDamage(struct FDamageInfo* DamageInfo, struct FDamageInfo* DamageInfoOut, bool* ShouldApplyDamage)
{
