...
#include "BL3_InputComponent_IronBear_structs.hpp"
...
public:
	...
	class AOakCharacter_IronBear*                      IronBear;                                                 // 0x02F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__8;                                         // 0x0300(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__10;                                        // 0x0378(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__13;                                        // 0x03F0(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__15;                                        // 0x0468(0x0078)
	struct FGbxInputEvent_OakMoveAxis                  GbxInputEvent__4;                                         // 0x04E0(0x0070)
	struct FGbxInputEvent_OakLookAxis                  GbxInputEvent__5;                                         // 0x0550(0x0080)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__7;                                         // 0x05D0(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__2;                                         // 0x0648(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__3;                                         // 0x06C0(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__6;                                         // 0x0738(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__1;                                         // 0x07B0(0x0078)
	struct FGbxInputEvent_Button_PressHoldRelease      GbxInputEvent__9;                                         // 0x0828(0x0080)
	struct FGbxInputEvent_Button_PressHoldRelease      GbxInputEvent__11;                                        // 0x08A8(0x0080)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__12;                                        // 0x0928(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__14;                                        // 0x09A0(0x0078)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass InputComponent_IronBear.InputComponent_IronBear_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_InputComponent_IronBear(int EntryPoint);
};
