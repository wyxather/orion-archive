...
#include "BL3_AnimNotify_EnableVehicleControl_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AnimNotify_EnableVehicleControl.AnimNotify_EnableVehicleControl_C.Received_Notify");
