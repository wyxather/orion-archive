...
#include "BL3_AIAction_PetJabbermon_Evo1_Beefcake_classes.hpp"
...
struct UAIAction_PetJabbermon_Evo1_Beefcake_C_BndEvt__SimpleMelee_OnStoppedEventBP_AIActionBlueprintResultDelegate__DelegateSignature_AIAction_PetJabbermon_Evo1_Beefcake_Params
{
...
struct UAIAction_PetJabbermon_Evo1_Beefcake_C_BndEvt__SimpleWeapon_OnStartedEventBP_AIActionBlueprintDelegate__DelegateSignature_AIAction_PetJabbermon_Evo1_Beefcake_Params
{
	class AGbxAIController*                            AIController;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class AGbxCharacter*                               Character;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	struct FAIActionBlueprintContext                   Context;                                                  // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
struct UAIAction_PetJabbermon_Evo1_Beefcake_C_ExecuteUbergraph_AIAction_PetJabbermon_Evo1_Beefcake_Params
{
