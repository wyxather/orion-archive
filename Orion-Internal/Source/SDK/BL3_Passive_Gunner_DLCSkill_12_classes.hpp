...
#include "BL3_Passive_Gunner_DLCSkill_12_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Passive_Gunner_DLCSkill_12.Passive_Gunner_DLCSkill_11_C");
		return ptr;
	}


	void GunnerCausedElementalEffect(class AActor** Causer, struct FStatusEffectSpec* Spec);
	void ExecuteUbergraph_Passive_Gunner_DLCSkill_12(int EntryPoint);
};
