...
#include "BL3_BPAnim_SR_JAK_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SR_JAK.BPAnim_SR_JAK_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SR_JAK(int EntryPoint);
};
