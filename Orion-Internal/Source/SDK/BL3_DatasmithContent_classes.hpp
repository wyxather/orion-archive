...
#include "BL3_DatasmithContent_structs.hpp"
...
{
public:
	EDatasmithAreaLightActorShape                      LightShape;                                               // 0x0458(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0459(0x0003) MISSED OFFSET
	struct FVector2D                                   Dimensions;                                               // 0x045C(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                Color;                                                    // 0x0464(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              Intensity;                                                // 0x0474(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class FString STATIC_GetDatasmithUserDataValueForKey(class UObject* Object, const struct FName& Key);
...
{
public:
	class UDatasmithScene*                             Scene;                                                    // 0x0458(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	TMap<struct FName, TSoftObjectPtr<class AActor>>   RelatedActors;                                            // 0x0460(0x0050) (Edit, ZeroConstructor, EditConst)
