...
#include "BL3_HitReactionLayer_SpiderantRollCharge_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_SpiderantRollCharge_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_SpiderantRollCharge.HitReactionLayer_SpiderantRollCharge_C.EvaluateTag");

	UHitReactionLayer_SpiderantRollCharge_C_EvaluateTag_Params params;
