...
#include "BL3_LightProjectile_HYP_IceBurger_Child1_classes.hpp"
...
struct ULightProjectile_HYP_IceBurger_Child1_C_OnDamage_Params
{
...
struct ULightProjectile_HYP_IceBurger_Child1_C_OnExplode_Params
{
	class ULightProjectile**                           Projectile;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function LightProjectile_HYP_IceBurger_Child1.LightProjectile_HYP_IceBurger_Child1_C.OnLifetimeExpired
struct ULightProjectile_HYP_IceBurger_Child1_C_OnLifetimeExpired_Params
{
	class ULightProjectile**                           Projectile;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function LightProjectile_HYP_IceBurger_Child1.LightProjectile_HYP_IceBurger_Child1_C.OnRicochet
struct ULightProjectile_HYP_IceBurger_Child1_C_OnRicochet_Params
{
	class ULightProjectile**                           Projectile;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	struct FHitResult*                                 Hit;                                                      // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData)
