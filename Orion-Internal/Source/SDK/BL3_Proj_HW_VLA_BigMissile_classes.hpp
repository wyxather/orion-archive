...
#include "BL3_Proj_HW_VLA_BigMissile_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_HW_VLA_BigMissile.Proj_HW_VLA_BigMissile_C");
		return ptr;
	}
	...
	void OnExplode();
	void ExecuteUbergraph_Proj_HW_VLA_BigMissile(int EntryPoint);
};
