...
#include "BL3_BP_GM_Payload_AcidBurn_parameters.hpp"
...
void UBP_GM_Payload_AcidBurn_C::K2_GrenadeDamageDealt(class AGrenade** Grenade, class AGrenadeMod** GrenadeMod, class AOakCharacter** Character, struct FDamageDataEventDetails* DamageEvent, struct FPayloadInstanceData* InstanceData)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_AcidBurn.BP_GM_Payload_AcidBurn_C.K2_GrenadeDamageDealt");

	UBP_GM_Payload_AcidBurn_C_K2_GrenadeDamageDealt_Params params;
