...
#include "BL3_PassiveSkill_Operative_KillSkillParent_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PassiveSkill_Operative_KillSkillParent.PassiveSkill_Operative_KillSkillParent_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PassiveSkill_Operative_KillSkillParent(int EntryPoint);
};
