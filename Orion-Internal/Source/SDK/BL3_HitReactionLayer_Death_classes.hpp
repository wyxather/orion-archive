...
#include "BL3_HitReactionLayer_Death_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass HitReactionLayer_Death.HitReactionLayer_Death_C");
		return ptr;
	}
