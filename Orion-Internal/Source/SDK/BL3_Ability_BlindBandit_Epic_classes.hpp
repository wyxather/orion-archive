...
#include "BL3_Ability_BlindBandit_Epic_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_BlindBandit_Epic.Ability_BlindBandit_Epic_C");
		return ptr;
	}
	...
	void OnDeactivated();
	void ExecuteUbergraph_Ability_BlindBandit_Epic(int EntryPoint);
};
