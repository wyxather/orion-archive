...
#include "BL3_HitReactionLayer_BossNoLaunch_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_BossNoLaunch_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_BossNoLaunch.HitReactionLayer_BossNoLaunch_C.EvaluateTag");

	UHitReactionLayer_BossNoLaunch_C_EvaluateTag_Params params;
