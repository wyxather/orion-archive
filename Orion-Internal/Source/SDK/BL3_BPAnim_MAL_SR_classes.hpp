...
#include "BL3_BPAnim_MAL_SR_structs.hpp"
...
public:
	...
	class UAnimSequence*                               WeaponIdleAnim;                                           // 0x0990(0x0008) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_MAL_SR.BPAnim_MAL_SR_C");
		return ptr;
	}


	void UpdateIdleAnim(int A);
	...
	void ExecuteUbergraph_BPAnim_MAL_SR(int EntryPoint);
};
