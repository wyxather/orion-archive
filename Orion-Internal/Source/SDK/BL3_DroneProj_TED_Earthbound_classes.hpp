...
#include "BL3_DroneProj_TED_Earthbound_structs.hpp"
...
// BlueprintGeneratedClass DroneProj_TED_Earthbound.DroneProj_TED_Earthbound_C
// 0x0128 (0x0858 - 0x0730)
class ADroneProj_TED_Earthbound_C : public AOakDroneProjectile
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0730(0x0008) (Transient, DuplicateTransient)
	class USocketComponent*                            Muzzle2;                                                  // 0x0738(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DroneProj_TED_Earthbound.DroneProj_TED_Earthbound_C");
		return ptr;
	}
	...
	void RebindMoveTarget(class AActor* DamageReceiver, class AActor* DamageCauser);
	void CheckForTargets();
	void ExecuteUbergraph_DroneProj_TED_Earthbound(int EntryPoint);
};
