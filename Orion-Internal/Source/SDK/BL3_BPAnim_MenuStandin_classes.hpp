...
#include "BL3_BPAnim_MenuStandin_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x1DA8(0x0008) MISSED OFFSET
	...
	TEnumAsByte<EAEnum_WeaponType>                     WeaponType;                                               // 0x4308(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x4309(0x0007) MISSED OFFSET
	TArray<struct FName>                               LiveWeaponPoses;                                          // 0x4310(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class AOakWeapon*                                  BaseWeapon;                                               // 0x4320(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	int                                                Grip_Type;                                                // 0x4328(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ForeGrip_Type;                                            // 0x432C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                Pistol_Stock;                                             // 0x4330(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x4334(0x0004) MISSED OFFSET
	class UManufacturerData*                           Manufacturer;                                             // 0x4338(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                Current_Weapon_Type;                                      // 0x4340(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                Current_Weapon_Manufacturer;                              // 0x4344(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               VLA_AR;                                                   // 0x4348(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x4349(0x0007) MISSED OFFSET
	struct FName                                       AlternateGrip;                                            // 0x4350(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       LeftGrip;                                                 // 0x4358(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      WeaponMode;                                               // 0x4360(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      SecondaryModePart;                                        // 0x4361(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x6];                                       // 0x4362(0x0006) MISSED OFFSET
	struct FName                                       RightGrip;                                                // 0x4368(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       AddWeapPose_RHBase;                                       // 0x4370(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bIsPistol;                                                // 0x4378(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               AltMode;                                                  // 0x4379(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData05[0x6];                                       // 0x437A(0x0006) MISSED OFFSET
	struct FName                                       WeaponDownPose;                                           // 0x4380(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       AdditiveWeaponPose;                                       // 0x4388(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               JAK_AR_Crank;                                             // 0x4390(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData06[0x7];                                       // 0x4391(0x0007) MISSED OFFSET
	struct FAStruct_WeaponAnimContainer_Menu           AStruct_WeaponAnimContainer;                              // 0x4398(0x0780) (Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<struct FName>                               AnimSetList;                                              // 0x4B18(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	bool                                               DisableAdditives;                                         // 0x4B28(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_MenuStandin.BPAnim_MenuStandin_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_MenuStandin(int EntryPoint);
};
