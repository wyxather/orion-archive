...
#include "RFTA_PropertyPath_classes.hpp"
...
struct FAnimationEventBinding
{
	...
	struct FScriptDelegate                             Delegate;                                                 // 0x0008(0x0014) (ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
...
{
	unsigned char                                      bOverride_TextShapingMethod : 1;                          // 0x0000(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bOverride_TextFlowDirection : 1;                          // 0x0000(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FWidgetNavigationData
{
	...
	struct FScriptDelegate                             CustomDelegate;                                           // 0x0014(0x0014) (ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
};
