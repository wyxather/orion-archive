...
#include "BL3_PC_OakClothActor_parameters.hpp"
...
void APC_OakClothActor_C::Set_Per_Element_Layer_4_Base_Material_Parameters(class UMaterialInstanceDynamic* Material_Instance_Dynamic, int Array_Index, class UMaterialInstanceDynamic* Default_Material_In, class UMaterialInstanceDynamic** Dynamic_Material_Instance, int* Array_Index_Out, class UMaterialInstanceDynamic** Default_Material_Out)
{
	static auto fn = UObject::FindObject<UFunction>("Function PC_OakClothActor.PC_OakClothActor_C.Set Per Element Layer 4 Base Material Parameters");

	APC_OakClothActor_C_Set_Per_Element_Layer_4_Base_Material_Parameters_Params params;
...
void APC_OakClothActor_C::Set_Per_Element_Layer_3_Base_Material_Parameters(class UMaterialInstanceDynamic* Material_Instance_Dynamic, int Array_Index, class UMaterialInstanceDynamic* Default_Material_In, class UMaterialInstanceDynamic** Dynamic_Material_Instance, int* Array_Index_Out, class UMaterialInstanceDynamic** Default_Material_Out)
{
	static auto fn = UObject::FindObject<UFunction>("Function PC_OakClothActor.PC_OakClothActor_C.Set Per Element Layer 3 Base Material Parameters");

	APC_OakClothActor_C_Set_Per_Element_Layer_3_Base_Material_Parameters_Params params;
	params.Material_Instance_Dynamic = Material_Instance_Dynamic;
	params.Array_Index = Array_Index;
	params.Default_Material_In = Default_Material_In;
...
void APC_OakClothActor_C::Set_Per_Element_Layer_2_Base_Material_Parameters(class UMaterialInstanceDynamic* Material_Instance_Dynamic, int Array_Index, class UMaterialInstanceDynamic* Default_Material_In, class UMaterialInstanceDynamic** Dynamic_Material_Instance, int* Array_Index_Out, class UMaterialInstanceDynamic** Default_Material_Out)
{
	static auto fn = UObject::FindObject<UFunction>("Function PC_OakClothActor.PC_OakClothActor_C.Set Per Element Layer 2 Base Material Parameters");

	APC_OakClothActor_C_Set_Per_Element_Layer_2_Base_Material_Parameters_Params params;
	params.Material_Instance_Dynamic = Material_Instance_Dynamic;
	params.Array_Index = Array_Index;
	params.Default_Material_In = Default_Material_In;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PC_OakClothActor.PC_OakClothActor_C.Set Randomized Colorization");
...
void APC_OakClothActor_C::Set_Per_Element_Base_Material_Parameters(class UMaterialInstanceDynamic* Material_Instance_Dynamic, int Array_Index, class UMaterialInstanceDynamic** Dynamic_Material_Instance, int* Material_ID_Out, class UMaterialInstanceDynamic** Default_Material_Out)
{
	static auto fn = UObject::FindObject<UFunction>("Function PC_OakClothActor.PC_OakClothActor_C.Set Per Element Base Material Parameters");
...
// class UMeshComponent*          Mesh_Component                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
...
void APC_OakClothActor_C::Create_Dynamic_Material_Instance(class UMaterialInterface* Material_Instance_Interface, int Element_Index, class UMeshComponent* Mesh_Component, class UMaterialInstanceDynamic** Material_Instance_Dynamic, int* Material_ID)
{
	static auto fn = UObject::FindObject<UFunction>("Function PC_OakClothActor.PC_OakClothActor_C.Create Dynamic Material Instance");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PC_OakClothActor.PC_OakClothActor_C.Set Level ColorScheme");
...
// Parameters:
// class UMeshComponent*          Target_Component               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void APC_OakClothActor_C::Per_Instance_Master_Material_Parameters(class UMeshComponent* Target_Component)
{
	static auto fn = UObject::FindObject<UFunction>("Function PC_OakClothActor.PC_OakClothActor_C.Per Instance Master Material Parameters");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PC_OakClothActor.PC_OakClothActor_C.UserConstructionScript");
