...
#include "BL3_BPAnim_EFabricator_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_EFabricator.BPAnim_EFabricator_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_EFabricator(int EntryPoint);
};
