...
#include "BL3_BPAnim_IronBearSkillScreen_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_IronBearSkillScreen.BPAnim_IronBearSkillScreen_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_IronBearSkillScreen(int EntryPoint);
};
