...
#include "BL3_BPAnim_PS_Jakobs_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PS_Jakobs.BPAnim_PS_Jakobs_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_PS_Jakobs(int EntryPoint);
};
