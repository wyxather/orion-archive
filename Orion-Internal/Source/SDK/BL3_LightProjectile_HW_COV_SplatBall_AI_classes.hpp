...
#include "BL3_LightProjectile_HW_COV_SplatBall_AI_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_HW_COV_SplatBall_AI.LightProjectile_HW_COV_SplatBall_AI_C");
		return ptr;
	}
