...
#include "RFTA_Mod_HuntersMark_Action_parameters.hpp"
...
void UMod_HuntersMark_Action_C::FilterIncomingDamage(struct FDamageInfo* DamageInfo, struct FDamageInfo* DamageInfoOut, bool* ShouldApplyDamage)
{
