...
#include "BL3_Proj_MAL_SG_DeathGrip_Singularity_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_MAL_SG_DeathGrip_Singularity.Proj_MAL_SG_DeathGrip_Singularity_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Proj_MAL_SG_DeathGrip_Singularity(int EntryPoint);
};
