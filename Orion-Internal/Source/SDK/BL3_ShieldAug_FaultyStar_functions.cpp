...
#include "BL3_ShieldAug_FaultyStar_parameters.hpp"
...
void UShieldAug_FaultyStar_C::K2_NativeDelayCallback(class AShield** Shield, struct FName* DelayName, struct FAugmentData* StackData)
{
	static auto fn = UObject::FindObject<UFunction>("Function ShieldAug_FaultyStar.ShieldAug_FaultyStar_C.K2_NativeDelayCallback");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ShieldAug_FaultyStar.ShieldAug_FaultyStar_C.K2_OnDamageTaken");
