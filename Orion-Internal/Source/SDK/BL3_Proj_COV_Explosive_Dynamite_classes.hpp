...
#include "BL3_Proj_COV_Explosive_Dynamite_structs.hpp"
...
// BlueprintGeneratedClass Proj_COV_Explosive_Dynamite.Proj_COV_Explosive_Dynamite_C
// 0x0041 (0x0721 - 0x06E0)
class AProj_COV_Explosive_Dynamite_C : public AOakAIBalancedProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_COV_Explosive_Dynamite.Proj_COV_Explosive_Dynamite_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Proj_COV_Explosive_Dynamite(int EntryPoint);
};
