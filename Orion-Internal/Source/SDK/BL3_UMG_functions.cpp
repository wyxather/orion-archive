...
#include "BL3_UMG_parameters.hpp"
...
// Function UMG.ComboBoxString.SetSelectedOptionByIndex
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int                            Index                          (Parm, ZeroConstructor, IsPlainOldData)

void UComboBoxString::SetSelectedOptionByIndex(int Index)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.ComboBoxString.SetSelectedOptionByIndex");

	UComboBoxString_SetSelectedOptionByIndex_Params params;
	params.Index = Index;
...
// Function UMG.ComboBoxString.GetSelectedOptionIndex
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int UComboBoxString::GetSelectedOptionIndex()
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.ComboBoxString.GetSelectedOptionIndex");

	UComboBoxString_GetSelectedOptionIndex_Params params;
...
// Function UMG.RichTextBlock.SetColorAndOpacity
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FSlateColor             InColorAndOpacity              (Parm)

void URichTextBlock::SetColorAndOpacity(const struct FSlateColor& InColorAndOpacity)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.RichTextBlock.SetColorAndOpacity");

	URichTextBlock_SetColorAndOpacity_Params params;
	params.InColorAndOpacity = InColorAndOpacity;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.ScrollBox.GetPhysicalScrollOffset");
