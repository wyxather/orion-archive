...
#include "BL3_Passive_OperativeDLC_13_structs.hpp"
...
public:
	...
	class UClass*                                      DmgType;                                                  // 0x0208(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Passive_OperativeDLC_13.Passive_OperativeDLC_12_C");
		return ptr;
	}
	...
	void OnActivated();
	void ExecuteUbergraph_Passive_OperativeDLC_13(int EntryPoint);
};
