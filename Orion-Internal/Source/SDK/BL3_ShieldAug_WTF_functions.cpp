...
#include "BL3_ShieldAug_WTF_parameters.hpp"
...
void UShieldAug_WTF_C::K2_TriggerEffect(class AShield** Shield, struct FGameResourcePoolReference* ResourcePool, struct FAugmentData* StackData)
{
	static auto fn = UObject::FindObject<UFunction>("Function ShieldAug_WTF.ShieldAug_WTF_C.K2_TriggerEffect");

	UShieldAug_WTF_C_K2_TriggerEffect_Params params;
...
void UShieldAug_WTF_C::K2_UntriggerEffect(class AShield** Shield, struct FGameResourcePoolReference* ResourcePool, struct FAugmentData* StackData)
{
	static auto fn = UObject::FindObject<UFunction>("Function ShieldAug_WTF.ShieldAug_WTF_C.K2_UntriggerEffect");

	UShieldAug_WTF_C_K2_UntriggerEffect_Params params;
	params.Shield = Shield;
	params.ResourcePool = ResourcePool;
