...
#include "BL3_Ability_Artifact_PhoenixTears_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_Artifact_PhoenixTears.Ability_Artifact_PhoenixTears_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Ability_Artifact_PhoenixTears(int EntryPoint);
};
