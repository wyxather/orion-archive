...
#include "BL3_BP_GM_Payload_Slider_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_Slider.BP_GM_Payload_Slider_C.K2_GrenadeInitialized");
...
void UBP_GM_Payload_Slider_C::K2_GrenadeDamageDealt(class AGrenade** Grenade, class AGrenadeMod** GrenadeMod, class AOakCharacter** Character, struct FDamageDataEventDetails* DamageEvent, struct FPayloadInstanceData* InstanceData)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_Slider.BP_GM_Payload_Slider_C.K2_GrenadeDamageDealt");
