...
#include "BL3_BPAnim_HW_VLA_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_HW_VLA.BPAnim_HW_VLA_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_HW_VLA(int EntryPoint);
};
