...
#include "BL3_Challenge_Sabotage_MoxxiGunReward_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Challenge_Sabotage_MoxxiGunReward.Challenge_Sabotage_MoxxiGunReward_C.CompletedChallenge");
...
void UChallenge_Sabotage_MoxxiGunReward_C::ExecuteUbergraph_Challenge_Sabotage_MoxxiGunReward(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function Challenge_Sabotage_MoxxiGunReward.Challenge_Sabotage_MoxxiGunReward_C.ExecuteUbergraph_Challenge_Sabotage_MoxxiGunReward");
