...
#include "BL3_AIModule_parameters.hpp"
...
// Function AIModule.BlackboardComponent.HasValue
// (Final, Native, Public, HasOutParms, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct FName                   KeyName                        (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool UBlackboardComponent::HasValue(const struct FName& KeyName)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIModule.BlackboardComponent.HasValue");

	UBlackboardComponent_HasValue_Params params;
	params.KeyName = KeyName;
...
// Function AIModule.BlackboardComponent.AddRuntimeKey
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FName                   KeyName                        (Parm, ZeroConstructor, IsPlainOldData)
// class UBlackboardKeyType*      KeyType                        (Parm, ZeroConstructor, IsPlainOldData)
// unsigned char                  ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

unsigned char UBlackboardComponent::AddRuntimeKey(const struct FName& KeyName, class UBlackboardKeyType* KeyType)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIModule.BlackboardComponent.AddRuntimeKey");

	UBlackboardComponent_AddRuntimeKey_Params params;
	params.KeyName = KeyName;
