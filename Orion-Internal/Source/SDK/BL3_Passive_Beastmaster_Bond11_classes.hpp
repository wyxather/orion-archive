...
#include "BL3_Passive_Beastmaster_Bond11_structs.hpp"
...
public:
	...
	float                                              ClampedDamage;                                            // 0x0200(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              BossMaxHealthClamp;                                       // 0x0204(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              EnemyMaxHealthClamp;                                      // 0x0208(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Passive_Beastmaster_Bond11.Passive_Beastmaster_Bond11_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Passive_Beastmaster_Bond11(int EntryPoint);
};
