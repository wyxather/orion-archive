...
#include "BL3_Proj_AIMeleeWeapon_structs.hpp"
...
// BlueprintGeneratedClass Proj_AIMeleeWeapon.Proj_AIMeleeWeapon_C
// 0x0038 (0x0718 - 0x06E0)
class AProj_AIMeleeWeapon_C : public AOakAIBalancedProjectile
{
public:
	...
	class UStaticMeshComponent*                        MeleeMesh;                                                // 0x06F8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	EOakElementalType                                  ElementalType;                                            // 0x0710(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_AIMeleeWeapon.Proj_AIMeleeWeapon_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Proj_AIMeleeWeapon(int EntryPoint);
};
