...
#include "BL3_ApexDestruction_parameters.hpp"
...
// Function ApexDestruction.DestructibleComponent.SetDestructiblePoseComponent
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class USkinnedMeshComponent*   NewDestructiblePoseComponent   (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void UDestructibleComponent::SetDestructiblePoseComponent(class USkinnedMeshComponent* NewDestructiblePoseComponent)
{
	static auto fn = UObject::FindObject<UFunction>("Function ApexDestruction.DestructibleComponent.SetDestructiblePoseComponent");

	UDestructibleComponent_SetDestructiblePoseComponent_Params params;
	params.NewDestructiblePoseComponent = NewDestructiblePoseComponent;
