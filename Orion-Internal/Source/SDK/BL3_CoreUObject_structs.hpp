...
struct FVector
{
	...
	[[nodiscard]] auto toAngle() const noexcept -> FRotator;
};
...
struct FVector2D
{
	...
	constexpr FVector2D(float x = 0.f, float y = 0.f) noexcept : X{ x }, Y{ y } {}

	[[nodiscard]] friend constexpr auto operator-(const FVector2D& a, const FVector2D& b) noexcept -> FVector2D
	{
	...
	[[nodiscard]] friend constexpr auto operator*(const FVector2D& vec, float f) noexcept -> FVector2D
	{
...
struct FRotator
{
	...
	[[nodiscard]] constexpr auto fromAngle() const noexcept -> FVector
	{
		return {
...
struct FLinearColor
{
	...
	constexpr FLinearColor(float r = 0.f, float g = 0.f, float b = 0.f, float a = 0.f) noexcept : R{ r }, G{ g }, B{ b }, A{ a } {}
};
