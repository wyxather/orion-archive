...
#include "BL3_HitReactionLayer_ForceFlinchOrLaunch_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_ForceFlinchOrLaunch_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_ForceFlinchOrLaunch.HitReactionLayer_ForceFlinchOrLaunch_C.EvaluateTag");

	UHitReactionLayer_ForceFlinchOrLaunch_C_EvaluateTag_Params params;
