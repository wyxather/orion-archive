...
#include "BL3_Ability_All_unhealthyraddamage_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_All_unhealthyraddamage.Ability_All_UnhealthyRadDamage_C");
		return ptr;
	}
	...
	void OnActivated();
	void OnDeactivated();
	void ExecuteUbergraph_Ability_All_UnhealthyRadDamage(int EntryPoint);
};
