...
#include "BL3_StandIn_Beastmaster_Spiderant_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass StandIn_Beastmaster_Spiderant.StandIn_Beastmaster_Spiderant_C");
		return ptr;
	}
