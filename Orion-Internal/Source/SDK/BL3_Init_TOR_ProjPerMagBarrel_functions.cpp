...
#include "BL3_Init_TOR_ProjPerMagBarrel_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Init_TOR_ProjPerMagBarrel.Init_TOR_ProjPerMagBarrel_C.CalculateAttributeInitialValue");
