...
#include "BL3_Condition_IsWeaponHeld_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Condition_IsWeaponHeld.Condition_IsWeaponHeld_C.EvaluateCondition");
