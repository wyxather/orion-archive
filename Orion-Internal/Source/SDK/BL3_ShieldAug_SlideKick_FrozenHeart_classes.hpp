...
#include "BL3_ShieldAug_SlideKick_FrozenHeart_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ShieldAug_SlideKick_FrozenHeart.ShieldAug_SlideKick_FrozenHeart_C");
		return ptr;
	}
