...
#include "BL3_LightProjectile_JAK_BirdofPrey_Child_parameters.hpp"
...
void ULightProjectile_JAK_BirdofPrey_Child_C::OnRicochet(class ULightProjectile** Projectile, struct FHitResult* Hit, struct FVector* ImpactVelocity)
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_JAK_BirdofPrey_Child.LightProjectile_JAK_BirdofPrey_Child_C.OnRicochet");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_JAK_BirdofPrey_Child.LightProjectile_JAK_BirdofPrey_Child_C.HomeIn");
