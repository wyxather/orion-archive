...
#include "BL3_DroneProj_MessyBreakup_structs.hpp"
...
public:
	...
	class UWwiseAudioComponent*                        WWisAudio;                                                // 0x0748(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DroneProj_MessyBreakup.DroneProj_MessyBreakup_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_DroneProj_MessyBreakup(int EntryPoint);
};
