...
#include "BL3_BPAnim_SM_Dahl_structs.hpp"
...
public:
	...
	class UAnimSequence*                               ScopeIdleAnim;                                            // 0x0FA8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAddScopeIdleAnim;                                        // 0x0FB0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SM_Dahl.BPAnim_SM_Dahl_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SM_Dahl(int EntryPoint);
};
