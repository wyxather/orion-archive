...
#include "BL3_BP_GM_Payload_RedQueen_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_RedQueen.BP_GM_Payload_RedQueen_C.K2_GrenadeLastBounce");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_RedQueen.BP_GM_Payload_RedQueen_C.K2_GrenadeExplode");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_RedQueen.BP_GM_Payload_RedQueen_C.K2_GrenadeInitialized");
...
void UBP_GM_Payload_RedQueen_C::K2_UpdateChildGeneration(struct FGrenadeChildGenerationData* InGenerationData, struct FGrenadeChildGenerationData* GenerationData)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_RedQueen.BP_GM_Payload_RedQueen_C.K2_UpdateChildGeneration");
...
void UBP_GM_Payload_RedQueen_C::K2_NativeDelayCallback(class AGrenade** Grenade, class AGrenadeMod** GrenadeMod, struct FName* DelayName, struct FPayloadInstanceData* InstanceData)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_RedQueen.BP_GM_Payload_RedQueen_C.K2_NativeDelayCallback");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_RedQueen.BP_GM_Payload_RedQueen_C.K2_GrenadeBeginPlay");
