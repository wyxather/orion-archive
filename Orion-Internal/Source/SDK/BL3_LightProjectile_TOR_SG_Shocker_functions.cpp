...
#include "BL3_LightProjectile_TOR_SG_Shocker_parameters.hpp"
...
void ULightProjectile_TOR_SG_Shocker_C::OnRicochet(class ULightProjectile** Projectile, struct FHitResult* Hit, struct FVector* ImpactVelocity)
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_TOR_SG_Shocker.LightProjectile_TOR_SG_Shocker_C.OnRicochet");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_TOR_SG_Shocker.LightProjectile_TOR_SG_Shocker_C.OnLifetimeExpired");
