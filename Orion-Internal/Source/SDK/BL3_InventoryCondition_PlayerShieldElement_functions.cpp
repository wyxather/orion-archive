...
#include "BL3_InventoryCondition_PlayerShieldElement_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function InventoryCondition_PlayerShieldElement.InventoryCondition_PlayerShieldElement_C.EvaluateCondition");
