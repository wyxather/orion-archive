...
#include "BL3_Proj_Siren_DLCSkill_WalkingPotato_Attack_6_structs.hpp"
...
public:
	...
	class AActor*                                      NewTarget;                                                // 0x09D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_Siren_DLCSkill_WalkingPotato_Attack_6.Proj_Siren_DLCSkill_WalkingPotato_Attack_5_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Proj_Siren_DLCSkill_WalkingPotato_Attack_6(int EntryPoint);
};
