...
#include "BL3_BPCont_TedioreTurret_structs.hpp"
...
public:
	...
	float                                              TargetDistanceMax;                                        // 0x0790(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BPCont_TedioreTurret.BPCont_TedioreTurret_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPCont_TedioreTurret(int EntryPoint);
};
