...
#include "BL3_HitReactionLayer_HitByVehicle_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_HitByVehicle.HitReactionLayer_HitByVehicle_C.EvaluateTag");
