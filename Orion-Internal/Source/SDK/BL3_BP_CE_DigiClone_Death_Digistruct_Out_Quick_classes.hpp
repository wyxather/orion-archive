...
#include "BL3_BP_CE_DigiClone_Death_Digistruct_Out_Quick_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_CE_DigiClone_Death_Digistruct_Out_Quick.BP_CE_DigiClone_Death_Digistruct_Out_Quick_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_CE_DigiClone_Death_Digistruct_Out_Quick(int EntryPoint);
};
