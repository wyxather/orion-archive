...
#include "BL3_Resolver_Artifact_Stats_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Resolver_Artifact_Stats.Resolver_Artifact_Stats_C.GetValueForAttribute");
