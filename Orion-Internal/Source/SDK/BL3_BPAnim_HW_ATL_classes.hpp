...
#include "BL3_BPAnim_HW_ATL_structs.hpp"
...
public:
	...
	struct FTransform                                  tShoulder_Socket;                                         // 0x0EE0(0x0030) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	float                                              ShoulderIK_Weight;                                        // 0x0F10(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bPrimaryUseMode;                                          // 0x0F14(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_HW_ATL.BPAnim_HW_ATL_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_HW_ATL(int EntryPoint);
};
