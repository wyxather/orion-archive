...
#include "BL3_HitReactionLayer_VarkidDeathInPod_parameters.hpp"
...
// Function HitReactionLayer_VarkidDeathInPod.HitReactionLayer_VarkidDeathInPod_C.EvaluateTag
...
class UHitReactionTag* UHitReactionLayer_VarkidDeathInPod_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_VarkidDeathInPod.HitReactionLayer_VarkidDeathInPod_C.EvaluateTag");

	UHitReactionLayer_VarkidDeathInPod_C_EvaluateTag_Params params;
