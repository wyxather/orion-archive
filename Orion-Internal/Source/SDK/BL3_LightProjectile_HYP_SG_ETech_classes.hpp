...
#include "BL3_LightProjectile_HYP_SG_ETech_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_HYP_SG_ETech.LightProjectile_HYP_SG_ETech_C");
		return ptr;
	}
