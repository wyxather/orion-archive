...
#include "BL3_PassiveSkill_Operative_BorrowedTime_classes.hpp"
...
struct UPassiveSkill_Operative_BorrowedTime_C_OnActivated_Params
{
};

// Function PassiveSkill_Operative_BorrowedTime.PassiveSkill_Operative_BorrowedTime_C.OOO_OnActionSkillActivated
struct UPassiveSkill_Operative_BorrowedTime_C_OOO_OnActionSkillActivated_Params
{
...
struct UPassiveSkill_Operative_BorrowedTime_C_OOO_OnActionSkillCoolingDown_Params
{
	class UOakActionAbility*                           ActionAbility;                                            // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UPassiveSkill_Operative_BorrowedTime_C_ExecuteUbergraph_PassiveSkill_Operative_BorrowedTime_Params
{
