...
#include "BL3_BPAnim_SG_Hyperion_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x1078(0x0008) MISSED OFFSET
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SG_Hyperion.BPAnim_SG_Hyperion_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SG_Hyperion(int EntryPoint);
};
