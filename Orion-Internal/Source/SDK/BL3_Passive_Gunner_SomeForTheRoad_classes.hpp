...
#include "BL3_Passive_Gunner_SomeForTheRoad_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Passive_Gunner_SomeForTheRoad.Passive_Gunner_SomeForTheRoad_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Passive_Gunner_SomeForTheRoad(int EntryPoint);
};
