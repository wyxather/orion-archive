...
#include "BL3_BPAnim_AR_TOR_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_AR_TOR.BPAnim_AR_TOR_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_AR_TOR(int EntryPoint);
};
