...
#include "BL3_Proj_HOTSpring_structs.hpp"
...
public:
	...
	class UParticleSystemComponent*                    PS_HealAura;                                              // 0x07A0(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_HOTSpring.Proj_HOTSpring_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Proj_HOTSpring(int EntryPoint);
};
