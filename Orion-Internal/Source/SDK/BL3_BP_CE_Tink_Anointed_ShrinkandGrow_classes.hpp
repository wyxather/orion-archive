...
#include "BL3_BP_CE_Tink_Anointed_ShrinkandGrow_structs.hpp"
...
// BlueprintGeneratedClass BP_CE_Tink_Anointed_ShrinkandGrow.BP_CE_Tink_Anointed_ShrinkandGrow_C
// 0x0018 (0x0160 - 0x0148)
class UBP_CE_Tink_Anointed_ShrinkandGrow_C : public UOakAction_CoordinatedEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_CE_Tink_Anointed_ShrinkandGrow.BP_CE_Tink_Anointed_ShrinkandGrow_C");
		return ptr;
	}


	void OnBegin(class AActor** Actor);
	void ExecuteUbergraph_BP_CE_Tink_Anointed_ShrinkandGrow(int EntryPoint);
};
