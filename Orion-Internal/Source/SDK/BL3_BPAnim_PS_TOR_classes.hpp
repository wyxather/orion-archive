...
#include "BL3_BPAnim_PS_TOR_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PS_TOR.BPAnim_PS_TOR_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_PS_TOR(int EntryPoint);
};
