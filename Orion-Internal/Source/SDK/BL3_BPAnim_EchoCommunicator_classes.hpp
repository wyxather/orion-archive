...
#include "BL3_BPAnim_EchoCommunicator_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_EchoCommunicator.BPAnim_EchoCommunicator_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_EchoCommunicator(int EntryPoint);
};
