...
#include "RFTA_Action_InvulnerableToMonsters_parameters.hpp"
...
void UAction_InvulnerableToMonsters_C::FilterIncomingDamage(struct FDamageInfo* DamageInfo, struct FDamageInfo* DamageInfoOut, bool* ShouldApplyDamage)
{
