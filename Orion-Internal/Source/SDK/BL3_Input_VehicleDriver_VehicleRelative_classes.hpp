...
#include "BL3_Input_VehicleDriver_VehicleRelative_structs.hpp"
...
// BlueprintGeneratedClass Input_VehicleDriver_VehicleRelative.Input_VehicleDriver_VehicleRelative_C
// 0x0778 (0x0B30 - 0x03B8)
class UInput_VehicleDriver_VehicleRelative_C : public UOakVehicleInputComponent
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Input_VehicleDriver_VehicleRelative.Input_VehicleDriver_VehicleRelative_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Input_VehicleDriver_VehicleRelative(int EntryPoint);
};
