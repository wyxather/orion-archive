...
#include "BL3_AITree_PetSkag_Evo1_Horned_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AIActionBlueprintGeneratedClass AITree_PetSkag_Evo1_Horned.AITree_PetSkag_Evo1_Horned_C");
		return ptr;
	}


	void ExecuteUbergraph_AITree_PetSkag_Evo1_Horned(int EntryPoint);
};
