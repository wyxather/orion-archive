...
#include "BL3_ADirection_Spiderant_Flinch_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ADirection_Spiderant_Flinch.ADirection_Spiderant_Flinch_C");
		return ptr;
	}


	void OnBegin(class AActor** Actor);
	void ExecuteUbergraph_ADirection_Spiderant_Flinch(int EntryPoint);
};
