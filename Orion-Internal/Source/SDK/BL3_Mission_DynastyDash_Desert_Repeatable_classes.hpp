...
#include "BL3_Mission_DynastyDash_Desert_Repeatable_structs.hpp"
...
public:
	...
	bool                                               FastAchieved;                                             // 0x0524(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               MediumAchieved;                                           // 0x0525(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               SlowAchieved;                                             // 0x0526(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Mission_DynastyDash_Desert_Repeatable.Mission_DynastyDash_Desert_Repeatable_C");
		return ptr;
	}
	...
	void MissionKickoff();
	void ExecuteUbergraph_Mission_DynastyDash_Desert_Repeatable(int EntryPoint);
};
