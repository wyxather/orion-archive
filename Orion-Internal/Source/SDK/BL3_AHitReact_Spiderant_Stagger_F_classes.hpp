...
#include "BL3_AHitReact_Spiderant_Stagger_F_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AHitReact_Spiderant_Stagger_F.AHitReact_Spiderant_Stagger_F_C");
		return ptr;
	}
