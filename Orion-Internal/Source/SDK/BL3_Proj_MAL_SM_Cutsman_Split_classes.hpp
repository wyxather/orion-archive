...
#include "BL3_Proj_MAL_SM_Cutsman_Split_structs.hpp"
...
// BlueprintGeneratedClass Proj_MAL_SM_Cutsman_Split.Proj_MAL_SM_Cutsman_Split_C
// 0x002F (0x07B9 - 0x078A)
class AProj_MAL_SM_Cutsman_Split_C : public AProj_Weapon_BaseProjectile_C
{
public:
	...
	class AProj_MAL_SM_Cutsman_Split_C*                LinkedProjectile;                                         // 0x07B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	bool                                               bHasImpacted;                                             // 0x07B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_MAL_SM_Cutsman_Split.Proj_MAL_SM_Cutsman_Split_C");
		return ptr;
	}
	...
	void OnExplode();
	void ExecuteUbergraph_Proj_MAL_SM_Cutsman_Split(int EntryPoint);
};
