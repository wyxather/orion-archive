...
#include "BL3_LightProjectile_Drone_CalledShot_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_Drone_CalledShot.LightProjectile_Drone_CalledShot_C");
		return ptr;
	}
