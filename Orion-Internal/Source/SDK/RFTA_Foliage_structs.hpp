...
{
	unsigned char                                      UseMask : 1;                                              // 0x0000(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      InvertMask : 1;                                           // 0x0008(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
