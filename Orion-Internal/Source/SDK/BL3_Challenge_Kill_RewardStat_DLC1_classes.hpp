...
#include "BL3_Challenge_Kill_RewardStat_DLC1_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_Kill_RewardStat_DLC1.Challenge_Kill_RewardStat_DLC1_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Challenge_Kill_RewardStat_DLC1(int EntryPoint);
};
