...
#include "BL3_BP_CE_Anointed_TeleportUnCloak_structs.hpp"
...
// BlueprintGeneratedClass BP_CE_Anointed_TeleportUnCloak.BP_CE_Anointed_TeleportUnCloak_C
// 0x0018 (0x0160 - 0x0148)
class UBP_CE_Anointed_TeleportUnCloak_C : public UOakAction_CoordinatedEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_CE_Anointed_TeleportUnCloak.BP_CE_Anointed_TeleportUnCloak_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_CE_Anointed_TeleportUnCloak(int EntryPoint);
};
