...
#include "BL3_HitReactionLayer_Spiderant_CarpaceHitDowngrade_parameters.hpp"
...
// Function HitReactionLayer_Spiderant_CarpaceHitDowngrade.HitReactionLayer_Spiderant_CarpaceHitDowngrade_C.EvaluateTag
...
class UHitReactionTag* UHitReactionLayer_Spiderant_CarpaceHitDowngrade_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_Spiderant_CarpaceHitDowngrade.HitReactionLayer_Spiderant_CarpaceHitDowngrade_C.EvaluateTag");

	UHitReactionLayer_Spiderant_CarpaceHitDowngrade_C_EvaluateTag_Params params;
