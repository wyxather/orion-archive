...
#include "BL3_BPAnim_PlayerCharacter_Legs_structs.hpp"
...
public:
	...
	struct FName                                       Leg_AO;                                                   // 0x2568(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PlayerCharacter_Legs.BPAnim_PlayerCharacter_Legs_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_PlayerCharacter_Legs(int EntryPoint);
};
