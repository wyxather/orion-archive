...
#include "BL3_LightProjectile_TOR_SG_Balrog_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_TOR_SG_Balrog.LightProjectile_TOR_SG_Balrog_C");
		return ptr;
	}
