...
#include "BL3_BP_ShieldBoosterPickup_Clover_Luck_structs.hpp"
...
public:
	...
	class UStatusEffectData*                           StatusEffect;                                             // 0x0500(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              Duration;                                                 // 0x0508(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ShieldBoosterPickup_Clover_Luck.BP_ShieldBoosterPickup_Clover_Luck_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ShieldBoosterPickup_Clover_Luck(int EntryPoint);
};
