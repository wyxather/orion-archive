...
#include "BL3_LightProjectile_HW_COV_SawBlade_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_HW_COV_SawBlade.LightProjectile_HW_COV_SawBlade_C");
		return ptr;
	}
