...
#include "RFTA_BP_Cinematic_Actor_PlayerMale_structs.hpp"
...
class ABP_Cinematic_Actor_PlayerMale_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Cinematic_Actor_PlayerMale.BP_Cinematic_Actor_PlayerMale_C");
		return ptr;
	}
