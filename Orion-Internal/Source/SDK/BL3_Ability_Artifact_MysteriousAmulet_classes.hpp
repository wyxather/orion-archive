...
#include "BL3_Ability_Artifact_MysteriousAmulet_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_Artifact_MysteriousAmulet.Ability_Artifact_MysteriousAmulet_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Ability_Artifact_MysteriousAmulet(int EntryPoint);
};
