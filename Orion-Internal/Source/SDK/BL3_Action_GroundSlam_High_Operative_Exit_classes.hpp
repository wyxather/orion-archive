...
#include "BL3_Action_GroundSlam_High_Operative_Exit_structs.hpp"
...
// BlueprintGeneratedClass Action_GroundSlam_High_Operative_Exit.Action_GroundSlam_High_Operative_Exit_C
// 0x00B8 (0x02D8 - 0x0220)
class UAction_GroundSlam_High_Operative_Exit_C : public UAction_GroundSlam_High_Exit_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Action_GroundSlam_High_Operative_Exit.Action_GroundSlam_High_Operative_Exit_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Action_GroundSlam_High_Operative_Exit(int EntryPoint);
};
