...
#include "BL3_Ability_Fork_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_Fork.Ability_Fork_C");
		return ptr;
	}
	...
	void OnActivated();
	void OnDeactivated();
	void ExecuteUbergraph_Ability_Fork(int EntryPoint);
};
