...
#include "BL3_Challenge_Shield_RoidKills_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_Shield_RoidKills.Challenge_Shield_RoidKills_C");
		return ptr;
	}
