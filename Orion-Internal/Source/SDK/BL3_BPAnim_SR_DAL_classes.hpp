...
#include "BL3_BPAnim_SR_DAL_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SR_DAL.BPAnim_SR_DAL_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SR_DAL(int EntryPoint);
};
