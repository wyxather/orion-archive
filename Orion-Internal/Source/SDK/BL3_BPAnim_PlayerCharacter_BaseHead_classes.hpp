...
#include "BL3_BPAnim_PlayerCharacter_BaseHead_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PlayerCharacter_BaseHead.BPAnim_PlayerCharacter_BaseHead_C");
		return ptr;
	}


	void ExecuteUbergraph_BPAnim_PlayerCharacter_BaseHead(int EntryPoint);
};
