...
#include "BL3_APhys_Enemy_RagdollLaunch_classes.hpp"
...
struct UAPhys_Enemy_RagdollLaunch_C_OnBegin_Params
{
	class AActor**                                     Actor;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function APhys_Enemy_RagdollLaunch.APhys_Enemy_RagdollLaunch_C.OnEnd
struct UAPhys_Enemy_RagdollLaunch_C_OnEnd_Params
{
...
struct UAPhys_Enemy_RagdollLaunch_C_ExecuteUbergraph_APhys_Enemy_RagdollLaunch_Params
{
