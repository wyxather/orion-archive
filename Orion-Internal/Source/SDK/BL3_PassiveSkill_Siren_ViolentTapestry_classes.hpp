...
#include "BL3_PassiveSkill_Siren_ViolentTapestry_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PassiveSkill_Siren_ViolentTapestry.PassiveSkill_Siren_ViolentTapestry_C");
		return ptr;
	}
	...
	void ViolentTapestryTriggerRushStacks(int RushStacks);
	void ExecuteUbergraph_PassiveSkill_Siren_ViolentTapestry(int EntryPoint);
};
