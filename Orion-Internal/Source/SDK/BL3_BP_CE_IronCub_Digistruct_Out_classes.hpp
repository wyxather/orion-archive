...
#include "BL3_BP_CE_IronCub_Digistruct_Out_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_CE_IronCub_Digistruct_Out.BP_CE_IronCub_Digistruct_Out_C");
		return ptr;
	}


	void OnEnd(EGbxActionEndState* ActionEndState, class AActor** Actor);
	void ExecuteUbergraph_BP_CE_IronCub_Digistruct_Out(int EntryPoint);
};
