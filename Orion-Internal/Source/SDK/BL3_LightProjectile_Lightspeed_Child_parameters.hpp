...
#include "BL3_LightProjectile_Lightspeed_Child_classes.hpp"
...
struct ULightProjectile_Lightspeed_Child_C_OnLifetimeExpired_Params
{
	class ULightProjectile**                           Projectile;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function LightProjectile_Lightspeed_Child.LightProjectile_Lightspeed_Child_C.HomeIn
struct ULightProjectile_Lightspeed_Child_C_HomeIn_Params
{
