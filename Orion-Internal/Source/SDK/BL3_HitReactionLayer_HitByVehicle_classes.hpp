...
#include "BL3_HitReactionLayer_HitByVehicle_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass HitReactionLayer_HitByVehicle.HitReactionLayer_HitByVehicle_C");
		return ptr;
	}
