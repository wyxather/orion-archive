...
#include "BL3_Init_Global_SlideSpeed_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Init_Global_SlideSpeed.Init_Global_SlideSpeed_C.CalculateAttributeInitialValue");
