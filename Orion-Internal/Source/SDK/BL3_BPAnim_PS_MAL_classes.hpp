...
#include "BL3_BPAnim_PS_MAL_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PS_MAL.BPAnim_PS_MAL_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_PS_MAL(int EntryPoint);
};
