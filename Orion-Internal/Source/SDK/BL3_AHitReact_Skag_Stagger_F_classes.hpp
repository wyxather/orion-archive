...
#include "BL3_AHitReact_Skag_Stagger_F_structs.hpp"
...
class UAHitReact_Skag_Stagger_F_C : public UOakAction_Anim
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AHitReact_Skag_Stagger_F.AHitReact_Skag_Stagger_F_C");
		return ptr;
	}
