...
#include "BL3_Challenge_VaultReward_ArtifactSlot_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Challenge_VaultReward_ArtifactSlot.Challenge_VaultReward_ArtifactSlot_C.CompletedChallenge");
...
void UChallenge_VaultReward_ArtifactSlot_C::ExecuteUbergraph_Challenge_VaultReward_ArtifactSlot(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function Challenge_VaultReward_ArtifactSlot.Challenge_VaultReward_ArtifactSlot_C.ExecuteUbergraph_Challenge_VaultReward_ArtifactSlot");
