...
#include "BL3_TravelGraph_Cartels_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TravelGraph_Cartels.TravelGraph_Cartels_C");
		return ptr;
	}


	void ExecuteUbergraph_TravelGraph_Cartels(int EntryPoint);
};
