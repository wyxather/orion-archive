...
#include "BL3_Passive_Gunner_Deadlines_structs.hpp"
...
public:
	...
	float                                              CooldownPercentToReturn;                                  // 0x01E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              DiminishingReturns;                                       // 0x01E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Passive_Gunner_Deadlines.Passive_Gunner_Deadlines_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Passive_Gunner_Deadlines(int EntryPoint);
};
