...
#include "BL3_Init_Drone_MachineGunDamageCalc_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Init_Drone_MachineGunDamageCalc.Init_Drone_MachineGunDamageCalc_C");
		return ptr;
	}
