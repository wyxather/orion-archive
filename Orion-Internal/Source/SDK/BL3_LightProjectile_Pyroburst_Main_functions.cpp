...
#include "BL3_LightProjectile_Pyroburst_Main_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_Pyroburst_Main.LightProjectile_Pyroburst_Main_C.OnExplode");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_Pyroburst_Main.LightProjectile_Pyroburst_Main_C.OnBegin");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_Pyroburst_Main.LightProjectile_Pyroburst_Main_C.OnLifetimeExpired");
...
void ULightProjectile_Pyroburst_Main_C::OnImpact(class ULightProjectile** Projectile, struct FHitResult* Hit)
{
	static auto fn = UObject::FindObject<UFunction>("Function LightProjectile_Pyroburst_Main.LightProjectile_Pyroburst_Main_C.OnImpact");
