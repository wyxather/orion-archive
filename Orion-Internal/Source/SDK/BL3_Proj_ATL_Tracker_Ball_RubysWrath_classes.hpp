...
#include "BL3_Proj_ATL_Tracker_Ball_RubysWrath_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_ATL_Tracker_Ball_RubysWrath.Proj_ATL_Tracker_Ball_RubysWrath_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Proj_ATL_Tracker_Ball_RubysWrath(int EntryPoint);
};
