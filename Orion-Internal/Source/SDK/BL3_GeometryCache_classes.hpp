...
#include "BL3_GeometryCache_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData01[0x30];                                      // 0x0734(0x0030) MISSED OFFSET
	float                                              Duration;                                                 // 0x0764(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bManualTick;                                              // 0x0768(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
