...
#include "RFTA_OnlineSubsystemUtils_structs.hpp"
...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0720(0x0001) (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0720(0x0001) (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
