...
#include "BL3_Init_IronBear_LowHPDamage_WeapDmg_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Init_IronBear_LowHPDamage_WeapDmg.Init_IronBear_LowHPDamage_WeapDmg_C.CalculateAttributeInitialValue");
