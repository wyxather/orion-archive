...
#include "BL3_BP_CE_Tink_Anointed_GrowGigantic_structs.hpp"
...
// BlueprintGeneratedClass BP_CE_Tink_Anointed_GrowGigantic.BP_CE_Tink_Anointed_GrowGigantic_C
// 0x0018 (0x0160 - 0x0148)
class UBP_CE_Tink_Anointed_GrowGigantic_C : public UOakAction_CoordinatedEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_CE_Tink_Anointed_GrowGigantic.BP_CE_Tink_Anointed_GrowGigantic_C");
		return ptr;
	}


	void OnBegin(class AActor** Actor);
	void ExecuteUbergraph_BP_CE_Tink_Anointed_GrowGigantic(int EntryPoint);
};
