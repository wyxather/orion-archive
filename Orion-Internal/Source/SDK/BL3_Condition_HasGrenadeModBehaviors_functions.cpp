...
#include "BL3_Condition_HasGrenadeModBehaviors_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Condition_HasGrenadeModBehaviors.Condition_HasGrenadeModBehaviors_C.EvaluateCondition");
