...
#include "BL3_MeshDescription_classes.hpp"
...
struct FSubdividedQuadVertex
{
	...
	struct FColor                                      GbxVertexColor;                                           // 0x0018(0x0004) (BlueprintVisible, IsPlainOldData)
	struct FVector                                     VertexNormal;                                             // 0x001C(0x000C) (BlueprintVisible, IsPlainOldData)
	struct FVector                                     VertexTangent;                                            // 0x0028(0x000C) (BlueprintVisible, IsPlainOldData)
	float                                              VertexBinormalSign;                                       // 0x0034(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
{
	struct FSubdividedQuadVertex                       QuadVertex0;                                              // 0x0000(0x0038) (BlueprintVisible)
	struct FSubdividedQuadVertex                       QuadVertex1;                                              // 0x0038(0x0038) (BlueprintVisible)
	struct FSubdividedQuadVertex                       QuadVertex2;                                              // 0x0070(0x0038) (BlueprintVisible)
	struct FSubdividedQuadVertex                       QuadVertex3;                                              // 0x00A8(0x0038) (BlueprintVisible)
};
