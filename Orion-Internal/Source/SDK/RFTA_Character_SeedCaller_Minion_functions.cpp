...
#include "RFTA_Character_SeedCaller_Minion_parameters.hpp"
...
void ACharacter_SeedCaller_Minion_C::GetBrutalMarkDamageMod(struct FDamageInfo* InputPin, float* DamageMod)
{
...
void ACharacter_SeedCaller_Minion_C::GetArmorScalars(struct FDamageInfo* DamageInfo, float* MinionDamageScalar)
{
...
void ACharacter_SeedCaller_Minion_C::NotifyHitTarget(struct FDamageInfo* DamageInfo)
{
