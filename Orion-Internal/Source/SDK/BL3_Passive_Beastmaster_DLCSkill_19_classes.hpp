...
#include "BL3_Passive_Beastmaster_DLCSkill_19_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Passive_Beastmaster_DLCSkill_19.Passive_Beastmaster_DLCSkill_18_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Passive_Beastmaster_DLCSkill_19(int EntryPoint);
};
