...
#include "BL3_DamageData_PetSkag_Vortex_parameters.hpp"
...
void UDamageData_PetSkag_Vortex_C::OnHitEnemy(class AActor** DamageInstigator, class AActor** DamageCauser, class AActor** DamageTarget, struct FDamageDataEventDetails* Details)
{
	static auto fn = UObject::FindObject<UFunction>("Function DamageData_PetSkag_Vortex.DamageData_PetSkag_Vortex_C.OnHitEnemy");

	UDamageData_PetSkag_Vortex_C_OnHitEnemy_Params params;
