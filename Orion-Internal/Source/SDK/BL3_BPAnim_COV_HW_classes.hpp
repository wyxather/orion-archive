...
#include "BL3_BPAnim_COV_HW_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_COV_HW.BPAnim_COV_HW_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_COV_HW(int EntryPoint);
};
