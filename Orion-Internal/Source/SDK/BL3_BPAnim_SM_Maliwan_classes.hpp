...
#include "BL3_BPAnim_SM_Maliwan_structs.hpp"
...
public:
	...
	bool                                               bPrimaryUseMode;                                          // 0x0AE0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SM_Maliwan.BPAnim_SM_Maliwan_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SM_Maliwan(int EntryPoint);
};
