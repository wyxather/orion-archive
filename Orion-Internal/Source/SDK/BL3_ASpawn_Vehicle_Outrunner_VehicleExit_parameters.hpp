...
#include "BL3_ASpawn_Vehicle_Outrunner_VehicleExit_classes.hpp"
...
struct UASpawn_Vehicle_Outrunner_VehicleExit_C_OnBegin_Params
{
	class AActor**                                     Actor;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function ASpawn_Vehicle_Outrunner_VehicleExit.ASpawn_Vehicle_Outrunner_VehicleExit_C.OnEnd
struct UASpawn_Vehicle_Outrunner_VehicleExit_C_OnEnd_Params
{
...
struct UASpawn_Vehicle_Outrunner_VehicleExit_C_ExecuteUbergraph_ASpawn_Vehicle_Outrunner_VehicleExit_Params
{
