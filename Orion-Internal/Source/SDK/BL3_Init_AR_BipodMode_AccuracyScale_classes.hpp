...
#include "BL3_Init_AR_BipodMode_AccuracyScale_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Init_AR_BipodMode_AccuracyScale.Init_AR_BipodMode_AccuracyScale_C");
		return ptr;
	}
