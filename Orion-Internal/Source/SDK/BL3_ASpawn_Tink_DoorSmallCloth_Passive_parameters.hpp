...
#include "BL3_ASpawn_Tink_DoorSmallCloth_Passive_classes.hpp"
...
struct UASpawn_Tink_DoorSmallCloth_Passive_C_OnBegin_Params
{
	class AActor**                                     Actor;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function ASpawn_Tink_DoorSmallCloth_Passive.ASpawn_Tink_DoorSmallCloth_Passive_C.OnEnd
struct UASpawn_Tink_DoorSmallCloth_Passive_C_OnEnd_Params
{
...
struct UASpawn_Tink_DoorSmallCloth_Passive_C_ExecuteUbergraph_ASpawn_Tink_DoorSmallCloth_Passive_Params
{
