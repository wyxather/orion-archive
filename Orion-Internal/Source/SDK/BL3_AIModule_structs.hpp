...
// Enum AIModule.EEqsTraceDrawMode
enum class EEqsTraceDrawMode : uint8_t
{
	None                           = 0,
	DrawFailed                     = 1,
	DrawSucceeded                  = 2,
...
struct FEnvTraceData
{
	...
	unsigned char                                      bCanTraceOnFlight : 1;                                    // 0x002C(0x0001) (Edit, DisableEditOnInstance)
...
struct FAIStimulus
{
	...
	unsigned char                                      UnknownData02 : 1;                                        // 0x0044(0x0001)
	unsigned char                                      bSuccessfullySensed : 1;                                  // 0x0044(0x0001) (BlueprintVisible)
	unsigned char                                      UnknownData03[0x13];                                      // 0x0045(0x0013) MISSED OFFSET
	struct FVector                                     SourceLocation;                                           // 0x0058(0x000C) (BlueprintVisible, IsPlainOldData)
...
struct FEnvQueryInstanceCache
{
	...
	unsigned char                                      UnknownData00[0x190];                                     // 0x0008(0x0190) MISSED OFFSET
};
...
// ScriptStruct AIModule.SenseMetadata
// 0x0008
struct FSenseMetadata
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) MISSED OFFSET
};
