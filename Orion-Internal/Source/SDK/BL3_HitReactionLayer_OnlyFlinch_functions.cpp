...
#include "BL3_HitReactionLayer_OnlyFlinch_parameters.hpp"
...
// Function HitReactionLayer_OnlyFlinch.HitReactionLayer_OnlyFlinch_C.EvaluateTag
...
class UHitReactionTag* UHitReactionLayer_OnlyFlinch_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_OnlyFlinch.HitReactionLayer_OnlyFlinch_C.EvaluateTag");

	UHitReactionLayer_OnlyFlinch_C_EvaluateTag_Params params;
