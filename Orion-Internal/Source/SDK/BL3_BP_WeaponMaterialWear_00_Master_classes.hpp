...
#include "BL3_BP_WeaponMaterialWear_00_Master_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_WeaponMaterialWear_00_Master.BP_WeaponMaterialWear_00_Master_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_WeaponMaterialWear_00_Master(int EntryPoint);
};
