...
#include "BL3_LightProjectile_Mutant_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_Mutant.LightProjectile_Mutant_C");
		return ptr;
	}
