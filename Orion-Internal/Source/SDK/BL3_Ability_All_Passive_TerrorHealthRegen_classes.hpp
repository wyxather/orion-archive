...
#include "BL3_Ability_All_Passive_TerrorHealthRegen_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_All_Passive_TerrorHealthRegen.Ability_All_Passive_TerrorHealthRegen_C");
		return ptr;
	}


	void OnActivated();
	void ExecuteUbergraph_Ability_All_Passive_TerrorHealthRegen(int EntryPoint);
};
