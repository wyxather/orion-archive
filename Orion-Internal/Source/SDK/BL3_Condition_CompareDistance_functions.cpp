...
#include "BL3_Condition_CompareDistance_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Condition_CompareDistance.Condition_CompareDistance_C.EvaluateCondition");
