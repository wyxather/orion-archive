...
#include "BL3_BPWeaponFireProjectileComponent_ATL_Replay_structs.hpp"
...
public:
	...
	int                                                HomingTargetIndex;                                        // 0x0970(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BPWeaponFireProjectileComponent_ATL_Replay.BPWeaponFireProjectileComponent_ATL_Replay_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPWeaponFireProjectileComponent_ATL_Replay(int EntryPoint);
};
