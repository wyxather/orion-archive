...
#include "BL3_PassiveSkill_Siren_LaidBare_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PassiveSkill_Siren_LaidBare.PassiveSkill_Siren_LaidBare_C.OnActivated");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PassiveSkill_Siren_LaidBare.PassiveSkill_Siren_LaidBare_C.SirenSkillEvent_OnCausedAnyDamage");
...
void UPassiveSkill_Siren_LaidBare_C::ExecuteUbergraph_PassiveSkill_Siren_LaidBare(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function PassiveSkill_Siren_LaidBare.PassiveSkill_Siren_LaidBare_C.ExecuteUbergraph_PassiveSkill_Siren_LaidBare");
