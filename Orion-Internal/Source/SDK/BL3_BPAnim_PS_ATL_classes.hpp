...
#include "BL3_BPAnim_PS_ATL_structs.hpp"
...
public:
	...
	class ABPWeap_ATL_BaseWeapon_C*                    BaseWeapon;                                               // 0x1070(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               HasHomingTarget;                                          // 0x1078(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               HasFiredRecently;                                         // 0x1079(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               bFlapsOut;                                                // 0x107A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               MarkerMode;                                               // 0x107B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PS_ATL.BPAnim_PS_ATL_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_PS_ATL(int EntryPoint);
};
