...
#include "BL3_BPAnim_SM_Hyperion_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SM_Hyperion.BPAnim_SM_Hyperion_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SM_Hyperion(int EntryPoint);
};
