...
#include "BL3_Ability_Artifact_Cauterizer_structs.hpp"
...
public:
	...
	bool                                               AugmentAvailable;                                         // 0x0150(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_Artifact_Cauterizer.Ability_Artifact_Cauterizer_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Ability_Artifact_Cauterizer(int EntryPoint);
};
