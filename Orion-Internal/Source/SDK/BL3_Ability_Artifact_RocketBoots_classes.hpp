...
#include "BL3_Ability_Artifact_RocketBoots_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_Artifact_RocketBoots.Ability_Artifact_RocketBoots_C");
		return ptr;
	}
	...
	void OnDeactivated();
	void ExecuteQuery();
	void ExecuteUbergraph_Ability_Artifact_RocketBoots(int EntryPoint);
};
