...
#include "RFTA_Character_Wasteland_IronSentinel_Turret_parameters.hpp"
...
void ACharacter_Wasteland_IronSentinel_Turret_C::GetBrutalMarkDamageMod(struct FDamageInfo* InputPin, float* DamageMod)
{
...
void ACharacter_Wasteland_IronSentinel_Turret_C::GetArmorScalars(struct FDamageInfo* DamageInfo, float* MinionDamageScalar)
{
...
void ACharacter_Wasteland_IronSentinel_Turret_C::NotifyHitTarget(struct FDamageInfo* DamageInfo)
{
