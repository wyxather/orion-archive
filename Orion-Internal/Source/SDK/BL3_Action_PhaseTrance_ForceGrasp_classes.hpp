...
#include "BL3_Action_PhaseTrance_ForceGrasp_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Action_PhaseTrance_ForceGrasp.Action_PhaseTrance_ForceGrasp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Action_PhaseTrance_ForceGrasp(int EntryPoint);
};
