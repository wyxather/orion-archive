...
#include "BL3_BP_GM_Payload_Lightspeed_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_Lightspeed.BP_GM_Payload_Lightspeed_C.K2_GrenadeBeginPlay");
...
void UBP_GM_Payload_Lightspeed_C::K2_GrenadeImpact(class AGrenade** Grenade, class AGrenadeMod** GrenadeMod, struct FHitResult* HitResult, struct FPayloadInstanceData* InstanceData)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_Lightspeed.BP_GM_Payload_Lightspeed_C.K2_GrenadeImpact");
