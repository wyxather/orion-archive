...
#include "BL3_Condition_DuelTotemParticipant_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Condition_DuelTotemParticipant.Condition_DuelTotemParticipant_C.EvaluateCondition");
