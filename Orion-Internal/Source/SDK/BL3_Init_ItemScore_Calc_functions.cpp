...
#include "BL3_Init_ItemScore_Calc_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Init_ItemScore_Calc.Init_ItemScore_Calc_C.CalculateAttributeInitialValue");
