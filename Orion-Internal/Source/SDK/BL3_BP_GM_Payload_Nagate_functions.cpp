...
#include "BL3_BP_GM_Payload_Nagate_parameters.hpp"
...
void UBP_GM_Payload_Nagate_C::K2_GrenadeBeginPlay(class AGrenade** Grenade, class AGrenadeMod** GrenadeMod, struct FPayloadInstanceData* InstanceData)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_Nagate.BP_GM_Payload_Nagate_C.K2_GrenadeBeginPlay");

	UBP_GM_Payload_Nagate_C_K2_GrenadeBeginPlay_Params params;
