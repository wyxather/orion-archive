...
#include "BL3_BPAnim_PetLoader_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x4EA8(0x0008) MISSED OFFSET
	...
	bool                                               InPassiveStance;                                          // 0x55C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               InCombatStance;                                           // 0x55C9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x55CA(0x0002) MISSED OFFSET
	float                                              bCustomRightArmOverride;                                  // 0x55CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bBadassType;                                              // 0x55D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<Enum_PetLoader_Variations>             Pet_Variations;                                           // 0x55D1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               EXPLoader;                                                // 0x55D2(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               Charge;                                                   // 0x55D3(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_PetLoader.BPAnim_PetLoader_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_PetLoader(int EntryPoint);
};
