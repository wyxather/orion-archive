...
#include "BL3_BP_GM_Payload_MoxiesBosom_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_GM_Payload_MoxiesBosom.BP_GM_Payload_MoxiesBosom_C");
		return ptr;
	}
