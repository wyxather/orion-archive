...
#include "BL3_BPAnim_SM_TED_RaptorLegs_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x1638(0x0008) MISSED OFFSET
	...
	class ABPChar_TedioreTurret_C*                     Base_BPChar;                                              // 0x1918(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SM_TED_RaptorLegs.BPAnim_SM_TED_RaptorLegs_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SM_TED_RaptorLegs(int EntryPoint);
};
