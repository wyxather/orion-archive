...
#include "BL3_BP_GM_Payload_Epicenter_parameters.hpp"
...
void UBP_GM_Payload_Epicenter_C::K2_GrenadeExplode(class AGrenade** Grenade, class AGrenadeMod** GrenadeMod, struct FPayloadInstanceData* InstanceData)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GM_Payload_Epicenter.BP_GM_Payload_Epicenter_C.K2_GrenadeExplode");

	UBP_GM_Payload_Epicenter_C_K2_GrenadeExplode_Params params;
