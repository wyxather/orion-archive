...
#include "BL3_BP_GM_Payload_FireStorm_structs.hpp"
...
class UBP_GM_Payload_FireStorm_C : public UGrenadeBehavior_PayloadBlueprint
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_GM_Payload_FireStorm.BP_GM_Payload_FireStorm_C");
		return ptr;
	}
