...
#include "BL3_MediaAssets_parameters.hpp"
...
// Function MediaAssets.MediaPlayer.SetAudioSinkProvider
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// TScriptInterface<class UMediaAudioSinkProviderInterface> NewSinkProvider                (Parm, ZeroConstructor, IsPlainOldData)

void UMediaPlayer::SetAudioSinkProvider(const TScriptInterface<class UMediaAudioSinkProviderInterface>& NewSinkProvider)
{
	static auto fn = UObject::FindObject<UFunction>("Function MediaAssets.MediaPlayer.SetAudioSinkProvider");

	UMediaPlayer_SetAudioSinkProvider_Params params;
	params.NewSinkProvider = NewSinkProvider;
