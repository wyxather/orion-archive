...
#include "BL3_Ability_CM_Ixora_BSM_L01_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_CM_Ixora_BSM_L01.Ability_CM_Ixora_BSM_L01_C");
		return ptr;
	}
	...
	void OnActivated();
	void ExecuteUbergraph_Ability_CM_Ixora_BSM_L01(int EntryPoint);
};
