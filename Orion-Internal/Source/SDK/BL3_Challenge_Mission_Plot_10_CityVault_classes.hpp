...
#include "BL3_Challenge_Mission_Plot_10_CityVault_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_Mission_Plot_10_CityVault.Challenge_Mission_Plot_10_CityVault_C");
		return ptr;
	}


	void CompletedChallenge(class AGbxPlayerController** CompletedPlayer);
	void ExecuteUbergraph_Challenge_Mission_Plot_10_CityVault(int EntryPoint);
};
