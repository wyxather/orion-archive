...
#include "BL3_MovieSceneTracks_structs.hpp"
...
{
public:
	bool                                               bAffectsCoarseMotor;                                      // 0x0180(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAffectsFineMotor;                                        // 0x0181(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAffectsRightTrigger;                                     // 0x0182(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAffectsLeftTrigger;                                      // 0x0183(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0184(0x0004) MISSED OFFSET

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class MovieSceneTracks.MovieSceneFeedbackSection");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class MovieSceneTracks.MovieSceneFeedbackTrack");
		return ptr;
	}
...
{
public:
	struct FMovieSceneFloatChannel                     PlayRateChannel;                                          // 0x00E0(0x00A0)
	struct FMovieSceneBoolChannel                      FrameSnappingChannel;                                     // 0x0180(0x0090)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class MovieSceneTracks.MovieSceneGbxPlayRateSection");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class MovieSceneTracks.MovieSceneGbxPlayRateTrack");
		return ptr;
	}
...
public:
	...
	TArray<struct FActorParameterNameAndChannel>       ActorParameterNamesAndChannels;                           // 0x0110(0x0010) (ZeroConstructor)
...
{
public:
	struct FMovieSceneSkeletalAnimationParams          Params;                                                   // 0x00E0(0x00D0) (Edit)
	...
	void GetAvailableSlotNames(TArray<struct FName>* OutSlotNames);
};
