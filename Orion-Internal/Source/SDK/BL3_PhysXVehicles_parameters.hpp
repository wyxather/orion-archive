...
struct UWheeledVehicleMovementComponent_SetAutoBrake_Params
{
...
struct UWheeledVehicleMovementComponent_IsAutoBraking_Params
{
...
struct UWheeledVehicleMovementComponent_GetSteeringInput_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function PhysXVehicles.WheeledVehicleMovementComponent.GetPlanarSpeed
struct UWheeledVehicleMovementComponent_GetPlanarSpeed_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function PhysXVehicles.WheeledVehicleMovementComponent.GetLateralSpeed
struct UWheeledVehicleMovementComponent_GetLateralSpeed_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function PhysXVehicles.WheeledVehicleMovementComponent.GetHandbrakeInput
struct UWheeledVehicleMovementComponent_GetHandbrakeInput_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UWheeledVehicleMovementComponent_GetBrakeInput_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
