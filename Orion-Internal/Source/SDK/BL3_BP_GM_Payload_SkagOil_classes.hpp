...
#include "BL3_BP_GM_Payload_SkagOil_structs.hpp"
...
class UBP_GM_Payload_SkagOil_C : public UGrenadeBehavior_PayloadLingering
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_GM_Payload_SkagOil.BP_GM_Payload_SkagOil_C");
		return ptr;
	}
