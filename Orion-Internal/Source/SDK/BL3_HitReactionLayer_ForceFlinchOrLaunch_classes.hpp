...
#include "BL3_HitReactionLayer_ForceFlinchOrLaunch_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass HitReactionLayer_ForceFlinchOrLaunch.HitReactionLayer_ForceFlinchOrLaunch_C");
		return ptr;
	}
