...
#include "BL3_LightProjectile_HW_BanditLauncher_v2_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_HW_BanditLauncher_v2.LightProjectile_HW_BanditLauncher_v2_C");
		return ptr;
	}
