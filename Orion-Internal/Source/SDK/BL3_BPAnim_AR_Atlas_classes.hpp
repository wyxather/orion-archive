...
#include "BL3_BPAnim_AR_Atlas_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x1128(0x0008) MISSED OFFSET
	...
	class ABPWeap_ATL_BaseWeapon_C*                    BaseWeapon;                                               // 0x12E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               HasHomingTarget;                                          // 0x12E8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               HasFiredRecently;                                         // 0x12E9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               bFlapsOut;                                                // 0x12EA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_AR_Atlas.BPAnim_AR_Atlas_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_AR_Atlas(int EntryPoint);
};
