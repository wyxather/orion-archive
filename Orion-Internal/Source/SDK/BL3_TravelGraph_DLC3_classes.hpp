...
#include "BL3_TravelGraph_DLC3_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TravelGraph_DLC3.TravelGraph_DLC3_C");
		return ptr;
	}


	void ExecuteUbergraph_TravelGraph_DLC3(int EntryPoint);
};
