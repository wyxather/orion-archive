...
#include "BL3_Init_COV_HeatToFirerate_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Init_COV_HeatToFirerate.Init_COV_HeatToFirerate_C");
		return ptr;
	}
