...
#include "BL3_PhysXVehicles_parameters.hpp"
...
// Function PhysXVehicles.WheeledVehicleMovementComponent.SetAutoBrake
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                           bWantedAutoBrake               (Parm, ZeroConstructor, IsPlainOldData)
// struct FName                   Reason                         (Parm, ZeroConstructor, IsPlainOldData)

void UWheeledVehicleMovementComponent::SetAutoBrake(bool bWantedAutoBrake, const struct FName& Reason)
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.SetAutoBrake");
...
// Function PhysXVehicles.WheeledVehicleMovementComponent.IsAutoBraking
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.IsAutoBraking");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetThrottleInput");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetSteeringInput");
...
// Function PhysXVehicles.WheeledVehicleMovementComponent.GetPlanarSpeed
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// float                          ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetPlanarSpeed");
...
// Function PhysXVehicles.WheeledVehicleMovementComponent.GetLateralSpeed
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// float                          ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetLateralSpeed");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetHandbrakeInput");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysXVehicles.WheeledVehicleMovementComponent.GetBrakeInput");
