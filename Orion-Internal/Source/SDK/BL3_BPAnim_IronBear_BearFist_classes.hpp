...
#include "BL3_BPAnim_IronBear_BearFist_structs.hpp"
...
public:
	...
	float                                              Hand_End;                                                 // 0x0938(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                Mod3SlotWeight;                                           // 0x093C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_IronBear_BearFist.BPAnim_IronBear_BearFist_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_IronBear_BearFist(int EntryPoint);
};
