...
#include "BL3_BPWeap_SM_MAL_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BPWeap_SM_MAL.BPWeap_SM_MAL_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPWeap_SM_MAL(int EntryPoint);
};
