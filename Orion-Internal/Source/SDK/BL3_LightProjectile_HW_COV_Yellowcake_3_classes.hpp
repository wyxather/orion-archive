...
#include "BL3_LightProjectile_HW_COV_Yellowcake_3_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_HW_COV_Yellowcake_3.LightProjectile_HW_COV_Yellowcake_2_C");
		return ptr;
	}
