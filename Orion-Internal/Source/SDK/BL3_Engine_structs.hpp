...
#include "BL3_Slate_classes.hpp"
#include "BL3_SlateCore_classes.hpp"
#include "BL3_CoreUObject_classes.hpp"
#include "BL3_PacketHandler_classes.hpp"
#include "BL3_InputCore_classes.hpp"
#include "BL3_AudioPlatformConfiguration_classes.hpp"
...
// Enum Engine.ERadialBlurPreset
enum class ERadialBlurPreset : uint8_t
{
	RadialBlur_Small               = 0,
	RadialBlur_Medium              = 1,
	RadialBlur_Large               = 2,
...
// Enum Engine.EGbxViewFlagAction
enum class EGbxViewFlagAction : uint8_t
{
	Set                            = 0,
	Add                            = 1,
	Remove                         = 2,
...
// Enum Engine.EHavokNavMobility
enum class EHavokNavMobility : uint8_t
{
	Automatic                      = 0,
	Static                         = 1,
	Movable                        = 2,
	EHavokNavMobility_MAX          = 3
};


// Enum Engine.EHavokNavGeometryUsage
enum class EHavokNavGeometryUsage : uint8_t
{
	Automatic                      = 0,
	WalkableSurface                = 1,
	StaticPaintingVolume           = 2,
	DynamicPaintingVolume          = 3,
	None                           = 4,
	EHavokNavGeometryUsage_MAX     = 5
};


// Enum Engine.EHavokNavGeometrySource
enum class EHavokNavGeometrySource : uint8_t
{
	SimpleCollision                = 0,
	SingleConvex                   = 1,
	BoundingBox                    = 2,
	EHavokNavGeometrySource_MAX    = 3
};


// Enum Engine.EHavokNavPresets
enum class EHavokNavPresets : uint8_t
{
	Default                        = 0,
	Block                          = 1,
	Ignore                         = 2,
	Custom                         = 3,
	EHavokNavPresets_MAX           = 4
};
...
// Enum Engine.EAnimNotifyEndReason
enum class EAnimNotifyEndReason : uint8_t
{
	DurationCompleted              = 0,
...
// Enum Engine.ERootMotionBlendType
enum class ERootMotionBlendType : uint8_t
{
	Blend                          = 0,
	Source                         = 1,
	Target                         = 2,
	ERootMotionBlendType_MAX       = 3
};


// Enum Engine.EBlendStartTime
enum class EBlendStartTime : uint8_t
{
	BST_Default                    = 0,
	BST_AnimMarker                 = 1,
	BST_End                        = 2,
...
// Enum Engine.FAnimNotifyTrackLockState
enum class EFAnimNotifyTrackLockState : uint8_t
{
	Locked                         = 0,
	GeneratedOnly                  = 1,
	Unlocked                       = 2,
	FAnimNotifyTrackLockState_MAX  = 3
};
...
// Enum Engine.EDefaultVertexColor
enum class EDefaultVertexColor : uint8_t
{
	OpaqueWhite                    = 0,
	OpaqueGrey                     = 1,
	OpaqueBlack                    = 2,
	...
	TransparentBlack               = 8,
	NUM                            = 9,
	EDefaultVertexColor_MAX        = 10
};


// Enum Engine.ECullMethod
enum class ECullMethod : uint8_t
{
	CEIL                           = 0,
	ROUND                          = 1,
	INTERPOLATE                    = 2,
...
enum class ENodeEnabledState : uint8_t
{
	...
	DevelopmentOnly                = 2,
	AutomationOnly                 = 3,
	ConstructionScriptOnly         = 4,
	AutomationAndConstruction      = 5,
	ENodeEnabledState_MAX          = 6
};
...
// Enum Engine.EGbxViewFlag
enum class EGbxViewFlag : uint8_t
{
	FirstPerson                    = 0,
	ThirdPerson                    = 1,
	HideViewTarget                 = 2,
...
enum class EViewModeIndex : uint8_t
{
	...
	VMI_VisualizeLightMapBase      = 24,
	VMI_VisualizeLightMapTimeOfDay = 25,
	VMI_VisualizeSkyBentNormal     = 26,
	VMI_VisualizeSkyOcclusion      = 27,
	VMI_VisualizeAOMaterialMask    = 28,
	VMI_VertexShaderComplexity     = 29,
	VMI_QueryOnlyVisibility        = 30,
	VMI_PhysicsOnlyVisibility      = 31,
	VMI_Max                        = 32,
	VMI_Unknown                    = 33
};
...
// Enum Engine.ELODDetailSetting
enum class ELODDetailSetting : uint8_t
{
	Low                            = 0,
	Medium                         = 1,
	High                           = 2,
...
// Enum Engine.EExtraCollisionChannel
enum class EExtraCollisionChannel : uint8_t
{
	ExtraCollisionChannel1         = 0,
	ExtraCollisionChannel2         = 1,
	ExtraCollisionChannel3         = 2,
	ExtraCollisionChannel4         = 3,
	ExtraCollisionChannel_MAX      = 4,
	EExtraCollisionChannel_MAX     = 5
};
...
// Enum Engine.EGbxColorRemapLUTCategory
enum class EGbxColorRemapLUTCategory : uint8_t
{
	DCRC_World                     = 0,
	DCRC_FX                        = 1,
	DCRC_MAX                       = 2
...
// Enum Engine.EPrimitiveSpecificDataFlags
enum class EPrimitiveSpecificDataFlags : uint8_t
{
	PSDF_LocalUvForPost            = 0,
...
// Enum Engine.EAnimSetFindReplaceDLC
enum class EAnimSetFindReplaceDLC : uint8_t
{
	None                           = 0,
	Game                           = 1,
	Dandelion                      = 2,
	...
	Geranium                       = 4,
	Daffodil                       = 5,
	EAnimSetFindReplaceDLC_MAX     = 6
};


// Enum Engine.EAnimDebugChannel
enum class EAnimDebugChannel : uint8_t
{
	LegIK                          = 0,
	LookAt                         = 1,
	StretchBones                   = 2,
	...
	GaitScaling                    = 10,
	Misc                           = 11,
	AnimDebugChannelCount          = 12,
	EAnimDebugChannel_MAX          = 13
};


// Enum Engine.EGbxAttributeModifierType
enum class EGbxAttributeModifierType : uint8_t
{
	Scale                          = 0,
	PreAdd                         = 1,
	PostAdd                        = 2,
...
// Enum Engine.EBoneSetTransitionBlendType
enum class EBoneSetTransitionBlendType : uint8_t
{
	Default                        = 0,
	None                           = 1,
	BlendToOne                     = 2,
	BlendToZero                    = 3,
	ResetToZero_BlendToOne         = 4,
	ResetToOne_BlendToZero         = 5,
	One                            = 6,
	Zero                           = 7,
	EBoneSetTransitionBlendType_MAX = 8
};


// Enum Engine.ECurveOverrideType
enum class ECurveOverrideType : uint8_t
{
	None                           = 0,
	SingleCurve                    = 1,
	NormalizeCurves                = 2,
	ECurveOverrideType_MAX         = 3
};


// Enum Engine.EGbxColorRemapLUTSource
enum class EGbxColorRemapLUTSource : uint8_t
{
	DCRS_Identity                  = 0,
	DCRS_NegativeIdentity          = 1,
	DCRS_FlattenedTexture2D        = 2,
	DCRS_PostProcessSettings       = 3,
	DCRS_MAX                       = 4
};


// Enum Engine.GbxSignificance
enum class EGbxSignificance : uint8_t
{
	Unknown                        = 0,
	Insignificant                  = 1,
	DistantAndInvisible            = 2,
	DistantAndVisible              = 3,
	Significant                    = 4,
	MAX                            = 5
};
...
// Enum Engine.EGbxTraceAsyncType
enum class EGbxTraceAsyncType : uint8_t
{
	Line                           = 0,
	Sphere                         = 1,
	Capsule                        = 2,
	Box                            = 3,
	Count                          = 4,
	EGbxTraceAsyncType_MAX         = 5
};


// Enum Engine.EGbxTraceAsyncMode
enum class EGbxTraceAsyncMode : uint8_t
{
	Channel                        = 0,
	ObjectType                     = 1,
	ObjectTypes                    = 2,
	Count                          = 3,
	EGbxTraceAsyncMode_MAX         = 4
};


// Enum Engine.EGbxZoneMapFODDataState
enum class EGbxZoneMapFODDataState : uint8_t
{
	ZMDS_Unknown                   = 0,
	ZMDS_NoValidTexels             = 1,
	ZMDS_NoDiscovery               = 2,
	ZMDS_SomeDiscovery             = 3,
	ZMDS_FullDiscovery             = 4,
	ZMDS_MAX                       = 5
};


// Enum Engine.EHavokNavDataType
enum class EHavokNavDataType : uint8_t
{
	MESH                           = 0,
	VOLUME                         = 1,
	EHavokNavDataType_MAX          = 2
};
...
enum class ELevelLandscapeCullingPrecision : uint8_t
{
	...
	Medium                         = 1,
	Low                            = 2,
	ELevelLandscapeCullingPrecision_MAX = 3
};
...
enum class EDecalBlendMode : uint8_t
{
	...
	DBM_DBuffer_ColorNormalRoughnessEmissive = 11,
	DBM_Volumetric_DistanceFunction = 12,
	DBM_AlphaComposite             = 13,
	DBM_AmbientOcclusion           = 14,
	DBM_MAX                        = 15
};
...
enum class ESceneTextureId : uint8_t
{
	...
	PPI_CustomDataGBX              = 27,
	PPI_ShadingModelId             = 28,
	PPI_LightDistortion            = 29,
	PPI_CustomColor                = 30,
	PPI_MAX                        = 31
};
...
// Enum Engine.ETimeOrigin
enum class ETimeOrigin : uint8_t
{
	Absolute                       = 0,
	Primitive                      = 1,
	Material                       = 2,
...
// Enum Engine.ETimeSource
enum class ETimeSource : uint8_t
{
	Game                           = 0,
	Real                           = 1,
	ETimeSource_MAX                = 2
...
// Enum Engine.EMaterialParameterCopyMethod
enum class EMaterialParameterCopyMethod : uint8_t
{
	CopyAllButInstanced            = 0,
	CopyAllButSelfInstanced        = 1,
	CopyAll                        = 2,
	EMaterialParameterCopyMethod_MAX = 3
};
...
enum class EMaterialUsage : uint8_t
{
	...
	MATUSAGE_SkyEnvMap             = 13,
	MATUSAGE_SkeletalMeshParticles = 14,
	MATUSAGE_Cables                = 15,
	MATUSAGE_GPUSprites            = 16,
	MATUSAGE_VolumetricTranslucentShadows = 17,
	MATUSAGE_MAX                   = 18
};
...
// Enum Engine.EMaterialPowerFunction
enum class EMaterialPowerFunction : uint8_t
{
	ClampedPow                     = 0,
	PositiveClampedPow             = 1,
	UnClampedPow                   = 2,
	PositiveUnClampedPow           = 3,
	EMaterialPowerFunction_MAX     = 4
};
...
// Enum Engine.EmitterPlatform
enum class EmitterPlatform : uint8_t
{
	PC                             = 0,
	XBoxOne                        = 1,
	PS4                            = 2,
	SplitScreen                    = 3,
	None                           = 4,
	EmitterPlatform_MAX            = 5
};


// Enum Engine.EmitterPerformanceCategory
enum class EmitterPerformanceCategory : uint8_t
{
	Critical                       = 0,
	NonCritical                    = 1,
	Disabled                       = 2,
	EmitterPerformanceCategory_MAX = 3
};
...
// Enum Engine.EBeamAttachmentType
enum class EBeamAttachmentType : uint8_t
{
	None                           = 0,
	Location                       = 1,
	Actor                          = 2,
...
// Enum Engine.EBeamModuleTaperMethod
enum class EBeamModuleTaperMethod : uint8_t
{
	None                           = 0,
	Full                           = 1,
	Partial                        = 2,
	EBeamModuleTaperMethod_MAX     = 3
};


// Enum Engine.EBeamInterpolation
enum class EBeamInterpolation : uint8_t
{
	Linear                         = 0,
	Cubic                          = 1,
	Spline                         = 2,
	EBeamInterpolation_MAX         = 3
};


// Enum Engine.EBeamMethod
...
// Enum Engine.EmitterLocationMode
enum class EmitterLocationMode : uint8_t
{
	Direct                         = 0,
	EvenDistribution               = 1,
	ManualAlpha                    = 2,
	EmitterLocationMode_MAX        = 3
};
...
// Enum Engine.StartTimeSelectionMethod
enum class EStartTimeSelectionMethod : uint8_t
{
	Relative                       = 0,
	Absolute                       = 1,
	StartTimeSelectionMethod_MAX   = 2
};


// Enum Engine.AnimationSelectionMethod
enum class EAnimationSelectionMethod : uint8_t
{
	Random                         = 0,
	Sequential                     = 1,
	AnimationSelectionMethod_MAX   = 2
};
...
// Enum Engine.MeshSelectionMethod
enum class EMeshSelectionMethod : uint8_t
{
	Random                         = 0,
	Sequential                     = 1,
	MeshSelectionMethod_MAX        = 2
};
...
// Enum Engine.EVortexAxisAlignment
...
// Enum Engine.NoiseTimeSource
enum class ENoiseTimeSource : uint8_t
{
	EmitterTime                    = 0,
	Length                         = 1,
	ParticleLifetime               = 2,
	NoiseTimeSource_MAX            = 3
};


// Enum Engine.ParticleWaveNoiseType
enum class EParticleWaveNoiseType : uint8_t
{
	Sine                           = 0,
	Square                         = 1,
	Triangle                       = 2,
	Sawtooth                       = 3,
	ParticleWaveNoiseType_MAX      = 4
};
...
// Enum Engine.EForceKillParticlesThreshold
enum class EForceKillParticlesThreshold : uint8_t
{
	None                           = 0,
	Near                           = 1,
	Mid                            = 2,
	Far                            = 3,
	VeryFar                        = 4,
	EForceKillParticlesThreshold_MAX = 5
};
...
// Enum Engine.EStaticPruningStructure
enum class EStaticPruningStructure : uint8_t
{
	eDYNAMIC_AABB_TREE             = 0,
	eSTATIC_AABB_TREE              = 1,
	eNONE                          = 2,
	EStaticPruningStructure_MAX    = 3
};


// Enum Engine.EBroadPhaseType
enum class EBroadPhaseType : uint8_t
{
	eSAP                           = 0,
	eMBP                           = 1,
	EBroadPhaseType_MAX            = 2
};
...
// Enum Engine.EPrimitiveSceneCaptureFlags
enum class EPrimitiveSceneCaptureFlags : uint8_t
{
	PSCF_None                      = 0,
	PSCF_ForceDrawRelevance_True   = 1,
...
enum class EMaterialProperty : uint8_t
{
	...
	MP_CustomDataGBX               = 27,
	MP_CustomizedColor0            = 28,
	MP_CustomizedColor1            = 29,
	MP_CustomizedColor2            = 30,
	MP_CustomizedColor3            = 31,
...
// Enum Engine.EShaderCompareType
enum class EShaderCompareType : uint8_t
{
	Greater                        = 0,
	GreaterEqual                   = 1,
	Less                           = 2,
...
// Enum Engine.EBoundsGenerationType
enum class EBoundsGenerationType : uint8_t
{
	Default                        = 0,
	Tight                          = 1,
	EBoundsGenerationType_MAX      = 2
};
...
enum class EAnimationMode : uint8_t
{
	...
	AnimationActionNode            = 3,
	EAnimationMode_MAX             = 4
};
...
enum class EMeshComponentUpdateFlag : uint8_t
{
	...
	AlwaysTickPose                 = 1,
	OccasionallyTickPoseAndRefreshBones = 2,
	OnlyTickMontagesWhenNotRendered = 3,
	OnlyTickPoseWhenRendered       = 4,
	NeverTick                      = 5,
	EMeshComponentUpdateFlag_MAX   = 6
};
...
// Enum Engine.ETextureArchetype
enum class ETextureArchetype : uint8_t
{
	Texture2D                      = 0,
	Texture2DArray                 = 1,
	TextureCube                    = 2,
...
enum class ETextureGroup : uint8_t
{
	...
	TEXTUREGROUP_Default           = 32,
	TEXTUREGROUP_Editor            = 33,
	TEXTUREGROUP_CharacterMasks    = 34,
	TEXTUREGROUP_EffectsCharacter  = 35,
	TEXTUREGROUP_EffectsEnvironment = 36,
	TEXTUREGROUP_WorldMasks        = 37,
	TEXTUREGROUP_WeaponMasks       = 38,
	TEXTUREGROUP_VehicleMasks      = 39,
	TEXTUREGROUP_NPC               = 40,
	TEXTUREGROUP_NPCNormalMap      = 41,
	TEXTUREGROUP_NPCSpecular       = 42,
	TEXTUREGROUP_NPCMasks          = 43,
	TEXTUREGROUP_Atlas             = 44,
	TEXTUREGROUP_AtlasNormal       = 45,
	TEXTUREGROUP_AtlasMasks        = 46,
	TEXTUREGROUP_AtlasSpecular     = 47,
	TEXTUREGROUP_HlodDiffuse       = 48,
	TEXTUREGROUP_HlodNormal        = 49,
	TEXTUREGROUP_HlodMrs           = 50,
	TEXTUREGROUP_HlodMisc          = 51,
	TEXTUREGROUP_NPC_Generic       = 52,
	TEXTUREGROUP_NPC_Generic_NormalMap = 53,
	TEXTUREGROUP_NPC_Generic_Specular = 54,
	TEXTUREGROUP_NPC_Generic_Masks = 55,
	TEXTUREGROUP_WeaponAtlas       = 56,
	TEXTUREGROUP_EffectsScopes     = 57,
	TEXTUREGROUP_EffectsExplosions = 58,
	TEXTUREGROUP_MAX               = 59
};
...
// ScriptStruct Engine.TickOptimizationData
// 0x000C
struct FTickOptimizationData
{
	bool                                               bCheckForTickOptimizations;                               // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMatchActorOwnerTickState;                                // 0x0001(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0002(0x0002) MISSED OFFSET
	float                                              TickOptimDistanceFromLocalPlayers;                        // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bTickOptimizationOn;                                      // 0x0008(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FHitResult
{
	...
	struct FVector_NetQuantize                         Location;                                                 // 0x0014(0x000C)
	struct FVector_NetQuantize                         ImpactPoint;                                              // 0x0020(0x000C)
	struct FVector_NetQuantizeNormal                   Normal;                                                   // 0x002C(0x000C)
	struct FVector_NetQuantizeNormal                   ImpactNormal;                                             // 0x0038(0x000C)
	struct FVector_NetQuantize                         TraceStart;                                               // 0x0044(0x000C)
	struct FVector_NetQuantize                         TraceEnd;                                                 // 0x0050(0x000C)
	...
	struct FName                                       BoneName;                                                 // 0x0080(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       MyBoneName;                                               // 0x0088(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
// ScriptStruct Engine.HavokNavGeometrySettings
// 0x0020
struct FHavokNavGeometrySettings
{
	TEnumAsByte<EHavokNavGeometrySource>               NavigationGeometrySource;                                 // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EHavokNavGeometryUsage>                NavigationGeometryUsage;                                  // 0x0001(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x0002(0x0006) MISSED OFFSET
	class UGbxNavAreaBase*                             GbxNavArea;                                               // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	EHavokNavMobility                                  Mobility;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	int                                                PainterId;                                                // 0x0014(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	class UClass*                                      NavArea;                                                  // 0x0018(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
};
...
struct FBodyInstance
{
	...
	unsigned char                                      bReportQueriesAsBelongingToWelded : 1;                    // 0x0012(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bOverrideMaxDepenetrationVelocity : 1;                    // 0x0012(0x0001) (Edit)
	unsigned char                                      bOverrideWalkableSlopeOnInstance : 1;                     // 0x0013(0x0001) (Edit)
	...
	EHavokNavPresets                                   NavUsePreset;                                             // 0x0098(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x0098(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverrideNavGeometrySettingsOnInstance : 1;               // 0x009C(0x0001) (Deprecated)
	unsigned char                                      UnknownData08[0x3];                                       // 0x009D(0x0003) MISSED OFFSET
	struct FHavokNavGeometrySettings                   NavGeometrySettings;                                      // 0x00A0(0x0020) (Edit)
	unsigned char                                      UnknownData09[0x10];                                      // 0x00C0(0x0010) MISSED OFFSET
	...
	int                                                VelocitySolverIterationCount;                             // 0x00FC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x90];                                      // 0x0100(0x0090) MISSED OFFSET
	bool                                               bForceUseCollisionPropertiesInBody;                       // 0x0190(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x1F];                                      // 0x0191(0x001F) MISSED OFFSET
};
...
// ScriptStruct Engine.GestaltLODModelFragment
// 0x000C
struct FGestaltLODModelFragment
{
	int                                                MaterialIndex;                                            // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FirstIndex;                                               // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumPrimitives;                                            // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Engine.GestaltLODModel
// 0x0010
struct FGestaltLODModel
{
	TArray<struct FGestaltLODModelFragment>            GestaltFragments;                                         // 0x0000(0x0010) (ZeroConstructor)
};

// ScriptStruct Engine.SocketRemapEntry
// 0x0010
struct FSocketRemapEntry
{
	struct FName                                       MappedName;                                               // 0x0000(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       UniqueSocketName;                                         // 0x0008(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
};

// ScriptStruct Engine.GestaltDataContainer
// 0x0068
struct FGestaltDataContainer
{
	class USkeletalMesh*                               SkeletalMesh;                                             // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FGestaltLODModel>                    LODModelData;                                             // 0x0008(0x0010) (ZeroConstructor)
	TArray<struct FSocketRemapEntry>                   SocketMappings;                                           // 0x0018(0x0010) (ZeroConstructor)
	TArray<struct FName>                               PartNames;                                                // 0x0028(0x0010) (ZeroConstructor)
	TArray<struct FGuid>                               SupportedClothAssets;                                     // 0x0038(0x0010) (ZeroConstructor)
	struct FBoxSphereBounds                            ReferencePoseBounds;                                      // 0x0048(0x001C) (IsPlainOldData)
	bool                                               bUsingDefaultParts;                                       // 0x0064(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FSkeletalMeshLODInfo
{
	...
	unsigned char                                      bAllowCPUAccess : 1;                                      // 0x0028(0x0001) (Edit)
	unsigned char                                      bSupportUniformlyDistributedSampling : 1;                 // 0x0028(0x0001) (Edit)
...
// ScriptStruct Engine.GbxForceFeedbackEffect
// 0x0018
struct FGbxForceFeedbackEffect
{
	TArray<struct FForceFeedbackChannelDetails>        ChannelDetails;                                           // 0x0000(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0010(0x0008) MISSED OFFSET
};

// ScriptStruct Engine.ActiveGbxForceFeedbackEffect
// 0x0028
struct FActiveGbxForceFeedbackEffect
{
	struct FGbxForceFeedbackEffect                     ForceFeedbackEffect;                                      // 0x0000(0x0018)
...
// ScriptStruct Engine.ReplicatedConsoleCommandContext
// 0x0018
struct FReplicatedConsoleCommandContext
{
	uint32_t                                           Flags;                                                    // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	class FString                                      CommandAndArgs;                                           // 0x0008(0x0010) (ZeroConstructor)
};
...
// ScriptStruct Engine.RadialBlurSelection
// 0x000C
struct FRadialBlurSelection
{
	TEnumAsByte<ERadialBlurPreset>                     Selection;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	float                                              Duration;                                                 // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BlurDistance;                                             // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FKeyBind
{
	...
	unsigned char                                      bEditorOnly : 1;                                          // 0x0029(0x0001) (Config)
...
// ScriptStruct Engine.StaticLightingLevelInfo
// 0x0048
struct FStaticLightingLevelInfo
{
	struct FDateTime                                   StaticLightingBuildDateTime;                              // 0x0000(0x0008)
	struct FGuid                                       StaticLightingBuildGuid;                                  // 0x0008(0x0010) (IsPlainOldData)
	int                                                NumLightmaps;                                             // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumShadowmaps;                                            // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumTexturesTotal;                                         // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              LightMapSizeActualMB;                                     // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              ShadowMapSizeActualMB;                                    // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              LightMapSizeEstMB;                                        // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              ShadowMapSizeEstMB;                                       // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              TotalSizeEstMB;                                           // 0x0034(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              TotalSizeActualMB;                                        // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              LightMapUnusedSizeMB;                                     // 0x003C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              ShadowMapUnusedSizeMB;                                    // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              TotalUnusedSizeMB;                                        // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
// ScriptStruct Engine.SlotAnimationTrackAnimInfo
// 0x0020
struct FSlotAnimationTrackAnimInfo
{
	struct FName                                       SlotName;                                                 // 0x0000(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class FString                                      SlotAnim;                                                 // 0x0008(0x0010) (ZeroConstructor, Transient)
	int8_t                                             NumTracks;                                                // 0x0018(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FRepRootMotionMontage
{
	...
	struct FSlotAnimationTrackAnimInfo                 CurrentSlotAnimInfo;                                      // 0x0160(0x0020)
};
...
struct FSimulatedRootMotionReplicatedMove
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FRepRootMotionMontage                       RootMotion;                                               // 0x0008(0x0180)
};
...
// ScriptStruct Engine.GbxAnimSetPair
// 0x0010
struct FGbxAnimSetPair
{
...
struct FPaintedVertex
{
	...
	struct FColor                                      Color[0x2];                                               // 0x0020(0x0004) (IsPlainOldData)
...
struct FStaticMeshComponentLODInfo
{
	...
	unsigned char                                      UnknownData01[0x90];                                      // 0x0030(0x0090) MISSED OFFSET
};
...
struct FPostProcessSettings
{
	...
	unsigned char                                      bOverride_AmbientCubemapGBXCustomLitLightingChannel : 1;  // 0x0006(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_Bloom3Tint : 1;                                 // 0x0007(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_BloomSizeScale : 1;                             // 0x0008(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_BloomConvolutionBufferScale : 1;                // 0x0009(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_AutoExposureMinBrightnessHDR : 1;               // 0x000A(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_AutoExposureMaxBrightnessHDR : 1;               // 0x000A(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_AutoExposureBiasHDR : 1;                        // 0x000B(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_VignetteFeathering : 1;                         // 0x000C(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_ComputeAOEnable : 1;                            // 0x000E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAOBlurTolerance : 1;                     // 0x000E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAOUpsampleTolerance : 1;                 // 0x000E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAONoiseFilterTolerance : 1;              // 0x000E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAORejectionFalloff : 1;                  // 0x000E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAOStartFadeDistance : 1;                 // 0x000F(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAOFadeExponent : 1;                      // 0x000F(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAODepthDifference : 1;                   // 0x000F(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAOHierarchyDepth : 1;                    // 0x000F(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAOQualityLevel : 1;                      // 0x000F(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ComputeAOApplyCurve : 1;                        // 0x000F(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_LPVDirectionalOcclusionRadius : 1;              // 0x0010(0x0001) (Edit)
	unsigned char                                      bOverride_LPVDiffuseOcclusionExponent : 1;                // 0x0010(0x0001) (Edit)
	unsigned char                                      bOverride_LPVSpecularOcclusionExponent : 1;               // 0x0010(0x0001) (Edit)
	...
	unsigned char                                      bOverride_LPVGeometryVolumeBias : 1;                      // 0x0011(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_LPVVplInjectionBias : 1;                        // 0x0011(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_LPVEmissiveInjectionIntensity : 1;              // 0x0011(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_IndoorReflectionEnvironmentColor : 1;           // 0x0011(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_IndoorReflectionEnvironmentIntensity : 1;       // 0x0012(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_OutdoorReflectionEnvironmentColor : 1;          // 0x0012(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_OutdoorReflectionEnvironmentIntensity : 1;      // 0x0012(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ColorGradingIntensity : 1;                      // 0x0012(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ColorGradingLUT : 1;                            // 0x0012(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_SecondaryColorGradingIntensity : 1;             // 0x0012(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_SecondaryColorGradingLUT : 1;                   // 0x0012(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldFocalDistance : 1;                  // 0x0012(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldFstop : 1;                          // 0x0013(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldMinFstop : 1;                       // 0x0013(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldBladeCount : 1;                     // 0x0013(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldSensorWidth : 1;                    // 0x0013(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldDepthBlurRadius : 1;                // 0x0013(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldDepthBlurAmount : 1;                // 0x0013(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldFocalRegion : 1;                    // 0x0013(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldNearTransitionRegion : 1;           // 0x0013(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldFarTransitionRegion : 1;            // 0x0014(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldScale : 1;                          // 0x0014(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldMaxBokehSize : 1;                   // 0x0014(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldNearBlurSize : 1;                   // 0x0014(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldFarBlurSize : 1;                    // 0x0014(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldNearSampleCount : 1;                // 0x0014(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldFarSampleCount : 1;                 // 0x0014(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldMethod : 1;                         // 0x0014(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MobileHQGaussian : 1;                           // 0x0015(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldBokehShape : 1;                     // 0x0015(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldOcclusion : 1;                      // 0x0015(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldColorThreshold : 1;                 // 0x0015(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldSizeThreshold : 1;                  // 0x0015(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldSkyFocusDistance : 1;               // 0x0015(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldNearBlendFactor : 1;                // 0x0015(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldFarBlendFactor : 1;                 // 0x0015(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldVignetteSize : 1;                   // 0x0016(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldVignetteFeathering : 1;             // 0x0016(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldVignetteFarScale : 1;               // 0x0016(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MotionBlurAmount : 1;                           // 0x0016(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MotionBlurMax : 1;                              // 0x0016(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MotionBlurPerObjectSize : 1;                    // 0x0016(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MotionBlurStaticIntensity : 1;                  // 0x0016(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MotionBlurDynamicIntensity : 1;                 // 0x0016(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ScreenPercentage : 1;                           // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ScreenCenterOffset : 1;                         // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ScreenSpaceReflectionIntensity : 1;             // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ScreenSpaceReflectionQuality : 1;               // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ScreenSpaceReflectionMaxRoughness : 1;          // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_ScreenSpaceReflectionRoughnessScale : 1;        // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionEnable : 1;                        // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionHFilterAxisCoeff : 1;              // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionHFilterDiagCoeff : 1;              // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionVFilterAxisCoeff : 1;              // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionVFilterDiagCoeff : 1;              // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionFarDistance : 1;                   // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionNearDistance : 1;                  // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionSobelPower : 1;                    // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionTexelOffset : 1;                   // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionTransitionDistance : 1;            // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionTransitionDistanceFar : 1;         // 0x0019(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_EdgeDetectionApplyThreshold : 1;                // 0x0019(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x2];                                       // 0x001A(0x0002) MISSED OFFSET
	float                                              WhiteTemp;                                                // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              WhiteTint;                                                // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0024(0x000C) MISSED OFFSET
	struct FVector4                                    ColorSaturation;                                          // 0x0030(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorContrast;                                            // 0x0040(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorGamma;                                               // 0x0050(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorGain;                                                // 0x0060(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorOffset;                                              // 0x0070(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorSaturationShadows;                                   // 0x0080(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorContrastShadows;                                     // 0x0090(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorGammaShadows;                                        // 0x00A0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorGainShadows;                                         // 0x00B0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorOffsetShadows;                                       // 0x00C0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              ColorCorrectionShadowsMax;                                // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x00D4(0x000C) MISSED OFFSET
	struct FVector4                                    ColorSaturationMidtones;                                  // 0x00E0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorContrastMidtones;                                    // 0x00F0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorGammaMidtones;                                       // 0x0100(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorGainMidtones;                                        // 0x0110(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorOffsetMidtones;                                      // 0x0120(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorSaturationHighlights;                                // 0x0130(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorContrastHighlights;                                  // 0x0140(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorGammaHighlights;                                     // 0x0150(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorGainHighlights;                                      // 0x0160(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector4                                    ColorOffsetHighlights;                                    // 0x0170(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              ColorCorrectionHighlightsMin;                             // 0x0180(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BlueCorrection;                                           // 0x0184(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ExpandGamut;                                              // 0x0188(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmSlope;                                                // 0x018C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmToe;                                                  // 0x0190(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmShoulder;                                             // 0x0194(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmBlackClip;                                            // 0x0198(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmWhiteClip;                                            // 0x019C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                FilmWhitePoint;                                           // 0x01A0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                FilmShadowTint;                                           // 0x01B0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              FilmShadowTintBlend;                                      // 0x01C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmShadowTintAmount;                                     // 0x01C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmSaturation;                                           // 0x01C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                FilmChannelMixerRed;                                      // 0x01CC(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                FilmChannelMixerGreen;                                    // 0x01DC(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                FilmChannelMixerBlue;                                     // 0x01EC(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              FilmContrast;                                             // 0x01FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmToeAmount;                                            // 0x0200(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmHealAmount;                                           // 0x0204(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FilmDynamicRange;                                         // 0x0208(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                SceneColorTint;                                           // 0x020C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              SceneFringeIntensity;                                     // 0x021C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ChromaticAberrationStartOffset;                           // 0x0220(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBloomMethod>                          BloomMethod;                                              // 0x0224(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0225(0x0003) MISSED OFFSET
	float                                              BloomIntensity;                                           // 0x0228(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BloomThreshold;                                           // 0x022C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BloomSizeScale;                                           // 0x0230(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Bloom1Size;                                               // 0x0234(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Bloom2Size;                                               // 0x0238(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Bloom3Size;                                               // 0x023C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Bloom4Size;                                               // 0x0240(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Bloom5Size;                                               // 0x0244(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Bloom6Size;                                               // 0x0248(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                Bloom1Tint;                                               // 0x024C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                Bloom2Tint;                                               // 0x025C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                Bloom3Tint;                                               // 0x026C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                Bloom4Tint;                                               // 0x027C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                Bloom5Tint;                                               // 0x028C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                Bloom6Tint;                                               // 0x029C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x02AC(0x0004) MISSED OFFSET
	class UTexture2D*                                  BloomConvolutionTexture;                                  // 0x02B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BloomConvolutionSize;                                     // 0x02B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   BloomConvolutionCenterUV;                                 // 0x02BC(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     BloomConvolutionPreFilter;                                // 0x02C4(0x000C) (Deprecated, IsPlainOldData)
	float                                              BloomConvolutionPreFilterMin;                             // 0x02D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BloomConvolutionPreFilterMax;                             // 0x02D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BloomConvolutionPreFilterMult;                            // 0x02D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BloomConvolutionBufferScale;                              // 0x02DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTexture*                                    BloomDirtMask;                                            // 0x02E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BloomDirtMaskIntensity;                                   // 0x02E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BloomDirtMaskTint;                                        // 0x02EC(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                AmbientCubemapTint;                                       // 0x02FC(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	int                                                AmbientCubemapGBXCustomLitLightingChannel;                // 0x030C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientCubemapIntensity;                                  // 0x0310(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0314(0x0004) MISSED OFFSET
	class UTextureCube*                                AmbientCubemap;                                           // 0x0318(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CameraShutterSpeed;                                       // 0x0320(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CameraISO;                                                // 0x0324(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFstop;                                        // 0x0328(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldMinFstop;                                     // 0x032C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                DepthOfFieldBladeCount;                                   // 0x0330(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureBias;                                         // 0x0334(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureBiasHDR;                                      // 0x0338(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EAutoExposureMethod>                   AutoExposureMethod;                                       // 0x033C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x033D(0x0003) MISSED OFFSET
	float                                              AutoExposureLowPercent;                                   // 0x0340(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureHighPercent;                                  // 0x0344(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureMinBrightness;                                // 0x0348(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureMaxBrightness;                                // 0x034C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureMinBrightnessHDR;                             // 0x0350(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureMaxBrightnessHDR;                             // 0x0354(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureSpeedUp;                                      // 0x0358(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureSpeedDown;                                    // 0x035C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HistogramLogMin;                                          // 0x0360(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HistogramLogMax;                                          // 0x0364(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureCalibrationConstant;                          // 0x0368(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LensFlareIntensity;                                       // 0x036C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                LensFlareTint;                                            // 0x0370(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              LensFlareBokehSize;                                       // 0x0380(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LensFlareThreshold;                                       // 0x0384(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTexture*                                    LensFlareBokehShape;                                      // 0x0388(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                LensFlareTints[0x8];                                      // 0x0390(0x0010) (Edit, IsPlainOldData)
	float                                              VignetteIntensity;                                        // 0x0410(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              VignetteFeathering;                                       // 0x0414(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              GrainJitter;                                              // 0x0418(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              GrainIntensity;                                           // 0x041C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionIntensity;                                // 0x0420(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionStaticFraction;                           // 0x0424(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionRadius;                                   // 0x0428(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      AmbientOcclusionRadiusInWS : 1;                           // 0x042C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData07[0x3];                                       // 0x042D(0x0003) MISSED OFFSET
	float                                              AmbientOcclusionFadeDistance;                             // 0x0430(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionFadeRadius;                               // 0x0434(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionDistance;                                 // 0x0438(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              AmbientOcclusionPower;                                    // 0x043C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionBias;                                     // 0x0440(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionQuality;                                  // 0x0444(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionMipBlend;                                 // 0x0448(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionMipScale;                                 // 0x044C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AmbientOcclusionMipThreshold;                             // 0x0450(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bComputeAOEnable : 1;                                     // 0x0454(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData08[0x3];                                       // 0x0455(0x0003) MISSED OFFSET
	float                                              ComputeAOBlurTolerance;                                   // 0x0458(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ComputeAOUpsampleTolerance;                               // 0x045C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ComputeAONoiseFilterTolerance;                            // 0x0460(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ComputeAORejectionFalloff;                                // 0x0464(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ComputeAOStartFadeDistance;                               // 0x0468(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ComputeAOFadeExponent;                                    // 0x046C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ComputeAODepthDifference;                                 // 0x0470(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ComputeAOHierarchyDepth;                                  // 0x0474(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ComputeAOQualityLevel;                                    // 0x0478(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ComputeAOApplyCurve;                                      // 0x047C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                IndirectLightingColor;                                    // 0x0480(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              IndirectLightingIntensity;                                // 0x0490(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                IndoorReflectionEnvironmentColor;                         // 0x0494(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              IndoorReflectionEnvironmentIntensity;                     // 0x04A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                OutdoorReflectionEnvironmentColor;                        // 0x04A8(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              OutdoorReflectionEnvironmentIntensity;                    // 0x04B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ColorGradingIntensity;                                    // 0x04BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTexture*                                    ColorGradingLUT;                                          // 0x04C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTexture*                                    SecondaryColorGradingLUT;                                 // 0x04C8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SecondaryColorGradingIntensity;                           // 0x04D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EDepthOfFieldMethod>                   DepthOfFieldMethod;                                       // 0x04D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x04D5(0x0003) MISSED OFFSET
	unsigned char                                      bMobileHQGaussian : 1;                                    // 0x04D8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData10[0x3];                                       // 0x04D9(0x0003) MISSED OFFSET
	float                                              DepthOfFieldSensorWidth;                                  // 0x04DC(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFocalDistance;                                // 0x04E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldDepthBlurAmount;                              // 0x04E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldDepthBlurRadius;                              // 0x04E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFocalRegion;                                  // 0x04EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldNearTransitionRegion;                         // 0x04F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFarTransitionRegion;                          // 0x04F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldScale;                                        // 0x04F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldMaxBokehSize;                                 // 0x04FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldNearBlurSize;                                 // 0x0500(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFarBlurSize;                                  // 0x0504(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                DepthOfFieldNearSampleCount;                              // 0x0508(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                DepthOfFieldFarSampleCount;                               // 0x050C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTexture*                                    DepthOfFieldBokehShape;                                   // 0x0510(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldOcclusion;                                    // 0x0518(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldColorThreshold;                               // 0x051C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldSizeThreshold;                                // 0x0520(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldSkyFocusDistance;                             // 0x0524(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldNearBlendFactor;                              // 0x0528(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFarBlendFactor;                               // 0x052C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldVignetteSize;                                 // 0x0530(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldVignetteFeathering;                           // 0x0534(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldVignetteFarScale;                             // 0x0538(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MotionBlurAmount;                                         // 0x053C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MotionBlurMax;                                            // 0x0540(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MotionBlurPerObjectSize;                                  // 0x0544(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MotionBlurStaticIntensity;                                // 0x0548(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MotionBlurDynamicIntensity;                               // 0x054C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVIntensity;                                             // 0x0550(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVVplInjectionBias;                                      // 0x0554(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSize;                                                  // 0x0558(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSecondaryOcclusionIntensity;                           // 0x055C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSecondaryBounceIntensity;                              // 0x0560(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVGeometryVolumeBias;                                    // 0x0564(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVEmissiveInjectionIntensity;                            // 0x0568(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDirectionalOcclusionIntensity;                         // 0x056C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDirectionalOcclusionRadius;                            // 0x0570(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDiffuseOcclusionExponent;                              // 0x0574(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSpecularOcclusionExponent;                             // 0x0578(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDiffuseOcclusionIntensity;                             // 0x057C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSpecularOcclusionIntensity;                            // 0x0580(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenSpaceReflectionIntensity;                           // 0x0584(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenSpaceReflectionQuality;                             // 0x0588(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenSpaceReflectionMaxRoughness;                        // 0x058C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVFadeRange;                                             // 0x0590(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDirectionalOcclusionFadeRange;                         // 0x0594(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      EdgeDetectionEnable : 1;                                  // 0x0598(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0599(0x0003) MISSED OFFSET
	float                                              EdgeDetectionHFilterAxisCoeff;                            // 0x059C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionHFilterDiagCoeff;                            // 0x05A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionVFilterAxisCoeff;                            // 0x05A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionVFilterDiagCoeff;                            // 0x05A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionFarDistance;                                 // 0x05AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionNearDistance;                                // 0x05B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionSobelPower;                                  // 0x05B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionTexelOffset;                                 // 0x05B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionTransitionDistance;                          // 0x05BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionTransitionDistanceFar;                       // 0x05C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EdgeDetectionApplyThreshold;                              // 0x05C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenPercentage;                                         // 0x05C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ScreenCenterOffset;                                       // 0x05CC(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData12[0x4];                                       // 0x05D4(0x0004) MISSED OFFSET
	struct FWeightedBlendables                         WeightedBlendables;                                       // 0x05D8(0x0010) (Edit, BlueprintVisible)
	TArray<class UObject*>                             Blendables;                                               // 0x05E8(0x0010) (ZeroConstructor, Deprecated)
	unsigned char                                      UnknownData13[0x8];                                       // 0x05F8(0x0008) MISSED OFFSET
};
...
struct FMinimalViewInfo
{
	...
	float                                              ForegroundFOV;                                            // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DesiredFOV;                                               // 0x0020(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              OrthoWidth;                                               // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OrthoNearClipPlane;                                       // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OrthoFarClipPlane;                                        // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bUseFieldOfViewForLOD : 1;                                // 0x0034(0x0001) (Edit, BlueprintVisible)
	...
	struct FPostProcessSettings                        PostProcessSettings;                                      // 0x0040(0x0600) (BlueprintVisible)
	struct FVector2D                                   OffCenterProjectionOffset;                                // 0x0640(0x0008) (Edit, BlueprintVisible, DisableEditOnTemplate, Transient, EditConst, IsPlainOldData)
	unsigned char                                      bDisableSeparateTranslucency : 1;                         // 0x0648(0x0001) (Transient)
...
struct FCameraCacheEntry
{
	...
	struct FMinimalViewInfo                            POV;                                                      // 0x0010(0x0650)
};
...
struct FTViewTarget
{
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0008(0x0008) MISSED OFFSET
	struct FMinimalViewInfo                            POV;                                                      // 0x0010(0x0650) (Edit, BlueprintVisible)
	class APlayerState*                                PlayerState;                                              // 0x0660(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Engine.GbxAttributeBase
// 0x0004
struct FGbxAttributeBase
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) MISSED OFFSET
};

// ScriptStruct Engine.GbxAttributeFloat
// 0x0008 (0x000C - 0x0004)
struct FGbxAttributeFloat : public FGbxAttributeBase
{
...
// ScriptStruct Engine.NetDriverChannelClassOverride
// 0x0010
struct FNetDriverChannelClassOverride
{
	TEnumAsByte<EChannelType>                          ChannelType;                                              // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
	struct FName                                       ChannelClassName;                                         // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FNetDriverDefinition
{
	...
	TArray<struct FNetDriverChannelClassOverride>      ChannelClassOverrides;                                    // 0x0018(0x0010) (ZeroConstructor)
};

// ScriptStruct Engine.GameObjectPoolManager
// 0x03D0
struct FGameObjectPoolManager
{
	unsigned char                                      UnknownData00[0x3D0];                                     // 0x0000(0x03D0) MISSED OFFSET
};
...
struct FMaterialParameterInfo
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0008(0x0003) MISSED OFFSET
	TEnumAsByte<EMaterialParameterAssociation>         Association;                                              // 0x000B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FMaterialInstanceBasePropertyOverrides
{
	...
	bool                                               bOverride_DisableEdgeDetection;                           // 0x0006(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_ShouldDoOuterEdge;                              // 0x0007(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_IgnoreCustomMask;                               // 0x0008(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_IgnoreCustomGlow;                               // 0x0009(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_EnableWorldPositionOffset;                      // 0x000A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_EnablePixelDepthOffset;                         // 0x000B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_EnableRefraction;                               // 0x000C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	float                                              OpacityMaskClipValue;                                     // 0x0010(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBlendMode>                            BlendMode;                                                // 0x0014(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EMaterialShadingModel>                 ShadingModel;                                             // 0x0015(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0016(0x0002) MISSED OFFSET
	unsigned char                                      TwoSided : 1;                                             // 0x0018(0x0001) (Edit)
	unsigned char                                      DitheredLODTransition : 1;                                // 0x0018(0x0001) (Edit)
	unsigned char                                      bCastDynamicShadowAsMasked : 1;                           // 0x0018(0x0001) (Edit)
	unsigned char                                      DisableEdgeDetection : 1;                                 // 0x0018(0x0001) (Edit)
	unsigned char                                      bShouldDoOuterEdge : 1;                                   // 0x0018(0x0001) (Edit)
	unsigned char                                      bIgnoreCustomMask : 1;                                    // 0x0018(0x0001) (Edit)
	unsigned char                                      bIgnoreCustomGlow : 1;                                    // 0x0018(0x0001) (Edit)
	unsigned char                                      bEnableWorldPositionOffset : 1;                           // 0x0018(0x0001) (Edit)
	unsigned char                                      bEnablePixelDepthOffset : 1;                              // 0x0019(0x0001) (Edit)
	unsigned char                                      bEnableRefraction : 1;                                    // 0x0019(0x0001) (Edit)
...
// ScriptStruct Engine.AnimCompressProfile
// 0x0020
struct FAnimCompressProfile
{
	float                                              DefaultVirtualVertexDistance;                             // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SafeVirtualVertexDistance;                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SafetyFallbackThreshold;                                  // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ErrorThreshold;                                           // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FName>                               BoneToIgnores;                                            // 0x0010(0x0010) (Edit, ZeroConstructor)
};
...
struct FBakedAnimationState
{
	...
	class UGbxAnimStateManager*                        Manager;                                                  // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData)
	class UGbxBoneSet*                                 AnimStateBoneSet;                                         // 0x0050(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
	...
	TEnumAsByte<EBlendStartTime>                       BlendStartTime;                                           // 0x0039(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bResetDestinationState;                                   // 0x003A(0x0001) (ZeroConstructor, IsPlainOldData)
	ERootMotionBlendType                               RootMotionBlendType;                                      // 0x003B(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FBakedAnimationStateMachine
{
	...
	int                                                BoneSetPriority;                                          // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FRawCurveTracks
{
	...
	TArray<struct FTransformCurve>                     RootMotionCurves;                                         // 0x0010(0x0010) (ZeroConstructor)
};
...
struct FPrimaryAssetTypeInfo
{
	...
	bool                                               bSearchAllDirectories;                                    // 0x0088(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FKShapeElem
{
	...
	TEnumAsByte<ECollisionEnabled>                     CollisionEnabled;                                         // 0x0030(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x0031(0x0007) MISSED OFFSET
	class UPhysicalMaterial*                           PrimitivePhysicalMaterial;                                // 0x0038(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIsGestaltCollision : 1;                                  // 0x0040(0x0001) (Deprecated)
	unsigned char                                      UnknownData05[0x7];                                       // 0x0041(0x0007) MISSED OFFSET
	struct FName                                       GestaltPartName;                                          // 0x0048(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	TArray<struct FName>                               GestaltPartNames;                                         // 0x0050(0x0010) (Edit, ZeroConstructor)
};
...
{
	struct FMatrix                                     TM;                                                       // 0x0060(0x0040) (Deprecated, IsPlainOldData)
	struct FVector                                     Center;                                                   // 0x00A0(0x000C) (Edit, IsPlainOldData)
	float                                              Radius;                                                   // 0x00AC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	struct FMatrix                                     TM;                                                       // 0x0060(0x0040) (Deprecated, IsPlainOldData)
	struct FQuat                                       Orientation;                                              // 0x00A0(0x0010) (Deprecated, IsPlainOldData)
	struct FVector                                     Center;                                                   // 0x00B0(0x000C) (Edit, IsPlainOldData)
	struct FRotator                                    Rotation;                                                 // 0x00BC(0x000C) (Edit, IsPlainOldData)
	float                                              X;                                                        // 0x00C8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Y;                                                        // 0x00CC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Z;                                                        // 0x00D0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FKSphylElem : public FKShapeElem
{
	...
	float                                              Length;                                                   // 0x00CC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FVector>                             VertexData;                                               // 0x0060(0x0010) (ZeroConstructor)
	struct FBox                                        ElemBox;                                                  // 0x0070(0x001C) (IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FTransform                                  Transform;                                                // 0x0090(0x0030) (IsPlainOldData)
...
struct FKTaperedCapsuleElem : public FKShapeElem
{
	...
	float                                              Radius0;                                                  // 0x0078(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Radius1;                                                  // 0x007C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Length;                                                   // 0x0080(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FFOscillator
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	float                                              InitialOffsetValue;                                       // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FROscillator
{
	struct FFOscillator                                Pitch;                                                    // 0x0000(0x0010) (Edit, BlueprintVisible)
	struct FFOscillator                                Yaw;                                                      // 0x0010(0x0010) (Edit, BlueprintVisible)
	struct FFOscillator                                Roll;                                                     // 0x0020(0x0010) (Edit, BlueprintVisible)
};
...
struct FVOscillator
{
	struct FFOscillator                                X;                                                        // 0x0000(0x0010) (Edit, BlueprintVisible)
	struct FFOscillator                                Y;                                                        // 0x0010(0x0010) (Edit, BlueprintVisible)
	struct FFOscillator                                Z;                                                        // 0x0020(0x0010) (Edit, BlueprintVisible)
};
...
struct FEdGraphPinType
{
	...
	bool                                               bAllowMultipleConnection;                                 // 0x005A(0x0001) (ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Engine.GbxAnimManagerData
// 0x0018
struct FGbxAnimManagerData
{
	int                                                OccasionalTickRate;                                       // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxEvalRateForInterpolation;                              // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<float>                                      UpdateRateThresholds;                                     // 0x0008(0x0010) (Edit, ZeroConstructor)
};

// ScriptStruct Engine.GbxBoneSetEntry
// 0x0028
struct FGbxBoneSetEntry
{
	struct FBoneReference                              Bone;                                                     // 0x0000(0x0018) (Edit)
	int                                                BlendDepth;                                               // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Weight;                                                   // 0x001C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAdditive;                                                // 0x0020(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMeshSpaceRotation;                                       // 0x0021(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x0022(0x0006) MISSED OFFSET
};

// ScriptStruct Engine.NormalizeCurvesOverride
// 0x0018
struct FNormalizeCurvesOverride
{
	TArray<struct FName>                               CurveNames;                                               // 0x0000(0x0010) (Edit, ZeroConstructor)
	float                                              RangeMin;                                                 // 0x0010(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RangeMax;                                                 // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Engine.CurveWeightOverride
// 0x0040
struct FCurveWeightOverride
{
	struct FName                                       StartBoneName;                                            // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FName                                       OptionalEndBoneName;                                      // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	ECurveOverrideType                                 WeightModifierType;                                       // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	int                                                BlendDepth;                                               // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FName                                       OverrideCurveName;                                        // 0x0018(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FNormalizeCurvesOverride                    NormalizeCurvesOverride;                                  // 0x0020(0x0018) (Edit)
	float                                              Weight;                                                   // 0x0038(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x003C(0x0004) MISSED OFFSET
};

// ScriptStruct Engine.AutoLightMapResEntry
// 0x0008
struct FAutoLightMapResEntry
{
	float                                              ScaleDeviation;                                           // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                PowerOfTwoExponent;                                       // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
// ScriptStruct Engine.GbxExposeOnSpawnValueCache
// 0x0110
struct FGbxExposeOnSpawnValueCache
{
	unsigned char                                      UnknownData00[0x110];                                     // 0x0000(0x0110) MISSED OFFSET
};

// ScriptStruct Engine.GbxSpawnActorAsyncRequest
// 0x0230
struct FGbxSpawnActorAsyncRequest
{
	...
	class AActor*                                      TransformActor;                                           // 0x0040(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             TransformComponent;                                       // 0x0048(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FName                                       TransformSocketName;                                      // 0x0050(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FName>                               TransformSocketNames;                                     // 0x0058(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bTransformIgnorePitch;                                    // 0x0068(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bComputeTransformWhenSpawned;                             // 0x0069(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x006A(0x0006) MISSED OFFSET
	class AActor*                                      Owner;                                                    // 0x0070(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class AActor*                                      Instigator;                                               // 0x0078(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class AActor*                                      Template;                                                 // 0x0080(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Delay;                                                    // 0x0088(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ForceSpawnTimer;                                          // 0x008C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                InstanceCount;                                            // 0x0090(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              InstanceDelay;                                            // 0x0094(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bStopOnInstigatorDeath;                                   // 0x0098(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSkipOnClients;                                           // 0x0099(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x009A(0x0002) MISSED OFFSET
	float                                              SnapToGroundSearchExtent;                                 // 0x009C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCancelIfGroundNotFound;                                  // 0x00A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlignToGroundNormal;                                     // 0x00A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ESpawnActorCollisionHandlingMethod                 CollisionHandling;                                        // 0x00A2(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x5];                                       // 0x00A3(0x0005) MISSED OFFSET
	struct FName                                       Name;                                                     // 0x00A8(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bDeferConstruction;                                       // 0x00B0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x00B1(0x0007) MISSED OFFSET
	struct FScriptDelegate                             Spawned;                                                  // 0x00B8(0x0014) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             Failed;                                                   // 0x00C8(0x0014) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x10];                                      // 0x00D8(0x0010) MISSED OFFSET
	struct FGbxExposeOnSpawnValueCache                 ExposeOnSpawnCache;                                       // 0x00E8(0x0110) (BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData06[0x38];                                      // 0x01F8(0x0038) MISSED OFFSET
};

// ScriptStruct Engine.GbxSpawnActorAsyncRequestEntry
// 0x0050 (0x0280 - 0x0230)
struct FGbxSpawnActorAsyncRequestEntry : public FGbxSpawnActorAsyncRequest
{
	unsigned char                                      UnknownData00[0x50];                                      // 0x0230(0x0050) MISSED OFFSET
};

// ScriptStruct Engine.GbxTraceAsyncRequest
// 0x00B0
struct FGbxTraceAsyncRequest
{
	EGbxTraceAsyncMode                                 Mode;                                                     // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETraceTypeQuery>                       Channel;                                                  // 0x0001(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EObjectTypeQuery>                      ObjectType;                                               // 0x0002(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5];                                       // 0x0003(0x0005) MISSED OFFSET
	TArray<TEnumAsByte<EObjectTypeQuery>>              ObjectTypes;                                              // 0x0008(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	EGbxTraceAsyncType                                 Type;                                                     // 0x0018(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	struct FVector                                     Start;                                                    // 0x001C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     End;                                                      // 0x0028(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              Radius;                                                   // 0x0034(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CapsuleHalfHeight;                                        // 0x0038(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     BoxHalfSize;                                              // 0x003C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bTraceComplex;                                            // 0x0048(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreSelf;                                              // 0x0049(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<EDrawDebugTrace>                       DebugDrawType;                                            // 0x0068(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0069(0x0003) MISSED OFFSET
	struct FLinearColor                                DebugTraceColor;                                          // 0x006C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                DebugTraceHitColor;                                       // 0x007C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              DebugDrawTime;                                            // 0x008C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate                             Hit;                                                      // 0x0090(0x0014) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             Miss;                                                     // 0x00A0(0x0014) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
};

// ScriptStruct Engine.GbxViewFlagSettings
// 0x0018
struct FGbxViewFlagSettings
{
	EGbxViewFlag                                       Flag;                                                     // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
	struct FName                                       Name;                                                     // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bOwner;                                                   // 0x0010(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bOnlyOwner;                                               // 0x0011(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bOnlyViewportOwner;                                       // 0x0012(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x5];                                       // 0x0013(0x0005) MISSED OFFSET
};

// ScriptStruct Engine.GbxZoneMapFODSavedLevelData
// 0x0030
struct FGbxZoneMapFODSavedLevelData
{
	struct FName                                       LevelName;                                                // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           FODTextureSize;                                           // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           NumChunks;                                                // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DiscoveryPercentage;                                      // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EGbxZoneMapFODDataState>               DataState;                                                // 0x0014(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0015(0x0003) MISSED OFFSET
	uint32_t                                           DataRevision;                                             // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	TArray<unsigned char>                              FODData;                                                  // 0x0020(0x0010) (ZeroConstructor)
};

// ScriptStruct Engine.GestaltPart
// 0x0028
struct FGestaltPart
{
	struct FName                                       SkeletalMeshFragmentName;                                 // 0x0000(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                MaterialIndex;                                            // 0x0008(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                FirstIndex;                                               // 0x000C(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                NumPrimitives;                                            // 0x0010(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	struct FGuid                                       SupportedClothAsset;                                      // 0x0014(0x0010) (Edit, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
};

// ScriptStruct Engine.GestaltInfo
// 0x0010
struct FGestaltInfo
{
	TArray<struct FGestaltPart>                        Parts;                                                    // 0x0000(0x0010) (Edit, ZeroConstructor, EditConst)
};

// ScriptStruct Engine.GestaltPartBoundsEntry
// 0x0028
struct FGestaltPartBoundsEntry
{
	struct FName                                       PartName;                                                 // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FBoxSphereBounds                            ReferencePoseBounds;                                      // 0x0008(0x001C) (IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
};

// ScriptStruct Engine.GestaltSocketMapping
// 0x0018
struct FGestaltSocketMapping
{
	struct FName                                       PartName;                                                 // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       OriginalSocketName;                                       // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       MappedName;                                               // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
{
	int64_t                                            PropertyConnectedBitmask;                                 // 0x0030(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
};
...
struct FLocationBoneSocketInfo
{
	...
	struct FVector                                     Offset;                                                   // 0x0008(0x000C) (Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0014(0x0004) MISSED OFFSET
	struct FRawDistributionVector                      OffsetDistribution;                                       // 0x0018(0x0050) (Edit)
};
...
struct FEmitterDynamicParameter
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	TEnumAsByte<EEmitterDynamicParameterValue>         ValueMethod;                                              // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	unsigned char                                      bScaleVelocityByParamValue : 1;                           // 0x0010(0x0001)
...
// ScriptStruct Engine.NoiseModifier
// 0x0058
struct FNoiseModifier
{
	struct FRawDistributionVector                      Values;                                                   // 0x0000(0x0050) (Edit)
	bool                                               bUniformSeed;                                             // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ENoiseTimeSource                                   TimeSource;                                               // 0x0051(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FParticleSysParam
{
	...
	struct FName                                       BoneSocketName;                                           // 0x0040(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x18];                                      // 0x0000(0x0018) MISSED OFFSET
	struct FName                                       JointName;                                                // 0x0018(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FRigidBodyErrorCorrection
{
	...
	float                                              MaxLinearHardSnapDistance;                                // 0x0010(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PositionLerp;                                             // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AngleLerp;                                                // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              LinearVelocityCoefficient;                                // 0x001C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AngularVelocityCoefficient;                               // 0x0020(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ErrorAccumulationSeconds;                                 // 0x0024(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ErrorAccumulationDistanceSq;                              // 0x0028(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ErrorAccumulationSimilarity;                              // 0x002C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
// ScriptStruct Engine.PostProcessSettingsWithBlocker
// 0x0000 (0x0600 - 0x0600)
struct FPostProcessSettingsWithBlocker : public FPostProcessSettings
{
	unsigned char                                      bBlockWhiteBalance : 1;                                   // 0x05F8(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockColorGrading : 1;                                   // 0x05F8(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockColorGradingSMH : 1;                                // 0x05F8(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockFilm : 1;                                           // 0x05F8(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockSceneColor : 1;                                     // 0x05F8(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockBloom : 1;                                          // 0x05F8(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockDirtMask : 1;                                       // 0x05F8(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockLightPropagationVolume : 1;                         // 0x05F8(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockAmbientCubemap : 1;                                 // 0x05F9(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockAutoExposure : 1;                                   // 0x05F9(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockLensFlares : 1;                                     // 0x05F9(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockAmbientOcclusion : 1;                               // 0x05F9(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockGlobalIllumination : 1;                             // 0x05F9(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockDepthOfField : 1;                                   // 0x05F9(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockMotionBlur : 1;                                     // 0x05F9(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockScreenSpaceReflections : 1;                         // 0x05F9(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockEdgeDetection : 1;                                  // 0x05FA(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockFWeightedBlendable : 1;                             // 0x05FA(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockMisc : 1;                                           // 0x05FA(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockSkyEnvMap : 1;                                      // 0x05FA(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockAmbientOcclusionGBX : 1;                            // 0x05FA(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockExponentialHeightFog : 1;                           // 0x05FA(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bBlockAtmosphericFog : 1;                                 // 0x05FA(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      UnknownData00[0x5];                                       // 0x05FB(0x0005) MISSED OFFSET
};

// ScriptStruct Engine.PostProcessSettingsWithInheritance
// 0x0010 (0x0610 - 0x0600)
struct FPostProcessSettingsWithInheritance : public FPostProcessSettings
{
	class UClass*                                      OverridePostProcessSettings;                              // 0x05F8(0x0008) (Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	unsigned char                                      bInheritanceWhiteBalance : 1;                             // 0x0600(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceColorGrading : 1;                             // 0x0600(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceColorGradingSMH : 1;                          // 0x0600(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceFilm : 1;                                     // 0x0600(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceSceneColor : 1;                               // 0x0600(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceBloom : 1;                                    // 0x0600(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceDirtMask : 1;                                 // 0x0600(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceLightPropagationVolume : 1;                   // 0x0600(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceAmbientCubemap : 1;                           // 0x0601(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceAutoExposure : 1;                             // 0x0601(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceLensFlares : 1;                               // 0x0601(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceAmbientOcclusion : 1;                         // 0x0601(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceGlobalIllumination : 1;                       // 0x0601(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceDepthOfField : 1;                             // 0x0601(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceMotionBlur : 1;                               // 0x0601(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceScreenSpaceReflections : 1;                   // 0x0601(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceEdgeDetection : 1;                            // 0x0602(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceFWeightedBlendable : 1;                       // 0x0602(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceMisc : 1;                                     // 0x0602(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceSkyEnvMap : 1;                                // 0x0602(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceAmbientOcclusionGBX : 1;                      // 0x0602(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceExponentialHeightFog : 1;                     // 0x0602(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      bInheritanceAtmosphericFog : 1;                           // 0x0602(0x0001) (Edit, DisableEditOnTemplate)
	unsigned char                                      UnknownData00[0xD];                                       // 0x0603(0x000D) MISSED OFFSET
};
...
// ScriptStruct Engine.ThumbnailParameters
// 0x0010
struct FThumbnailParameters
{
	...
	float                                              Zoom;                                                     // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FOV;                                                      // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
// ScriptStruct Engine.StreamingLevelRemapData
// 0x0010
struct FStreamingLevelRemapData
{
	struct FName                                       OldLevelPath;                                             // 0x0000(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	struct FName                                       NewLevelPath;                                             // 0x0008(0x0008) (ZeroConstructor, Config, IsPlainOldData)
};
...
struct FMeshProxySettings
{
	...
	int                                                LODGroupIndex;                                            // 0x00DC(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	unsigned char                                      UnknownData05[0x5];                                       // 0x00E3(0x0005) MISSED OFFSET
	struct FName                                       LODGroup;                                                 // 0x00E8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	int                                                LODGroupIndex;                                            // 0x0010(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	unsigned char                                      UnknownData06[0x8];                                       // 0x00D8(0x0008) MISSED OFFSET
	struct FName                                       LODGroup;                                                 // 0x00E0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FHierarchicalSimplification
{
	...
	bool                                               bFarShadowCastersOnly;                                    // 0x000F(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FMeshProxySettings                          ProxySetting;                                             // 0x0010(0x00F0) (Edit)
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x0100(0x00E8) (Edit)
	float                                              DesiredBoundRadius;                                       // 0x01E8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DesiredFillingPercentage;                                 // 0x01EC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MinNumberOfActorsToBuild;                                 // 0x01F0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOnlyGenerateClustersForVolumes;                          // 0x01F4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bReusePreviousLevelClusters;                              // 0x01F5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x01F6(0x0002) MISSED OFFSET
};
...
{
	float                                              StaticLightingLevelScale;                                 // 0x0000(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                NumIndirectLightingBounces;                               // 0x0004(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                NumSkyLightingBounces;                                    // 0x0008(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	float                                              IndirectLightingQuality;                                  // 0x000C(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	float                                              IndirectLightingSmoothness;                               // 0x0010(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	struct FColor                                      EnvironmentColor;                                         // 0x0014(0x0004) (Edit, EditConst, IsPlainOldData)
	float                                              EnvironmentIntensity;                                     // 0x0018(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	...
	float                                              VolumetricLightmapMaximumIndirectionMemoryMb;             // 0x0030(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              VolumetricLightmapSphericalHarmonicSmoothing;             // 0x0034(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              VolumeLightSamplePlacementScale;                          // 0x0038(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUseAmbientOcclusion : 1;                                 // 0x003C(0x0001) (Edit)
	unsigned char                                      bGenerateAmbientOcclusionMaterialMask : 1;                // 0x003C(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x003D(0x0003) MISSED OFFSET
	float                                              DirectIlluminationOcclusionFraction;                      // 0x0040(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              IndirectIlluminationOcclusionFraction;                    // 0x0044(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              OcclusionExponent;                                        // 0x0048(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FullyOccludedSamplesFraction;                             // 0x004C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxOcclusionDistance;                                     // 0x0050(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bVisualizeMaterialDiffuse : 1;                            // 0x0054(0x0001) (Edit)
	unsigned char                                      bVisualizeAmbientOcclusion : 1;                           // 0x0054(0x0001) (Edit)
	unsigned char                                      bCompressLightmaps : 1;                                   // 0x0054(0x0001) (Edit)
...
// ScriptStruct Engine.GbxAttributeInteger
// 0x0008 (0x000C - 0x0004)
struct FGbxAttributeInteger : public FGbxAttributeBase
{
...
{
	unsigned char                                      UnknownData00[0x6C0];                                     // 0x0000(0x06C0) MISSED OFFSET
};
...
struct FAnimNode_AssetPlayerBase : public FAnimNode_Base
{
	...
	struct FName                                       AnimAssetName;                                            // 0x0058(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       LastAnimAssetName;                                        // 0x0060(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
};

// ScriptStruct Engine.NodeGaitScalingData
// 0x0018
struct FNodeGaitScalingData
{
	bool                                               bUseGaitScaling;                                          // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x0001(0x0017) MISSED OFFSET
};
...
// ScriptStruct Engine.BoneSetWeight
// 0x000C
struct FBoneSetWeight
{
	int                                                SourceIndex;                                              // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              BlendWeight;                                              // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bAdditive;                                                // 0x0008(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bMeshSpaceRotation;                                       // 0x0009(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData05[0xA4];                                      // 0x018C(0x00A4) MISSED OFFSET
};
...
struct FAnimNode_ApplyMeshSpaceAdditive : public FAnimNode_Base
{
	...
	bool                                               bBoolAlpha;                                               // 0x0074(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseBoolAlpha;                                            // 0x0075(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bInvertAlpha;                                             // 0x0076(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	class UAnimSequenceBase*                           Sequence;                                                 // 0x0068(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bLoopAnimation;                                           // 0x0070(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0071(0x0003) MISSED OFFSET
	float                                              PlayRateBasis;                                            // 0x0074(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x0078(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FInputScaleBiasClamp                        PlayRateScaleBiasClamp;                                   // 0x007C(0x003C) (Edit, BlueprintVisible)
	float                                              StartPosition;                                            // 0x00B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseRateScaleSpeed;                                       // 0x00BC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00BD(0x0003) MISSED OFFSET
	float                                              RateScaleSpeed;                                           // 0x00C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Duration;                                                 // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FNodeGaitScalingData                        GaitScalingData;                                          // 0x00C8(0x0018) (Edit, BlueprintVisible)
	bool                                               bCalcStartPositionFromCurrentPose;                        // 0x00E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bStartAtRandomPosition;                                   // 0x00E1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x00E2(0x0002) MISSED OFFSET
	struct FVector2D                                   MinMaxPlayRate;                                           // 0x00E4(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
...
struct FAnimNode_StateMachine : public FAnimNode_Base
{
	...
	int                                                BoneSetPriority;                                          // 0x00E0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xA4];                                      // 0x00E4(0x00A4) MISSED OFFSET
};
...
struct FAnimationActiveTransitionEntry
{
	...
	unsigned char                                      UnknownData01[0x40];                                      // 0x0098(0x0040) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x190];                                     // 0x06C0(0x0190) MISSED OFFSET
};
...
struct FAnimNotifyTrack
{
	...
	EFAnimNotifyTrackLockState                         LockState;                                                // 0x0040(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bIsAutoGenerated;                                         // 0x0044(0x0001) (ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Engine.BlendSpaceInstance
// 0x0108
struct FBlendSpaceInstance
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) MISSED OFFSET
	class UBlendSpaceBase*                             BlendSpace;                                               // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xF8];                                      // 0x0010(0x00F8) MISSED OFFSET
};
...
struct FBPVariableDescription
{
	...
	struct FGuid                                       AssociatedBlueprintVariableGuid;                          // 0x00D8(0x0010) (IsPlainOldData)
};
...
// ScriptStruct Engine.BoneModInstance
// 0x00E8
struct FBoneModInstance
{
	struct FName                                       BoneName;                                                 // 0x0000(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       ComponentName;                                            // 0x0008(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Translation;                                              // 0x0010(0x000C) (BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FRotator                                    Rotation;                                                 // 0x001C(0x000C) (BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FVector                                     Scale;                                                    // 0x0028(0x000C) (BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	struct FAlphaBlend                                 Blend;                                                    // 0x0038(0x0038) (BlueprintVisible)
	bool                                               bUseTranslation;                                          // 0x0070(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseRotation;                                             // 0x0071(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseScale;                                                // 0x0072(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bReplaceTranslation;                                      // 0x0073(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bReplaceRotation;                                         // 0x0074(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bReplaceScale;                                            // 0x0075(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bStartActive;                                             // 0x0076(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0077(0x0002) MISSED OFFSET
	TEnumAsByte<EBoneControlSpace>                     TranslationSpace;                                         // 0x0079(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     RotationSpace;                                            // 0x007A(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6D];                                      // 0x007B(0x006D) MISSED OFFSET
};
...
struct FWorldContext
{
	...
	TArray<struct FNamedNetDriver>                     BeaconNetDrivers;                                         // 0x0290(0x0010) (ZeroConstructor, Transient)
};
...
// ScriptStruct Engine.LODPerDetailSettings
// 0x0008
struct FLODPerDetailSettings
{
	bool                                               bEnabled;                                                 // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideScreenSize;                                      // 0x0001(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0002(0x0002) MISSED OFFSET
	float                                              OverrideScreenSize;                                       // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Engine.LODPlatformSettings
// 0x001C
struct FLODPlatformSettings
{
	struct FLODPerDetailSettings                       QualitySettings[0x3];                                     // 0x0000(0x0008)
	unsigned char                                      NumSettings;                                              // 0x0018(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
};

// ScriptStruct Engine.ClosestPointResult
// 0x0020
struct FClosestPointResult
{
	struct FVector                                     Location;                                                 // 0x0000(0x000C) (IsPlainOldData)
	float                                              Distance;                                                 // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UPrimitiveComponent>          Component;                                                // 0x0010(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x1];                                       // 0x0000(0x0001) MISSED OFFSET
	EUpdateRateShiftBucket                             ShiftBucket;                                              // 0x0001(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bInterpolateSkippedFrames : 1;                            // 0x0002(0x0001)
	unsigned char                                      bShouldUseLodMap : 1;                                     // 0x0002(0x0001) (Edit)
	unsigned char                                      bShouldUseMinLod : 1;                                     // 0x0002(0x0001) (Edit)
	...
	int                                                BaseNonRenderedUpdateRate;                                // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxEvalRateForInterpolation;                              // 0x001C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<float>                                      BaseVisibleDistanceFactorThesholds;                       // 0x0020(0x0010) (Edit, ZeroConstructor)
	TMap<int, int>                                     LODToFrameSkipMap;                                        // 0x0030(0x0050) (Edit, ZeroConstructor)
...
struct FRigidBodyContactInfo
{
	...
	struct FVector                                     RelativeVelocity;                                         // 0x0030(0x000C) (IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x003C(0x0004) MISSED OFFSET
};
...
// ScriptStruct Engine.GaitLimb
// 0x0020
struct FGaitLimb
{
	struct FBoneReference                              EffectorLimb;                                             // 0x0000(0x0018) (Edit)
	float                                              MaxLength;                                                // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
};

// ScriptStruct Engine.GaitScalingSettings
// 0x0038
struct FGaitScalingSettings
{
	float                                              GaitScalingAlpha;                                         // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              GaitScalingInterpSpeed;                                   // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FBoneReference                              GaitScalingHips;                                          // 0x0008(0x0018) (Edit)
	TArray<struct FGaitLimb>                           GaitScalingLimbs;                                         // 0x0020(0x0010) (Edit, ZeroConstructor)
	float                                              AppliedLimbLength;                                        // 0x0030(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              HipRaiseRatio;                                            // 0x0034(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Engine.CalculateGaitLimbMaxLengthButton
// 0x0001
struct FCalculateGaitLimbMaxLengthButton
{
	unsigned char                                      UnknownData00[0x1];                                       // 0x0000(0x0001) MISSED OFFSET
};

// ScriptStruct Engine.GbxStateManagerId
// 0x0008
struct FGbxStateManagerId
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) MISSED OFFSET
};

// ScriptStruct Engine.GbxStateManagerRuntime
// 0x0050
struct FGbxStateManagerRuntime
{
	TMap<struct FGbxStateManagerId, class UGbxAnimStateManager*> ManagerMap;                                               // 0x0000(0x0050) (ZeroConstructor)
};
...
struct FMeshReductionSettings
{
	...
	int                                                VertexWeightColorChannel;                                 // 0x0144(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
// ScriptStruct Engine.ParsedPropertyPathElement
// 0x0018
struct FParsedPropertyPathElement
{
	struct FName                                       PropertyName;                                             // 0x0000(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	bool                                               bUsesArrayIndex;                                          // 0x0008(0x0001) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      ArrayIndex;                                               // 0x0009(0x0001) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData00[0xE];                                       // 0x000A(0x000E) MISSED OFFSET
};

// ScriptStruct Engine.ParsedProperty
// 0x0080
struct FParsedProperty
{
	struct FParsedPropertyPathElement                  ParsedPath[0x5];                                          // 0x0000(0x0018) (Edit, EditConst)
	uint32_t                                           ParsedPathLength;                                         // 0x0078(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
...
struct FCameraExposureSettings
{
	...
	float                                              MinBrightnessHDR;                                         // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxBrightnessHDR;                                         // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SpeedUp;                                                  // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SpeedDown;                                                // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Bias;                                                     // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BiasHDR;                                                  // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HistogramLogMin;                                          // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HistogramLogMax;                                          // 0x0030(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CalibrationConstant;                                      // 0x0034(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FGroupedSkeletalOptimizationSettings
{
	...
	struct FMeshProxySettings                          ProxySettings;                                            // 0x0178(0x00F0) (Edit)
	bool                                               bForceLODRebuild;                                         // 0x0268(0x0001) (Edit, ZeroConstructor, Transient, IsPlainOldData)
...
// ScriptStruct Engine.SlotNodeBlendSpaceData
// 0x0028
struct FSlotNodeBlendSpaceData
{
	unsigned char                                      UnknownData00[0x28];                                      // 0x0000(0x0028) MISSED OFFSET
};

// ScriptStruct Engine.SlotNodeCameraData
// 0x0010
struct FSlotNodeCameraData
{
	unsigned char                                      UnknownData00[0x10];                                      // 0x0000(0x0010) MISSED OFFSET
};
...
// ScriptStruct Engine.EditorMarker
// 0x0018
struct FEditorMarker
{
	float                                              Distance;                                                 // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FName                                       Label;                                                    // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
...
struct FGroupedStaticMeshOptimizationSettings
{
	...
	struct FMeshProxySettings                          ProxySettings;                                            // 0x0150(0x00F0) (Edit)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0240(0x0008) MISSED OFFSET
};

// ScriptStruct Engine.PerLODPlatformSettings
// 0x0004
struct FPerLODPlatformSettings
{
	bool                                               bEnableOnXbox;                                            // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableOnPS4;                                             // 0x0001(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableOnPC_HighDetail;                                   // 0x0002(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableOnPC_LowDetail;                                    // 0x0003(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FStaticMeshSourceModel
{
	...
	struct FGroupedStaticMeshOptimizationSettings      OptimizationSettings;                                     // 0x0228(0x0248) (Edit)
	float                                              LODDistance;                                              // 0x0470(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FPerPlatformFloat                           ScreenSize;                                               // 0x0474(0x0004) (Edit)
	class FString                                      SourceImportFilename;                                     // 0x0478(0x0010) (Edit, ZeroConstructor, EditConst)
	struct FPerLODPlatformSettings                     PerLODPlatformSettings;                                   // 0x0488(0x0004) (Deprecated)
...
// ScriptStruct Engine.TextureLODStreamingSettings
// 0x0014
struct FTextureLODStreamingSettings
{
	float                                              BoostFactor;                                              // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              FOVBoostFactor;                                           // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                RetentionPriority;                                        // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                LoadOrderPriority;                                        // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                IsCharacterTexture;                                       // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	class UTextureStreaming*                           Texture;                                                  // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Engine.TrajectoryParams
// 0x001C
struct FTrajectoryParams
{
	float                                              Speed;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Error;                                                    // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector                                     TargetOffset;                                             // 0x0008(0x000C) (Edit, IsPlainOldData)
	float                                              PredictDistMax;                                           // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Angle;                                                    // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Engine.Trajectory
// 0x0020
struct FTrajectory
{
	struct FVector                                     StartLoc;                                                 // 0x0000(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     Velocity;                                                 // 0x000C(0x000C) (Edit, IsPlainOldData)
	float                                              GravityZ;                                                 // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Time;                                                     // 0x001C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
