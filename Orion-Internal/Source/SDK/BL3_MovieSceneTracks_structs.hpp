...
// ScriptStruct MovieSceneTracks.ActorParameterNameAndChannel
// 0x00A8
struct FActorParameterNameAndChannel
{
	struct FName                                       ParameterName;                                            // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FMovieSceneActorReferenceData               Channel;                                                  // 0x0008(0x00A0)
};
...
struct FMovieSceneSkeletalAnimationParams
{
	...
	bool                                               bOverrideSlotName;                                        // 0x0020(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0021(0x0007) MISSED OFFSET
	struct FMovieSceneFloatChannel                     Weight;                                                   // 0x0028(0x00A0)
	bool                                               bSkipAnimNotifiers;                                       // 0x00C8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneFadeSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	struct FLinearColor                                FadeColor;                                                // 0x00C0(0x0010) (IsPlainOldData)
	unsigned char                                      bFadeAudio : 1;                                           // 0x00D0(0x0001)
	unsigned char                                      UnknownData00[0x7];                                       // 0x00D1(0x0007) MISSED OFFSET
};

// ScriptStruct MovieSceneTracks.MovieSceneFeedbackSectionTemplate
// 0x00A8 (0x00C8 - 0x0020)
struct FMovieSceneFeedbackSectionTemplate : public FMovieSceneEvalTemplate
{
	struct FMovieSceneFloatChannel                     FloatCurve;                                               // 0x0020(0x00A0)
	bool                                               bAffectsCoarseMotor;                                      // 0x00C0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bAffectsFineMotor;                                        // 0x00C1(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bAffectsRightTrigger;                                     // 0x00C2(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bAffectsLeftTrigger;                                      // 0x00C3(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00C4(0x0004) MISSED OFFSET
};

// ScriptStruct MovieSceneTracks.MovieSceneGbxPlayRateSectionTemplate
// 0x0130 (0x0150 - 0x0020)
struct FMovieSceneGbxPlayRateSectionTemplate : public FMovieSceneEvalTemplate
{
	struct FMovieSceneFloatChannel                     PlayRateCurve;                                            // 0x0020(0x00A0)
	struct FMovieSceneBoolChannel                      FrameSnappingCurve;                                       // 0x00C0(0x0090)
};
...
struct FMovieSceneParameterSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	TArray<struct FActorParameterNameAndChannel>       Actors;                                                   // 0x0050(0x0010) (ZeroConstructor)
};
