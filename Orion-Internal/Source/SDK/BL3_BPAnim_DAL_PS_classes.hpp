...
#include "BL3_BPAnim_DAL_PS_structs.hpp"
...
public:
	...
	bool                                               bAddScopeAnim;                                            // 0x0C78(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0C79(0x0007) MISSED OFFSET
	class UAnimSequence*                               ScopeAddIdleAnim;                                         // 0x0C80(0x0008) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_DAL_PS.BPAnim_DAL_PS_C");
		return ptr;
	}


	void UpdateScopeAnim(int UseMode);
	...
	void ExecuteUbergraph_BPAnim_DAL_PS(int EntryPoint);
};
