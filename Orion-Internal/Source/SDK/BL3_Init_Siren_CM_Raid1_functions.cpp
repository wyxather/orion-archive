...
#include "BL3_Init_Siren_CM_Raid1_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Init_Siren_CM_Raid1.Init_Siren_CM_Raid1_C.CalculateAttributeInitialValue");
