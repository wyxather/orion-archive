...
#include "BL3_Proj_NPC_Explosive_Grenade_structs.hpp"
...
// BlueprintGeneratedClass Proj_NPC_Explosive_Grenade.Proj_NPC_Explosive_Grenade_C
// 0x0049 (0x0729 - 0x06E0)
class AProj_NPC_Explosive_Grenade_C : public AOakAIBalancedProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_NPC_Explosive_Grenade.Proj_NPC_Explosive_Grenade_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Proj_NPC_Explosive_Grenade(int EntryPoint);
};
