...
#include "BL3_AIAction_PetJabbermon_Evo1_Beefcake_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AIActionBlueprintGeneratedClass AIAction_PetJabbermon_Evo1_Beefcake.AIAction_PetJabbermon_Evo1_Beefcake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIAction_PetJabbermon_Evo1_Beefcake(int EntryPoint);
};
