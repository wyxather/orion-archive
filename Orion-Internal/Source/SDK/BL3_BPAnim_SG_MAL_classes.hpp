...
#include "BL3_BPAnim_SG_MAL_structs.hpp"
...
public:
	...
	class UAnimSequenceBase*                           WeaponIdleAnim;                                           // 0x0990(0x0008) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SG_MAL.BPAnim_SG_MAL_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SG_MAL(int EntryPoint);
};
