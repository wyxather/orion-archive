...
#include "BL3_BPAnim_SkillScreenAnimInstance_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SkillScreenAnimInstance.BPAnim_SkillScreenAnimInstance_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SkillScreenAnimInstance(int EntryPoint);
};
