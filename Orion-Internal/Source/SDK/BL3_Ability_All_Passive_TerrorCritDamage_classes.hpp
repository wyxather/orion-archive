...
#include "BL3_Ability_All_Passive_TerrorCritDamage_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_All_Passive_TerrorCritDamage.Ability_All_Passive_TerrorCritDamage_C");
		return ptr;
	}


	void OnActivated();
	void ExecuteUbergraph_Ability_All_Passive_TerrorCritDamage(int EntryPoint);
};
