...
#include "BL3_Ability_Weapon_BioBetsy_Shock_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_Weapon_BioBetsy_Shock.Ability_Weapon_BioBetsy_Shock_C");
		return ptr;
	}
	...
	void Reset();
	void ExecuteUbergraph_Ability_Weapon_BioBetsy_Shock(int EntryPoint);
};
