...
#include "BL3_WeaponType_Hardpoints_BearFist_Projectile_structs.hpp"
...
public:
	...
	class UWeaponFireProjectileComponent*              WeaponFireProjectile;                                     // 0x0AB8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass WeaponType_Hardpoints_BearFist_Projectile.WeaponType_Hardpoints_BearFist_Projectile_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WeaponType_Hardpoints_BearFist_Projectile(int EntryPoint);
};
