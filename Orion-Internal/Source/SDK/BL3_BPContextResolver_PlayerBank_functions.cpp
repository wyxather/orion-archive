...
#include "BL3_BPContextResolver_PlayerBank_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BPContextResolver_PlayerBank.BPContextResolver_PlayerBank_C.GetContextForAttribute");
