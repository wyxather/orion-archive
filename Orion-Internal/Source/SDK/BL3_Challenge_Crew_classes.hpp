...
#include "BL3_Challenge_Crew_structs.hpp"
...
// BlueprintGeneratedClass Challenge_Crew.Challenge_Crew_C
// 0x00D8 (0x0338 - 0x0260)
class UChallenge_Crew_C : public UOakChallenge
{
public:
	...
	TEnumAsByte<Enum_CrewChallengeType>                Enum_CrewChallenge;                                       // 0x0330(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_Crew.Challenge_Crew_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Challenge_Crew(int EntryPoint);
};
