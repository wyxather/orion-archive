...
#include "BL3_AHitReact_Spiderant_Flinch_L_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AHitReact_Spiderant_Flinch_L.AHitReact_Spiderant_Flinch_L_C");
		return ptr;
	}
