...
struct FDestructibleChunkParameters
{
	...
	bool                                               bDoNotSplit;                                              // 0x0004(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FDestructibleDamageParameters
{
	...
	float                                              DamageSpreadFalloffExponent;                              // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DamageSpreadMinimumRadius;                                // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DamageSpreadRadiusMultiplier;                             // 0x0010(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableImpactDamage;                                      // 0x0014(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0015(0x0003) MISSED OFFSET
	float                                              ImpactDamage;                                             // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                DefaultImpactDamageDepth;                                 // 0x001C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCustomImpactResistance;                                  // 0x0020(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0021(0x0003) MISSED OFFSET
	float                                              ImpactResistance;                                         // 0x0024(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	EApexConvexHullMethod                              ConvexHullMethod;                                         // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	float                                              ConcavityPercent;                                         // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MergeThreshold;                                           // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	uint32_t                                           RecursionDepth;                                           // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	uint32_t                                           MaxVertexCount;                                           // 0x0010(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	uint32_t                                           MaxEdgeCount;                                             // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	uint32_t                                           MaxFaceCount;                                             // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FDestructibleApexDepthCollisionVolumeParameters> DepthCollisionVolume;                                     // 0x0000(0x0010) (Edit, ZeroConstructor)
	bool                                               bHigherDepthsUseDefaultCollisionVolume;                   // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	float                                              MaximumTrimming;                                          // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EApexConvexHullMethod                              ConvexHullMethod;                                         // 0x0018(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	float                                              ConcavityPercent;                                         // 0x001C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              MergeThreshold;                                           // 0x0020(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	uint32_t                                           RecursionDepth;                                           // 0x0024(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	uint32_t                                           MaxVertexCount;                                           // 0x0028(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	uint32_t                                           MaxEdgeCount;                                             // 0x002C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	uint32_t                                           MaxFaceCount;                                             // 0x0030(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
	struct FDestructibleDamageParameters               DamageParameters;                                         // 0x0000(0x0028) (Edit)
	struct FDestructibleDebrisParameters               DebrisParameters;                                         // 0x0028(0x002C) (Edit)
	struct FDestructibleAdvancedParameters             AdvancedParameters;                                       // 0x0054(0x0010) (Edit)
	struct FDestructibleSpecialHierarchyDepths         SpecialHierarchyDepths;                                   // 0x0064(0x0014) (Edit)
	TArray<struct FDestructibleDepthParameters>        DepthParameters;                                          // 0x0078(0x0010) (Edit, EditFixedSize, ZeroConstructor)
	struct FDestructibleParametersFlag                 Flags;                                                    // 0x0088(0x0004) (Edit)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FDestructibleApexCollisionVolumeParameters  ApexCollisionVolumeParameters;                            // 0x0090(0x0038) (Edit)
};
...
struct FPosableDestructibleChunkInfo
{
	...
	struct FName                                       GestaltPartName;                                          // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIsSupportChunk : 1;                                      // 0x0010(0x0001)
...
{
	class UStaticMesh*                                 Mesh;                                                     // 0x0000(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	int                                                ParentIndex;                                              // 0x0008(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
