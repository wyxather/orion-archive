...
#include "BL3_Challenge_Manufacturer_CoV_CoVKills_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_Manufacturer_CoV_CoVKills.Challenge_Manufacturer_CoV_CoVKills_C");
		return ptr;
	}
