...
#include "BL3_Ability_Gunner_AutoBear_FireDamage_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_Gunner_AutoBear_FireDamage.Ability_Gunner_AutoBear_FireDamage_C");
		return ptr;
	}


	void AnointAutoBearEnded(bool* HasValidTarget, class AActor** ChargeTarget);
	void ExecuteUbergraph_Ability_Gunner_AutoBear_FireDamage(int EntryPoint);
};
