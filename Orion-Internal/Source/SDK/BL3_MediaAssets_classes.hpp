...
#include "BL3_MediaAssets_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class MediaAssets.MediaAudioSinkProviderInterface");
		return ptr;
	}
...
public:
	...
	TScriptInterface<class UMediaAudioSinkProviderInterface> AudioSinkProvider;                                        // 0x00F8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x28];                                      // 0x0108(0x0028) MISSED OFFSET
	struct FGuid                                       PlayerGuid;                                               // 0x0130(0x0010) (IsPlainOldData)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0140(0x0008) MISSED OFFSET
	...
	void SetAudioSinkProvider(const TScriptInterface<class UMediaAudioSinkProviderInterface>& NewSinkProvider);
...
public:
	...
	bool                                               DynamicRateAdjustment;                                    // 0x0654(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0655(0x0003) MISSED OFFSET
	float                                              RateAdjustmentFactor;                                     // 0x0658(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FFloatRange                                 RateAdjustmentRange;                                      // 0x065C(0x0010) (Edit)
	unsigned char                                      UnknownData02[0x4];                                       // 0x066C(0x0004) MISSED OFFSET
	class UMediaPlayer*                                MediaPlayer;                                              // 0x0670(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x78];                                      // 0x0678(0x0078) MISSED OFFSET
