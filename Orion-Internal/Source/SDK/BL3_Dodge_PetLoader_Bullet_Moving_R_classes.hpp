...
#include "BL3_Dodge_PetLoader_Bullet_Moving_R_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Dodge_PetLoader_Bullet_Moving_R.Dodge_PetLoader_Bullet_Moving_R_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Dodge_PetLoader_Bullet_Moving_R(int EntryPoint);
};
