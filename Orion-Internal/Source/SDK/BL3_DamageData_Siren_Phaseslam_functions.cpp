...
#include "BL3_DamageData_Siren_Phaseslam_parameters.hpp"
...
void UDamageData_Siren_Phaseslam_C::OnHitEnemy(class AActor** DamageInstigator, class AActor** DamageCauser, class AActor** DamageTarget, struct FDamageDataEventDetails* Details)
{
	static auto fn = UObject::FindObject<UFunction>("Function DamageData_Siren_Phaseslam.DamageData_Siren_Phaseslam_C.OnHitEnemy");
