...
#include "BL3_Challenge_Crew_Ger_Cemetery_00_AllComplete_structs.hpp"
...
class UChallenge_Crew_Ger_Cemetery_00_AllComplete_C : public UChallenge_Crew_Geranium_CemeteryOpportunity_C
{
public:
	...
	struct FDataTableRowHandle                         CrewChallengeMailRow_Random;                              // 0x0348(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       Beastmaster;                                              // 0x0358(0x0028) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       Gunner;                                                   // 0x0370(0x0028) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       Operative;                                                // 0x0388(0x0028) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       Siren;                                                    // 0x03A0(0x0028) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_Crew_Ger_Cemetery_00_AllComplete.Challenge_Crew_Ger_Cemetery_00_AllComplete_C");
		return ptr;
	}


	void CompletedChallenge(class AGbxPlayerController** CompletedPlayer);
	void ExecuteUbergraph_Challenge_Crew_Ger_Cemetery_00_AllComplete(int EntryPoint);
};
