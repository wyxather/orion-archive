...
#include "BL3_Action_PhaseTrance_DLCSkill_Summon_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Action_PhaseTrance_DLCSkill_Summon.Action_PhaseTrance_DLCSkill_Summon_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Action_PhaseTrance_DLCSkill_Summon(int EntryPoint);
};
