...
#include "BL3_Action_PhaseTrance_Cast_Summon_classes.hpp"
...
struct UAction_PhaseTrance_Cast_Summon_C_OnBegin_Params
{
	class AActor**                                     Actor;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function Action_PhaseTrance_Cast_Summon.Action_PhaseTrance_Cast_Summon_C.OnEnd
struct UAction_PhaseTrance_Cast_Summon_C_OnEnd_Params
{
...
struct UAction_PhaseTrance_Cast_Summon_C_ExecuteUbergraph_Action_PhaseTrance_Cast_Summon_Params
{
