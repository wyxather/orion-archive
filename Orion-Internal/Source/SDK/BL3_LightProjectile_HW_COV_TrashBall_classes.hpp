...
#include "BL3_LightProjectile_HW_COV_TrashBall_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_HW_COV_TrashBall.LightProjectile_HW_COV_TrashBall_C");
		return ptr;
	}
