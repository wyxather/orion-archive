...
#include "BL3_Action_Melee_Operative_Success_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Action_Melee_Operative_Success.Action_Melee_Operative_Success_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Action_Melee_Operative_Success(int EntryPoint);
};
