...
#include "BL3_LightProjectile_Artifact_RocketBoots_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_Artifact_RocketBoots.LightProjectile_Artifact_RocketBoots_C");
		return ptr;
	}
