...
#include "BL3_Challenge_Manufacturer_Vladof_Rockets_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_Manufacturer_Vladof_Rockets.Challenge_Manufacturer_Vladof_Rockets_C");
		return ptr;
	}
