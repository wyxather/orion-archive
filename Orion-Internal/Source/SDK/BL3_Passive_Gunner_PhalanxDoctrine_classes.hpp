...
#include "BL3_Passive_Gunner_PhalanxDoctrine_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Passive_Gunner_PhalanxDoctrine.Passive_Gunner_PhalanxDoctrine_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Passive_Gunner_PhalanxDoctrine(int EntryPoint);
};
