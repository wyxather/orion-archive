...
#include "BL3_BPWeap_SR_MAL_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BPWeap_SR_MAL.BPWeap_SR_MAL_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPWeap_SR_MAL(int EntryPoint);
};
