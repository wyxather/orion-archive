...
#include "BL3_Ability_Gunner_V35LauncherDamage_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_Gunner_V35LauncherDamage.Ability_Gunner_V35LauncherDamage_C");
		return ptr;
	}
	...
	void OnActivated();
	void OnDeactivated();
	void ExecuteUbergraph_Ability_Gunner_V35LauncherDamage(int EntryPoint);
};
