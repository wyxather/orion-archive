...
#include "BL3_BP_WeaponMaterialWear_01_Common_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_WeaponMaterialWear_01_Common.BP_WeaponMaterialWear_01_Common_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_WeaponMaterialWear_01_Common(int EntryPoint);
};
