...
#include "BL3_BP_ShieldBoosterPickup_Health_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ShieldBoosterPickup_Health.BP_ShieldBoosterPickup_Health_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ShieldBoosterPickup_Health(int EntryPoint);
};
