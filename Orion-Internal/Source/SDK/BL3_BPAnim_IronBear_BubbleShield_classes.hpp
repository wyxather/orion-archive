...
#include "BL3_BPAnim_IronBear_BubbleShield_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_IronBear_BubbleShield.BPAnim_IronBear_BubbleShield_C");
		return ptr;
	}


	void SetBlendPose(int Pose);
	...
	void ExecuteUbergraph_BPAnim_IronBear_BubbleShield(int EntryPoint);
};
