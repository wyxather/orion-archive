...
#include "BL3_Action_Melee_Operative_Miss_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Action_Melee_Operative_Miss.Action_Melee_Operative_Miss_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Action_Melee_Operative_Miss(int EntryPoint);
};
