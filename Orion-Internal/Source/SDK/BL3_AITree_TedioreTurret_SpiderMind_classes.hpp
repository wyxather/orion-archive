...
#include "BL3_AITree_TedioreTurret_SpiderMind_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AIActionBlueprintGeneratedClass AITree_TedioreTurret_SpiderMind.AITree_TedioreTurret_SpiderMind_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AITree_TedioreTurret_SpiderMind(int EntryPoint);
};
