...
#include "BL3_HitReactionLayer_SpiderantAbdomenDeath_parameters.hpp"
...
// Function HitReactionLayer_SpiderantAbdomenDeath.HitReactionLayer_SpiderantAbdomenDeath_C.EvaluateTag
...
class UHitReactionTag* UHitReactionLayer_SpiderantAbdomenDeath_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_SpiderantAbdomenDeath.HitReactionLayer_SpiderantAbdomenDeath_C.EvaluateTag");

	UHitReactionLayer_SpiderantAbdomenDeath_C_EvaluateTag_Params params;
