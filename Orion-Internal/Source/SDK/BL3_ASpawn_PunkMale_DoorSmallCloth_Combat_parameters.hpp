...
#include "BL3_ASpawn_PunkMale_DoorSmallCloth_Combat_classes.hpp"
...
struct UASpawn_PunkMale_DoorSmallCloth_Combat_C_OnBegin_Params
{
	class AActor**                                     Actor;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function ASpawn_PunkMale_DoorSmallCloth_Combat.ASpawn_PunkMale_DoorSmallCloth_Combat_C.OnEnd
struct UASpawn_PunkMale_DoorSmallCloth_Combat_C_OnEnd_Params
{
...
struct UASpawn_PunkMale_DoorSmallCloth_Combat_C_ExecuteUbergraph_ASpawn_PunkMale_DoorSmallCloth_Combat_Params
{
