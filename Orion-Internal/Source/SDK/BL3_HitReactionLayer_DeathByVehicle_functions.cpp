...
#include "BL3_HitReactionLayer_DeathByVehicle_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_DeathByVehicle_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_DeathByVehicle.HitReactionLayer_DeathByVehicle_C.EvaluateTag");

	UHitReactionLayer_DeathByVehicle_C_EvaluateTag_Params params;
