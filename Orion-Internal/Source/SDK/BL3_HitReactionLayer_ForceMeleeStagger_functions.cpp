...
#include "BL3_HitReactionLayer_ForceMeleeStagger_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_ForceMeleeStagger_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_ForceMeleeStagger.HitReactionLayer_ForceMeleeStagger_C.EvaluateTag");

	UHitReactionLayer_ForceMeleeStagger_C_EvaluateTag_Params params;
