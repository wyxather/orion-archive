...
#include "BL3_Init_PetSkag_Phase_HealthRegen_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Init_PetSkag_Phase_HealthRegen.Init_PetSkag_Phase_HealthRegen_C.CalculateAttributeInitialValue");
