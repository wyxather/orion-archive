...
#include "BL3_LightProjectile_HYP_SM_Fork_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_HYP_SM_Fork.LightProjectile_HYP_SM_Fork_C");
		return ptr;
	}
