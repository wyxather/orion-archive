...
#include "BL3_Item_Season01_HalloweenShard_Repeatable_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Item_Season01_HalloweenShard_Repeatable.Item_Season01_HalloweenShard_Repeatable_C");
		return ptr;
	}
