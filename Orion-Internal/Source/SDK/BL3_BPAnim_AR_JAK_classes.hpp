...
#include "BL3_BPAnim_AR_JAK_structs.hpp"
...
public:
	...
	bool                                               bIsCrankGrip;                                             // 0x0DD0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_AR_JAK.BPAnim_AR_JAK_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_AR_JAK(int EntryPoint);
};
