...
#include "BL3_Init_GrenadeLauncher_Damage_Singularity_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Init_GrenadeLauncher_Damage_Singularity.Init_GrenadeLauncher_Damage_Singularity_C");
		return ptr;
	}
