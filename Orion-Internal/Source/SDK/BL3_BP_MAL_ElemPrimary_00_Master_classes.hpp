...
#include "BL3_BP_MAL_ElemPrimary_00_Master_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MAL_ElemPrimary_00_Master.BP_MAL_ElemPrimary_00_Master_C");
		return ptr;
	}
