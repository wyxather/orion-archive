...
#include "BL3_HitReactionLayer_HitRegion_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_HitRegion_C::EvaluateTag(class UDamageComponent** Receiver, class UDamageCauserComponent** Causer, float* DamageAmount, class UGbxDamageType** DamageType, class UDamageSource** DamageSource, class UHitRegionData** HitRegion, float* Force, class UHitReactionTag** PreviousTag)
{
	static auto fn = UObject::FindObject<UFunction>("Function HitReactionLayer_HitRegion.HitReactionLayer_HitRegion_C.EvaluateTag");

	UHitReactionLayer_HitRegion_C_EvaluateTag_Params params;
