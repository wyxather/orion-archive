...
#include "BL3_BPAnim_SR_HYP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SR_HYP.BPAnim_SR_HYP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SR_HYP(int EntryPoint);
};
