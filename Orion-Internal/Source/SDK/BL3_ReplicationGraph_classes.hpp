...
#include "BL3_ReplicationGraph_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData01[0x150];                                     // 0x00A8(0x0150) MISSED OFFSET
...
public:
	...
	TArray<class AActor*>                              NonReplicatedDormantActors;                               // 0x0198(0x0010) (ZeroConstructor)
...
public:
	...
	class UReplicationGraphNode_ActorList*             AlwaysRelevantNode;                                       // 0x0200(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FConnectionAlwaysRelevantNodePair>   AlwaysRelevantForConnectionList;                          // 0x0208(0x0010) (ZeroConstructor)
	TArray<class AActor*>                              ActorsWithoutNetConnection;                               // 0x0218(0x0010) (ZeroConstructor)
...
{
public:
	class UReplicationGraph*                           ReplicationGraph;                                         // 0x0458(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetReplicationGraphConnection*              ConnectionManager;                                        // 0x0460(0x0008) (ZeroConstructor, IsPlainOldData)
