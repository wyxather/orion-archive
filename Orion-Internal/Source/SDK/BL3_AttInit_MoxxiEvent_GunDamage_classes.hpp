...
#include "BL3_AttInit_MoxxiEvent_GunDamage_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AttInit_MoxxiEvent_GunDamage.AttInit_MoxxiEvent_GunDamage_C");
		return ptr;
	}
