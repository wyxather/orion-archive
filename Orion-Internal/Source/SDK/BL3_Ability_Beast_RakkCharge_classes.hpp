...
#include "BL3_Ability_Beast_RakkCharge_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Ability_Beast_RakkCharge.Ability_Beast_RakkCharge_C");
		return ptr;
	}
	...
	void OnActivated();
	void OnDeactivated();
	void ExecuteUbergraph_Ability_Beast_RakkCharge(int EntryPoint);
};
