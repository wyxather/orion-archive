...
#include "BL3_HitReactionLayer_ForceMeleeStagger_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass HitReactionLayer_ForceMeleeStagger.HitReactionLayer_ForceMeleeStagger_C");
		return ptr;
	}
