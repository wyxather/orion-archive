...
// Enum Landscape.ELandscapeLayerAutoPaintType
enum class ELandscapeLayerAutoPaintType : uint8_t
{
	LSLAPT_None                    = 0,
	LSLAPT_AutoPaintMaster         = 1,
	LSLAPT_AutoPaintChild          = 2,
	LSLAPT_MAX                     = 3
};
...
// Enum Landscape.ELandscapeAutoPaintActorState
enum class ELandscapeAutoPaintActorState : uint8_t
{
	LAPS_None                      = 0,
	LAPS_NoAutoPaint               = 1,
	LAPS_AllComponentsBaked        = 2,
	LAPS_NoComponentsBaked         = 3,
	LAPS_SomeComponentsBaked       = 4,
	LAPS_InvalidComponents         = 5,
	LAPS_MAX                       = 6
};


// Enum Landscape.ELandscapeAutoPaintOperation
enum class ELandscapeAutoPaintOperation : uint8_t
{
	LAPO_None                      = 0,
...
struct FGrassVariety
{
	...
	bool                                               bUseAsOccluder;                                           // 0x0041(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCastDynamicShadow;                                       // 0x0042(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bKeepInstanceBufferCPUCopy;                               // 0x0043(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Landscape.AutoPaintLayerInput
// 0x0038
struct FAutoPaintLayerInput
{
