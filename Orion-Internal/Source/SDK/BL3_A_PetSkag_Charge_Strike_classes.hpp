...
#include "BL3_A_PetSkag_Charge_Strike_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass A_PetSkag_Charge_Strike.A_PetSkag_Charge_Strike_C");
		return ptr;
	}


	void Notify_Melee();
	void ExecuteUbergraph_A_PetSkag_Charge_Strike(int EntryPoint);
};
