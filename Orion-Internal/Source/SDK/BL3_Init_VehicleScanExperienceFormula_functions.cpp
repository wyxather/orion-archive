...
#include "BL3_Init_VehicleScanExperienceFormula_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Init_VehicleScanExperienceFormula.Init_VehicleScanExperienceFormula_C.CalculateAttributeInitialValue");
