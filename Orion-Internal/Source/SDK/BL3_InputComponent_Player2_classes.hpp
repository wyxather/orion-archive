...
#include "BL3_InputComponent_Player2_structs.hpp"
...
public:
	...
	class AOakCharacter_Player*                        Player;                                                   // 0x02F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	struct FGbxInputEvent_Button_PressHoldRelease      GbxInputEvent__28;                                        // 0x0300(0x0080)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__37;                                        // 0x0380(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__38;                                        // 0x03F8(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__39;                                        // 0x0470(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__6;                                         // 0x04E8(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__7;                                         // 0x0560(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__2;                                         // 0x05D8(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__14;                                        // 0x0650(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__8;                                         // 0x06C8(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__15;                                        // 0x0740(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__16;                                        // 0x07B8(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__17;                                        // 0x0830(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__23;                                        // 0x08A8(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__3;                                         // 0x0920(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__1;                                         // 0x0998(0x0078)
	struct FGbxInputEvent_Button_PressHoldRelease      GbxInputEvent__10;                                        // 0x0A10(0x0080)
	struct FGbxInputEvent_Button_PressHoldRelease      GbxInputEvent__12;                                        // 0x0A90(0x0080)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__9;                                         // 0x0B10(0x0078)
	struct FGbxInputEvent_OakMoveAxis                  GbxInputEvent__4;                                         // 0x0B88(0x0070)
	struct FGbxInputEvent_OakLookAxis                  GbxInputEvent__5;                                         // 0x0BF8(0x0080)
	struct FGbxInputEvent_Button_PressHoldRelease      GbxInputEvent__13;                                        // 0x0C78(0x0080)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__18;                                        // 0x0CF8(0x0078)
	struct FGbxInputEvent_Button_PressHoldRelease      GbxInputEvent__22;                                        // 0x0D70(0x0080)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__11;                                        // 0x0DF0(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__20;                                        // 0x0E68(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__19;                                        // 0x0EE0(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__21;                                        // 0x0F58(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__25;                                        // 0x0FD0(0x0078)
	struct FGbxInputEvent_Button_PressRelease          GbxInputEvent__24;                                        // 0x1048(0x0078)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass InputComponent_Player2.InputComponent_Player2_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_InputComponent_Player2(int EntryPoint);
};
