...
#include "BL3_BPAnim_Op_Cannon_SkillScreen_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_Op_Cannon_SkillScreen.BPAnim_Op_Cannon_SkillScreen_C");
		return ptr;
	}


	void ExecuteUbergraph_BPAnim_Op_Cannon_SkillScreen(int EntryPoint);
};
