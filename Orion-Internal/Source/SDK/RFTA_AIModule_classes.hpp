...
#include "RFTA_AIModule_structs.hpp"
...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x03E0(0x0001) (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      bLOSflag : 1;                                             // 0x03E0(0x0001) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x03E0(0x0001) (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x03E0(0x0001) (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x03E0(0x0001) (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x03E0(0x0001) (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	unsigned char                                      bOptimizeRandomPct : 1;                                   // 0x0048(0x0001) (Edit, DisableEditOnInstance, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	unsigned char                                      UnknownData02[0x158];                                     // 0x0148(0x0158) MISSED OFFSET
...
{
public:
	unsigned char                                      bAutoRegisterAsSource : 1;                                // 0x00F8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, Config, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	class UClass* STATIC_GetSenseClassForStimulus(class UObject** WorldContextObject, struct FAIStimulus* Stimulus);
};
...
public:
	...
	void STATIC_ReportDamageEvent(class UObject** WorldContextObject, class AActor** DamagedActor, class AActor** Instigator, float* DamageAmount, struct FVector* EventLocation, struct FVector* HitLocation);
};
...
public:
	...
	void STATIC_ReportNoiseEvent(class UObject** WorldContextObject, struct FVector* NoiseLocation, float* Loudness, class AActor** Instigator, float* MaxRange, struct FName* Tag);
};
...
public:
	...
	class UAITask_MoveTo* STATIC_AIMoveTo(class AAIController** Controller, struct FVector* GoalLocation, class AActor** GoalActor, float* AcceptanceRadius, TEnumAsByte<EAIOptionFlag>* StopOnOverlap, TEnumAsByte<EAIOptionFlag>* AcceptPartialPath, bool* bUsePathfinding, bool* bLockAILogic, bool* bUseContinuosGoalTracking);
};
...
public:
	...
	unsigned char                                      UnknownData01[0x120];                                     // 0x0188(0x0120) MISSED OFFSET
...
public:
	...
	void SetValueAsString(struct FName* KeyName, class FString* StringValue);
	...
	class FString GetValueAsString(struct FName* KeyName);
...
public:
	...
	void STATIC_SetBlackboardValueAsString(class UBTNode** NodeOwner, struct FBlackboardKeySelector* Key, class FString* Value);
	...
	class FString STATIC_GetBlackboardValueAsString(class UBTNode** NodeOwner, struct FBlackboardKeySelector* Key);
...
public:
	...
	unsigned char                                      bDrawLabels : 1;                                          // 0x0784(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x0784(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x0784(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x0784(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x0784(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData03[0x20];                                      // 0x07C0(0x0020) MISSED OFFSET
...
public:
	...
	bool STATIC_FindLocalNavigationGridPath(class UObject** WorldContextObject, struct FVector* Start, struct FVector* End, TArray<struct FVector>* PathPoints);
	...
	int STATIC_AddLocalNavigationGridForPoint(class UObject** WorldContextObject, struct FVector* Location, int* Radius2D, float* Height, bool* bRebuildGrids);
	int STATIC_AddLocalNavigationGridForCapsule(class UObject** WorldContextObject, struct FVector* Location, float* CapsuleRadius, float* CapsuleHalfHeight, int* Radius2D, float* Height, bool* bRebuildGrids);
	int STATIC_AddLocalNavigationGridForBox(class UObject** WorldContextObject, struct FVector* Location, struct FVector* Extent, struct FRotator* Rotation, int* Radius2D, float* Height, bool* bRebuildGrids);
};
...
public:
	...
	unsigned char                                      bEnableSensingUpdates : 1;                                // 0x010C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bOnlySensePlayers : 1;                                    // 0x010C(0x0001) (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bSeePawns : 1;                                            // 0x010C(0x0001) (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bHearNoises : 1;                                          // 0x010C(0x0001) (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
