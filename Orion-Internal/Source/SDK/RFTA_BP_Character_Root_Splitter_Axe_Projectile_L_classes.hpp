...
#include "RFTA_BP_Character_Root_Splitter_Axe_Projectile_L_structs.hpp"
...
// BlueprintGeneratedClass BP_Character_Root_Splitter_Axe_Projectile_L.BP_Character_Root_Splitter_Axe_Projectile_L_C
...
public:
	...
	class UStaticMeshComponent*                        Sword_Shell;                                              // 0x0490(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Character_Root_Splitter_Axe_Projectile_L.BP_Character_Root_Splitter_Axe_Projectile_L_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Character_Root_Splitter_Axe_Projectile_L(int* EntryPoint);
};
