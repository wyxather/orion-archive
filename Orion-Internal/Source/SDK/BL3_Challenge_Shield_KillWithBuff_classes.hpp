...
#include "BL3_Challenge_Shield_KillWithBuff_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_Shield_KillWithBuff.Challenge_Shield_KillWithBuff_C");
		return ptr;
	}
