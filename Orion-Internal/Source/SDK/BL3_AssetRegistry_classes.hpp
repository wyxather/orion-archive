...
#include "BL3_AssetRegistry_structs.hpp"
...
{
public:
	unsigned char                                      UnknownData00[0x6F0];                                     // 0x0028(0x06F0) MISSED OFFSET
...
public:
	...
	bool STATIC_GetTagValue(const struct FAssetData& InAssetData, const struct FName& InTagName, class FString* OutTagValue);
