...
#include "BL3_LightProjectile_Lightspeed_classes.hpp"
...
struct ULightProjectile_Lightspeed_C_OnBegin_Params
{
	class ULightProjectile**                           Projectile;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function LightProjectile_Lightspeed.LightProjectile_Lightspeed_C.OnRicochet
struct ULightProjectile_Lightspeed_C_OnRicochet_Params
{
	class ULightProjectile**                           Projectile;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
