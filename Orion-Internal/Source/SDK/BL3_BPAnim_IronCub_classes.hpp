...
#include "BL3_BPAnim_IronCub_structs.hpp"
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x11A8(0x0008) MISSED OFFSET
	...
	unsigned char                                      UnknownData01[0x8];                                       // 0x1DE8(0x0008) MISSED OFFSET
	...
	unsigned char                                      UnknownData02[0x8];                                       // 0x2498(0x0008) MISSED OFFSET
	...
	bool                                               HasTarget;                                                // 0x4498(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	bool                                               LittleArms;                                               // 0x4499(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_IronCub.BPAnim_IronCub_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_IronCub(int EntryPoint);
};
