...
struct FMovieSceneSkeletalAnimationParams
{
	...
	unsigned char                                      bTriggerNotifies : 1;                                     // 0x0014(0x0001) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FMovieSceneAudioSectionTemplateData
{
	...
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0168(0x0014) (ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
