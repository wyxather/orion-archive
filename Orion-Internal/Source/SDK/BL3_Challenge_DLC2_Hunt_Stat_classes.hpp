...
#include "BL3_Challenge_DLC2_Hunt_Stat_structs.hpp"
...
public:
	...
	struct FDataTableRowHandle                         HuntMailRow;                                              // 0x0268(0x0010) (Edit, BlueprintVisible)
	struct FDialogTimeSlotReference                    CrewCompletionDialog;                                     // 0x0278(0x0040) (Edit, BlueprintVisible)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Challenge_DLC2_Hunt_Stat.Challenge_DLC2_Hunt_Stat_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Challenge_DLC2_Hunt_Stat(int EntryPoint);
};
