...
#include "BL3_AIModule_structs.hpp"
...
public:
	...
	class UBlackboardComponent*                        BlackboardComp;                                           // 0x0180(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	class AAIController*                               AIOwner;                                                  // 0x0188(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData02[0x58];                                      // 0x0040(0x0058) MISSED OFFSET
...
public:
	...
	bool                                               bClearEntryOnFailure;                                     // 0x00F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TArray<class UClass*>                              ContextTypes;                                             // 0x0030(0x0010) (ZeroConstructor)
...
{
public:
	class FString                                      OptionName;                                               // 0x0040(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
...
public:
	...
	bool                                               bCaresAboutHotSpots;                                      // 0x0090(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class FString                                      TestComment;                                              // 0x0048(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	...
	class UEnvQueryTest*                               CopiedFrom;                                               // 0x01D0(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FEnvTraceData                               TraceData;                                                // 0x01D8(0x0030) (Edit, DisableEditOnInstance)
	struct FAIDataProviderBoolValue                    TraceFromContext;                                         // 0x0208(0x0030) (Edit, DisableEditOnInstance)
	struct FAIDataProviderFloatValue                   ItemHeightOffset;                                         // 0x0238(0x0030) (Edit, DisableEditOnInstance)
	struct FAIDataProviderFloatValue                   ContextHeightOffset;                                      // 0x0268(0x0030) (Edit, DisableEditOnInstance)
	class UClass*                                      Context;                                                  // 0x0298(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x0540(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x0540(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x0540(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x0540(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x0540(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x0540(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0541(0x0007) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x0548(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x0550(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x0558(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x0560(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x0568(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x0570(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x0578(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x0580(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0590(0x0008) MISSED OFFSET
...
// 0x0150 (0x0328 - 0x01D8)
class UBehaviorTreeComponent : public UBrainComponent
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x01D8(0x0020) MISSED OFFSET
	TArray<class UBTNode*>                             NodeInstances;                                            // 0x01F8(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0x120];                                     // 0x0208(0x0120) MISSED OFFSET
...
public:
	...
	class UEnvQuery*                                   QueryTemplate;                                            // 0x08B8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x08C0(0x0010) (Edit, ZeroConstructor, EditConst)
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x08D0(0x0010) (Edit, ZeroConstructor)
	TMap<class UClass*, class AActor*>                 QueryContexts;                                            // 0x08E0(0x0050) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x0930(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x0934(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x0938(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0939(0x0003) MISSED OFFSET
	unsigned char                                      bDrawLabels : 1;                                          // 0x093C(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x093C(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x093C(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x093C(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x093C(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x3];                                       // 0x093D(0x0003) MISSED OFFSET
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x0940(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x0941(0x0007) MISSED OFFSET
	struct FNavAgentProperties                         NavAgentProperties;                                       // 0x0948(0x0030) (Edit)
	unsigned char                                      bDrawTraces : 1;                                          // 0x0978(0x0001) (Edit)
	unsigned char                                      UnknownData04[0x27];                                      // 0x0979(0x0027) MISSED OFFSET
...
{
public:
	TArray<class UAISenseConfig*>                      SensesConfig;                                             // 0x0178(0x0010) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance)
	class UClass*                                      DominantSense;                                            // 0x0188(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0190(0x0010) MISSED OFFSET
	class AAIController*                               AIOwner;                                                  // 0x01A0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TScriptInterface<class UGenericTeamAgentInterface> OwnerTeamAgent;                                           // 0x01A8(0x0010) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x01B8(0x0004) MISSED OFFSET
	bool                                               bOwnerIsStationary;                                       // 0x01BC(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7B];                                      // 0x01BD(0x007B) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnPerceptionUpdated;                                      // 0x0238(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTargetPerceptionUpdated;                                // 0x0248(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	unsigned char                                      bAutoRegisterAsSource : 1;                                // 0x0178(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, Config)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0179(0x0007) MISSED OFFSET
	TArray<class UClass*>                              RegisterAsSourceForSenses;                                // 0x0180(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	TArray<class UAISense*>                            Senses;                                                   // 0x00D0(0x0010) (ZeroConstructor)
	float                                              PerceptionAgingRate;                                      // 0x00E0(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x9C];                                      // 0x00E4(0x009C) MISSED OFFSET
	TArray<class FString>                              PerceptionSourceWhitelist;                                // 0x0180(0x0010) (Edit, ZeroConstructor, Config)
	TArray<class FString>                              PerceptionSourceBlacklist;                                // 0x0190(0x0010) (Edit, ZeroConstructor, Config)
	TArray<class FString>                              MustHaveAssociatedCharacter;                              // 0x01A0(0x0010) (Edit, ZeroConstructor, Config)
	unsigned char                                      UnknownData02[0x30];                                      // 0x01B0(0x0030) MISSED OFFSET
...
{
public:
	class UClass*                                      ListenerDataType;                                         // 0x0098(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UAIPerceptionComponent*>              ListenerContainer;                                        // 0x00A0(0x0010) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor)
	TArray<class UAISenseEvent*>                       UnprocessedEvents;                                        // 0x00B0(0x0010) (ZeroConstructor)
...
{
public:
	TArray<struct FAIDamageEvent>                      RegisteredEvents;                                         // 0x0098(0x0010) (ZeroConstructor)
...
{
public:
	TArray<struct FAINoiseEvent>                       NoiseEvents;                                              // 0x0098(0x0010) (ZeroConstructor)
	float                                              SpeedOfSoundSq;                                           // 0x00A8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x54];                                      // 0x00AC(0x0054) MISSED OFFSET
...
{
public:
	TArray<struct FAIPredictionEvent>                  RegisteredEvents;                                         // 0x0098(0x0010) (ZeroConstructor)
...
{
public:
	TArray<struct FAITeamStimulusEvent>                RegisteredEvents;                                         // 0x0098(0x0010) (ZeroConstructor)
...
{
public:
	TArray<struct FAITouchEvent>                       RegisteredEvents;                                         // 0x0098(0x0010) (ZeroConstructor)
...
{
public:
	class UBrainComponent*                             BrainComp;                                                // 0x0178(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	class UBlackboardData*                             BlackboardAsset;                                          // 0x0180(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x20];                                      // 0x0188(0x0020) MISSED OFFSET
	TArray<class UBlackboardKeyType*>                  KeyInstances;                                             // 0x01A8(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0xB8];                                      // 0x01B8(0x00B8) MISSED OFFSET
	TArray<struct FBlackboardEntry>                    RuntimeKeys;                                              // 0x0270(0x0010) (ZeroConstructor, Transient)
	...
	bool HasValue(const struct FName& KeyName);
	...
	unsigned char AddRuntimeKey(const struct FName& KeyName, class UBlackboardKeyType* KeyType);
};
...
{
public:
	bool                                               DefaultValue;                                             // 0x0030(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	float                                              DefaultValue;                                             // 0x0030(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	int                                                DefaultValue;                                             // 0x0030(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
...
{
public:
	struct FName                                       DefaultValue;                                             // 0x0030(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	struct FRotator                                    DefaultValue;                                             // 0x0030(0x000C) (Edit, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUseDefaultValue;                                         // 0x003C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	class FString                                      DefaultValue;                                             // 0x0040(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
...
{
public:
	struct FVector                                     DefaultValue;                                             // 0x0030(0x000C) (Edit, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUseDefaultValue;                                         // 0x003C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x003D(0x0003) MISSED OFFSET
...
public:
	...
	class UNavMovementComponent*                       MovementComp;                                             // 0x01C8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x01D0(0x0008) MISSED OFFSET
	class ANavigationData*                             MyNavData;                                                // 0x01D8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x170];                                     // 0x01E0(0x0170) MISSED OFFSET
...
public:
	...
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x0358(0x000C) (IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0364(0x0004) MISSED OFFSET
	class UCharacterMovementComponent*                 CharacterMovement;                                        // 0x0368(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x0370(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x0374(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x0378(0x0004) (Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData02[0x24];                                      // 0x037C(0x0024) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x67];                                      // 0x0071(0x0067) MISSED OFFSET
...
public:
	...
	TMap<struct FName, class UClass*>                  ContextTypes;                                             // 0x0048(0x0050) (ZeroConstructor, Transient)
...
{
public:
	struct FText                                       GeneratorsActionDescription;                              // 0x0060(0x0028) (Edit)
...
{
public:
	struct FAIDataProviderFloatValue                   AlignedPointsDistance;                                    // 0x0098(0x0030) (Edit, DisableEditOnInstance)
	struct FAIDataProviderFloatValue                   ConeDegrees;                                              // 0x00C8(0x0030) (Edit, DisableEditOnInstance)
	struct FAIDataProviderFloatValue                   AngleStep;                                                // 0x00F8(0x0030) (Edit, DisableEditOnInstance)
	struct FAIDataProviderFloatValue                   Range;                                                    // 0x0128(0x0030) (Edit, DisableEditOnInstance)
	class UClass*                                      CenterActor;                                              // 0x0158(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIncludeContextLocation : 1;                              // 0x0160(0x0001) (Edit)
...
public:
	...
	bool                                               bUseSpiralPattern;                                        // 0x01A8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      bDefineArc : 1;                                           // 0x01B8(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x7];                                       // 0x01B9(0x0007) MISSED OFFSET
	struct FAIDataProviderIntValue                     NumberOfLayers;                                           // 0x01C0(0x0030) (Edit, DisableEditOnInstance)
	struct FAIDataProviderFloatValue                   HighestLayerHeight;                                       // 0x01F0(0x0030) (Edit, DisableEditOnInstance)
	struct FAIDataProviderFloatValue                   LowestLayerHeight;                                        // 0x0220(0x0030) (Edit, DisableEditOnInstance)
...
public:
	...
	struct FAIDataProviderIntValue                     NumberOfPoints;                                           // 0x00F8(0x0030) (Edit, DisableEditOnInstance)
	...
	struct FAIDataProviderFloatValue                   ArcAngle;                                                 // 0x0150(0x0030) (Edit, DisableEditOnInstance)
	float                                              AngleRadians;                                             // 0x0180(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0184(0x0004) MISSED OFFSET
	class UClass*                                      CircleCenter;                                             // 0x0188(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreAnyContextActorsWhenGeneratingCircle;              // 0x0190(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0191(0x0007) MISSED OFFSET
	struct FAIDataProviderFloatValue                   CircleCenterZOffset;                                      // 0x0198(0x0030) (Edit)
	struct FEnvTraceData                               TraceData;                                                // 0x01C8(0x0030) (Edit)
	unsigned char                                      bDefineArc : 1;                                           // 0x01F8(0x0001) (Edit)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AIModule.EnvQueryItemType_Component");
		return ptr;
	}
...
public:
	...
	TArray<class UEnvQueryTest*>                       AdditionalTestsCache;                                     // 0x00B0(0x0010) (ZeroConstructor, Transient)
...
{
public:
	TEnumAsByte<EEnvTestDistance>                      TestMode;                                                 // 0x01D8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	float                                              DistanceThreshold;                                        // 0x01E8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	struct FEnvDirection                               LineB;                                                    // 0x01F8(0x0020) (Edit, DisableEditOnInstance)
	EEnvTestDot                                        TestMode;                                                 // 0x0218(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAbsoluteValue;                                           // 0x0219(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	struct FGameplayTagQuery                           TagQueryToMatch;                                          // 0x01D8(0x0048) (Edit)
	bool                                               bPassIfNoTags;                                            // 0x0220(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUpdatedToUseQuery;                                       // 0x0221(0x0001) (ZeroConstructor, IsPlainOldData)
	EGameplayContainerMatchType                        TagsToMatch;                                              // 0x0222(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5];                                       // 0x0223(0x0005) MISSED OFFSET
	struct FGameplayTagContainer                       GameplayTags;                                             // 0x0228(0x0020)
...
{
public:
	struct FEnvOverlapData                             OverlapData;                                              // 0x01D8(0x0020) (Edit, DisableEditOnInstance)
...
{
public:
	TEnumAsByte<EEnvTestPathfinding>                   TestMode;                                                 // 0x01D8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x01D9(0x0007) MISSED OFFSET
	class UClass*                                      Context;                                                  // 0x01E0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FAIDataProviderBoolValue                    PathFromContext;                                          // 0x01E8(0x0030) (Edit, DisableEditOnInstance)
	struct FAIDataProviderBoolValue                    SkipUnreachable;                                          // 0x0218(0x0030) (Edit, DisableEditOnInstance)
	class UClass*                                      FilterClass;                                              // 0x0248(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	struct FAIDataProviderFloatValue                   ScanRangeMultiplier;                                      // 0x0250(0x0030) (Edit, DisableEditOnInstance)
...
{
public:
	struct FEnvTraceData                               ProjectionData;                                           // 0x01D8(0x0030) (Edit, DisableEditOnInstance)
...
{
public:
	class UNavLocalGridManager*                        GridManager;                                              // 0x0350(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TArray<struct FNavigationLink>                     PointLinks;                                               // 0x0468(0x0010) (Edit, ZeroConstructor)
	TArray<struct FNavigationSegmentLink>              SegmentLinks;                                             // 0x0478(0x0010) (ZeroConstructor)
	class UNavLinkCustomComponent*                     SmartLinkComp;                                            // 0x0488(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	bool                                               bSmartLinkIsRelevant;                                     // 0x0490(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0491(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSmartLinkReached;                                       // 0x0498(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	class APawn*                                       ControlledPawn;                                           // 0x0178(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TArray<struct FPawnActionStack>                    ActionStacks;                                             // 0x0180(0x0010) (ZeroConstructor)
	TArray<struct FPawnActionEvent>                    ActionEvents;                                             // 0x0190(0x0010) (ZeroConstructor)
	class UPawnAction*                                 CurrentAction;                                            // 0x01A0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	float                                              HearingThreshold;                                         // 0x0178(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LOSHearingThreshold;                                      // 0x017C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SightRadius;                                              // 0x0180(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SensingInterval;                                          // 0x0184(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              HearingMaxSoundAge;                                       // 0x0188(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bEnableSensingUpdates : 1;                                // 0x018C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bOnlySensePlayers : 1;                                    // 0x018C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bSeePawns : 1;                                            // 0x018C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bHearNoises : 1;                                          // 0x018C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0xB];                                       // 0x018D(0x000B) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSeePawn;                                                // 0x0198(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnHearNoise;                                              // 0x01A8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	float                                              PeripheralVisionAngle;                                    // 0x01B8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              PeripheralVisionCosine;                                   // 0x01BC(0x0004) (ZeroConstructor, IsPlainOldData)
