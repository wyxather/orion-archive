...
#include "BL3_LightProjectile_LovableRogue_Ricochet_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LightProjectile_LovableRogue_Ricochet.LightProjectile_LovableRogue_Ricochet_C");
		return ptr;
	}
