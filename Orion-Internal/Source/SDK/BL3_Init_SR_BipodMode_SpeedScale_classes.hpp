...
#include "BL3_Init_SR_BipodMode_SpeedScale_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Init_SR_BipodMode_SpeedScale.Init_SR_BipodMode_SpeedScale_C");
		return ptr;
	}
