...
#include "BL3_BPAnim_SG_Torgue_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BPAnim_SG_Torgue.BPAnim_SG_Torgue_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPAnim_SG_Torgue(int EntryPoint);
};
