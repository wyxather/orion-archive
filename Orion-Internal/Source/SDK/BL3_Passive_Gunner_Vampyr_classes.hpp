...
#include "BL3_Passive_Gunner_Vampyr_structs.hpp"
...
public:
	...
	float                                              MaxHealingClamp;                                          // 0x01B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Passive_Gunner_Vampyr.Passive_Gunner_Vampyr_C");
		return ptr;
	}
	...
	void OnActivated();
	void ExecuteUbergraph_Passive_Gunner_Vampyr(int EntryPoint);
};
