...
#include "BL3_Dodge_PetLoader_Bullet_Moving_FL_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Dodge_PetLoader_Bullet_Moving_FL.Dodge_PetLoader_Bullet_Moving_FL_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Dodge_PetLoader_Bullet_Moving_FL(int EntryPoint);
};
