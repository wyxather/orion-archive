...
#define CONFIG(v) write<#v>(o, v)
		CONFIG(orion.players.ally.box.enable);
		CONFIG(orion.players.ally.box.color[0]);
		CONFIG(orion.players.ally.box.color[1]);
		CONFIG(orion.players.ally.box.color[2]);
		CONFIG(orion.players.ally.box.color[3]);
		CONFIG(orion.players.ally.weapon.icon);
		CONFIG(orion.players.ally.name);
		CONFIG(orion.players.ally.skeleton);
		CONFIG(orion.players.ally.healthbar);
		...
		CONFIG(orion.players.enemy.weapon.icon);
		CONFIG(orion.players.enemy.name);
		CONFIG(orion.players.enemy.skeleton);
		CONFIG(orion.players.enemy.healthbar);
		CONFIG(orion.view.crosshair.color[0]);
		CONFIG(orion.view.crosshair.color[1]);
		CONFIG(orion.view.crosshair.color[2]);
		CONFIG(orion.view.crosshair.color[3]);
		CONFIG(orion.view.crosshair.enable);
		CONFIG(orion.view.crosshair.size);
		CONFIG(orion.view.misc.aspect_ratio);
		CONFIG(orion.main.movement.auto_jump);
