...
#ifdef _WIN64
#ifdef NDEBUG
#include "Resources/Shaders/Build/Release/x64/default_vs11.h"
#include "Resources/Shaders/Build/Release/x64/default_ps.h"
#else
#include "Resources/Shaders/Build/Debug/x64/default_vs11.h"
#include "Resources/Shaders/Build/Debug/x64/default_ps.h"
#endif
#else
#ifdef NDEBUG
#include "Resources/Shaders/Build/Release/Win32/default_vs11.h"
#include "Resources/Shaders/Build/Release/Win32/default_ps.h"
#else
#include "Resources/Shaders/Build/Debug/Win32/default_vs11.h"
#include "Resources/Shaders/Build/Debug/Win32/default_ps.h"
#endif
#endif
...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    {
        if (bd->pd3dDevice->CreateVertexShader(default_vs11, sizeof(default_vs11), NULL, &bd->pVertexShader) != S_OK)
            return false;
        ...
        if (bd->pd3dDevice->CreateInputLayout(local_layout, 3, default_vs11, sizeof(default_vs11), &bd->pInputLayout) != S_OK)
            return false;
    ...
    {
        if (bd->pd3dDevice->CreatePixelShader(default_ps, sizeof(default_ps), NULL, &bd->pPixelShader) != S_OK)
            return false;
    }
